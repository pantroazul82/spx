...
{
    public partial class frmAsociarReactivo : Form
    {
        public frmAsociarReactivo()
        {
            InitializeComponent();
        }
     ...
     public string CodManual { set { codManual = value; } get { return codManual; } }
        ...
        public DateTime fechaVencimiento { get { return calVencimiento.Value; } }
  ...
  sb.Append(" referencia_reactivo.codigo_manual,referencia_reactivo.nombre_referencia_reactivo ");
   ...
   SPXdata.BD.DataConector objData = new SPXdata.BD.DataConector();
        ...
        private void aceptar() 
        {
            ...
            {
                MessageBox.Show("Debe Ingresar la fecha de vencimiento del lote.");
                return;
            }
            if (txtLote.Text.Trim() == string.Empty)
            {
                MessageBox.Show("Debe Ingresar el Lote.");
                return;
            }
