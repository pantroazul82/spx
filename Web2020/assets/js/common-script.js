(function ($) {
    ...
    $(document).ready(function () {
        function ajustarContenido() {
            ...
            var minMainContentWidth = 500;
            var availableWidth = windowWidth - sidebarWidth;

            var sidebarVisible = window.getComputedStyle(sidebar).display !== 'none';

            var mainContentVisible;
            if (sidebarVisible && availableWidth < minMainContentWidth) {
                mainContentVisible = false;
            } else {
                mainContentVisible = true;
            }

            mainContent.style.visibility = mainContentVisible ? 'visible' : 'hidden';
        }

        window.onload = function () {
            ajustarContenido();
            setInterval(ajustarContenido, 100);
        };
