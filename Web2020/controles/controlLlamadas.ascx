<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="controlLlamadas.ascx.cs" Inherits="Web2020.controles.controlLlamadas" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cca" %>
<%@ Register src="controlTxtItem.ascx"
     tagname="controlTxtItem" tagprefix="uc1" %>
