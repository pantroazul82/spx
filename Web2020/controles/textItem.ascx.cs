...
namespace Web2020.controles
{
    ...
    public partial class textItem : System.Web.UI.UserControl
    {
        ...
        {
            controlTxtItem i = (controlTxtItem)LoadControl("controlTxtItem.ascx");
        ...
        void i_despuesDeQuitar(object sender, EventArgs e)
        {
            ...
            controlTxtItem i = (controlTxtItem)sender;
            for (int k = 0; k < listaItems.Count; k++)
            {
        ...
        public void generarItems()
        {
            ...
            for (int k = 0; k < listaItems.Count; k++)
            {
                controlTxtItem ct = (controlTxtItem)LoadControl("controlTxtItem.ascx");
