<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.Master" AutoEventWireup="true" CodeBehind="calendar.aspx.cs" Inherits="Web2020.frm.calendar.calendar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="grilla">
        ...
        onappointmentcommand="RadScheduler1_AppointmentCommand" AllowDelete="False" 
            ...
            DataReminderField="Inicio" CssClass="grilla" 
...
&nbsp;<asp:ObjectDataSource ID="odsCalendario" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="cmbIngeniro" Name="usuario" 
                ...
                <asp:ControlParameter ControlID="RadScheduler1" Name="RangoInicial" 
                PropertyName="VisibleRangeStart" Type="DateTime" />
                <asp:ControlParameter ControlID="RadScheduler1" Name="RangoFinal" 
                PropertyName="VisibleRangeEnd" Type="DateTime" />
