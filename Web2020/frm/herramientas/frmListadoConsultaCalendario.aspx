<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmListadoConsultaCalendario.aspx.cs" Inherits="Web2020.frm.herramientas.frmListadoConsultaCalendario" %>
        ...
        <dx:ASPxGridView ID="grdDatos" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="cod_usuario" ViewStateMode="Disabled">
            <Columns>  
                ...
                <dx:GridViewDataColumn Caption="Fecha fin Programacion" FieldName="fechafinprogramacion" VisibleIndex="8">
                    <DataItemTemplate>
                        <asp:Label runat="server" ID="Label1" Text='<%# Eval("fechafinprogramacion") %>'></asp:Label>
                    </DataItemTemplate>
                </dx:GridViewDataColumn>
