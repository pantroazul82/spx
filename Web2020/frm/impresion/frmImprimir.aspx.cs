...
namespace Web2020.frm.impresion
{
        ...
        protected void btnEnviarEmail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["nombreReporte"].ToString() == "rptReporteServicio")
                {
                    ...
                    string sqlD = "SELECT archivo, codArchivo, codOrdenServicio, descripcion, nombreArchivo FROM archivosXOrdenServicio "+
                        " WHERE (codOrdenServicio = '"+ codOrden + "')";
                    ds.archivosXOrdenServicio.Merge(
