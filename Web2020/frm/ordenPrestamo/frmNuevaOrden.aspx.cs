    ...
    public partial class frmNuevaOrden : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //cargamos los combos
                SPControladoraDatos.dsSpxTableAdapters.paisesTableAdapter objPais = new SPControladoraDatos.dsSpxTableAdapters.paisesTableAdapter();
                cmbPais.DataSource= objPais.GetData();
                cmbPais.DataBind();
            }
        }
