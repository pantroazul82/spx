...
{
    public partial class frmContactos : System.Web.UI.Page
    {
            ...
            if (Request.Params["cod"] != null || Request.Params["nit"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    if (Request.Params["cod"] != null)
                    {
                        ...
                        if (!ds.contactosClientes[0].IscargoNull())
                            txtCargo.Text = ds.contactosClientes[0].cargo;
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = "El nombre debe tener maximo 20 caracteres!!!";
                return;
            }
            ...
            if (lblCodContacto.Text == string.Empty)
            {
                ...
                obj.Insert(cmbCliente.SelectedValue, codContacto, txtNombreCliente.Text,
                    ...
                    null, txtFax.Text, chkActivo.Checked, txtCargo.Text);
            }
            else
            {
                obj.UpdateContacto(txtNombreCliente.Text, txtApellidosCliente.Text, txtDocumento.Text,
                    ...
                    txtEmail.Text, "", null, txtFax.Text, txtCargo.Text, cmbCliente.SelectedValue,
                    lblCodContacto.Text);
            }
