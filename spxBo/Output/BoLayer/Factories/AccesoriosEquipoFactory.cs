...
namespace BOLayer{
[DataObject]
public partial class AccesoriosEquipoFactory
 {
...
/// <summary>
/// Create a new AccesoriosEquipo Factory .
/// </summary>
public  AccesoriosEquipoFactory()
{
}

/// <summary>
/// Create a new AccesoriosEquipo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  AccesoriosEquipoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type AccesoriosEquipo by using it's Primary Key values. This is the Primary method to retrieve a AccesoriosEquipo.
/// </summary>
public AccesoriosEquipo Fetch(System.String pCodAccesoriosEquipos)
{
if ( String.IsNullOrEmpty(pCodAccesoriosEquipos)) throw new ArgumentException("Argument Name:pCodAccesoriosEquipos. Primary Key Column must have a value (different from null or empty)");
pCodAccesoriosEquipos = pCodAccesoriosEquipos.PadRight(15,' ') ;
AccesoriosEquipo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodAccesoriosEquipos" ,pCodAccesoriosEquipos ));
_bo = (AccesoriosEquipo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type AccesoriosEquipointo the current session by using it's Primary Key values.
/// </summary>
public AccesoriosEquipo Get(System.String pCodAccesoriosEquipos)
{
if ( String.IsNullOrEmpty(pCodAccesoriosEquipos)) throw new ArgumentException("Argument Name:pCodAccesoriosEquipos. Primary Key Column must have a value (different from null or empty)");
pCodAccesoriosEquipos = pCodAccesoriosEquipos.PadRight(15,' ') ;
AccesoriosEquipo _bo = null ;
try 
{
_bo = Session.Get(typeof(AccesoriosEquipo), pCodAccesoriosEquipos) as AccesoriosEquipo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of AccesoriosEquipoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public AccesoriosEquipoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object AccesoriosEquipo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(AccesoriosEquipo),"AccesoriosEquipo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for AccesoriosEquipo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of AccesoriosEquipoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public AccesoriosEquipoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 AccesoriosEquipoCollection _list = new AccesoriosEquipoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of AccesoriosEquipoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public AccesoriosEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of AccesoriosEquipoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public AccesoriosEquipoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public AccesoriosEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of AccesoriosEquipoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public AccesoriosEquipoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pAccesoriosEquipo">A BO of type AccesoriosEquipo</param>
public void ReAttach(AccesoriosEquipo pAccesoriosEquipo)
{
if( pAccesoriosEquipo == null  ) throw new ArgumentNullException("pAccesoriosEquipo");
try 
{
Session.Lock(pAccesoriosEquipo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class AccesoriosEquipo it saves it (insert) to the DataBase
/// </summary>
///<param name="pAccesoriosEquipo">A BO of type AccesoriosEquipo</param>
public void Insert(AccesoriosEquipo pAccesoriosEquipo)
{
if( pAccesoriosEquipo == null  ) throw new ArgumentNullException("pAccesoriosEquipo");
try 
{
BeginTransaction(false);
Session.Save(pAccesoriosEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class AccesoriosEquipo it Inserts them into the DataBase
/// </summary>
///<param name="pListAccesoriosEquipo">A List of AccesoriosEquipo</param>
public void Insert(IEnumerable<AccesoriosEquipo> pListAccesoriosEquipo)
{
if( pListAccesoriosEquipo == null  ) throw new ArgumentNullException("pListAccesoriosEquipo");
try 
{
BeginTransaction(false);
foreach ( AccesoriosEquipo _AccesoriosEquipo in pListAccesoriosEquipo ) 
{
Session.Save(_AccesoriosEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pAccesoriosEquipo">A BO of type AccesoriosEquipo</param>
public void Save(AccesoriosEquipo pAccesoriosEquipo)
{
if( pAccesoriosEquipo == null  ) throw new ArgumentNullException("pAccesoriosEquipo");
try 
{
BeginTransaction(false);
Session.Update(pAccesoriosEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type AccesoriosEquipo
/// </summary>
///<param name="pAccesoriosEquipo">A BO of type AccesoriosEquipo</param>
public void Delete(AccesoriosEquipo pAccesoriosEquipo)
{
if( pAccesoriosEquipo == null  ) throw new ArgumentNullException("pAccesoriosEquipo");
try 
{
BeginTransaction(false);
Session.Delete(pAccesoriosEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type AccesoriosEquipo inside one transaction.
/// </summary>
///<param name="pListAccesoriosEquipo">A List of AccesoriosEquipo</param>
public void Delete(IEnumerable<AccesoriosEquipo> pListAccesoriosEquipo)
{
if( pListAccesoriosEquipo == null  ) throw new ArgumentNullException("pListAccesoriosEquipo");
try 
{
...
foreach ( AccesoriosEquipo _AccesoriosEquipo in pListAccesoriosEquipo ) 
{
Session.Delete(_AccesoriosEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a AccesoriosEquipo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodAccesoriosEquipos)
{
AccesoriosEquipo _accesoriosEquipo = Fetch(pCodAccesoriosEquipos);
if ( _accesoriosEquipo == null ) throw new Exception("Object not found , could not delete");
Delete(_accesoriosEquipo);
...
/// </summary>
///<param name="pAccesoriosEquipo">A BO of type AccesoriosEquipo</param>
public AccesoriosEquipo Dummy(AccesoriosEquipo pAccesoriosEquipo)
{
if( pAccesoriosEquipo == null  ) throw new ArgumentNullException("pAccesoriosEquipo");
return pAccesoriosEquipo;
