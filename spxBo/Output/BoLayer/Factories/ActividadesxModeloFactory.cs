...
namespace BOLayer{
[DataObject]
public partial class ActividadesxModeloFactory
 {
...
/// <summary>
/// Create a new ActividadesxModelo Factory .
/// </summary>
public  ActividadesxModeloFactory()
{
}

/// <summary>
/// Create a new ActividadesxModelo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ActividadesxModeloFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ActividadesxModelo by using it's Primary Key values. This is the Primary method to retrieve a ActividadesxModelo.
/// </summary>
public ActividadesxModelo Fetch(System.String pCodFabricante , System.String pCodModelo , System.Int32 pCodActividad)
{
...
_bo = (ActividadesxModelo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type ActividadesxModelo by using it's Primary Key values. This is the Primary method to retrieve a ActividadesxModelo.
/// </summary>
public ActividadesxModelo FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codActividad = System.Int32.Parse(_keys[2]);
return Fetch(_codFabricante,_codModelo,_codActividad);
...
/// <summary>
/// Get strongly typed collection of ActividadesxModeloCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ActividadesxModeloCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ActividadesxModelo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ActividadesxModelo),"ActividadesxModelo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ActividadesxModelo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ActividadesxModeloCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ActividadesxModeloCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ActividadesxModeloCollection _list = new ActividadesxModeloCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ActividadesxModeloCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ActividadesxModeloCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ActividadesxModeloCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ActividadesxModeloCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ActividadesxModeloCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ActividadesxModeloCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ActividadesxModeloCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pActividadesxModelo">A BO of type ActividadesxModelo</param>
public void ReAttach(ActividadesxModelo pActividadesxModelo)
{
if( pActividadesxModelo == null  ) throw new ArgumentNullException("pActividadesxModelo");
try 
{
Session.Lock(pActividadesxModelo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ActividadesxModelo it saves it (insert) to the DataBase
/// </summary>
///<param name="pActividadesxModelo">A BO of type ActividadesxModelo</param>
public void Insert(ActividadesxModelo pActividadesxModelo)
{
if( pActividadesxModelo == null  ) throw new ArgumentNullException("pActividadesxModelo");
try 
{
BeginTransaction(false);
Session.Save(pActividadesxModelo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ActividadesxModelo it Inserts them into the DataBase
/// </summary>
///<param name="pListActividadesxModelo">A List of ActividadesxModelo</param>
public void Insert(IEnumerable<ActividadesxModelo> pListActividadesxModelo)
{
if( pListActividadesxModelo == null  ) throw new ArgumentNullException("pListActividadesxModelo");
try 
{
BeginTransaction(false);
foreach ( ActividadesxModelo _ActividadesxModelo in pListActividadesxModelo ) 
{
Session.Save(_ActividadesxModelo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pActividadesxModelo">A BO of type ActividadesxModelo</param>
public void Save(ActividadesxModelo pActividadesxModelo)
{
if( pActividadesxModelo == null  ) throw new ArgumentNullException("pActividadesxModelo");
try 
{
BeginTransaction(false);
Session.Update(pActividadesxModelo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ActividadesxModelo
/// </summary>
///<param name="pActividadesxModelo">A BO of type ActividadesxModelo</param>
public void Delete(ActividadesxModelo pActividadesxModelo)
{
if( pActividadesxModelo == null  ) throw new ArgumentNullException("pActividadesxModelo");
try 
{
BeginTransaction(false);
Session.Delete(pActividadesxModelo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ActividadesxModelo inside one transaction.
/// </summary>
///<param name="pListActividadesxModelo">A List of ActividadesxModelo</param>
public void Delete(IEnumerable<ActividadesxModelo> pListActividadesxModelo)
{
if( pListActividadesxModelo == null  ) throw new ArgumentNullException("pListActividadesxModelo");
try 
{
...
foreach ( ActividadesxModelo _ActividadesxModelo in pListActividadesxModelo ) 
{
Session.Delete(_ActividadesxModelo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ActividadesxModelo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodFabricante , System.String pCodModelo , System.Int32 pCodActividad)
{
ActividadesxModelo _actividadesxModelo = Fetch(pCodFabricante , pCodModelo , pCodActividad);
if ( _actividadesxModelo == null ) throw new Exception("Object not found , could not delete");
Delete(_actividadesxModelo);
...
/// </summary>
///<param name="pActividadesxModelo">A BO of type ActividadesxModelo</param>
public ActividadesxModelo Dummy(ActividadesxModelo pActividadesxModelo)
{
if( pActividadesxModelo == null  ) throw new ArgumentNullException("pActividadesxModelo");
return pActividadesxModelo;
