...
namespace BOLayer{
[DataObject]
public partial class ArchivosXOrdenServicioFactory
 {
...
/// <summary>
/// Create a new ArchivosXOrdenServicio Factory .
/// </summary>
public  ArchivosXOrdenServicioFactory()
{
}

/// <summary>
/// Create a new ArchivosXOrdenServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ArchivosXOrdenServicioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ArchivosXOrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a ArchivosXOrdenServicio.
/// </summary>
public ArchivosXOrdenServicio Fetch(System.Int32 pCodOrdenServicio , System.Int32 pCodArchivo)
{
ArchivosXOrdenServicio _bo = null ;
try 
{
...
_bo = (ArchivosXOrdenServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type ArchivosXOrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a ArchivosXOrdenServicio.
/// </summary>
public ArchivosXOrdenServicio FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codOrdenServicio,_codArchivo);
...
/// <summary>
/// Get strongly typed collection of ArchivosXOrdenServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ArchivosXOrdenServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ArchivosXOrdenServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ArchivosXOrdenServicio),"ArchivosXOrdenServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ArchivosXOrdenServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ArchivosXOrdenServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ArchivosXOrdenServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ArchivosXOrdenServicioCollection _list = new ArchivosXOrdenServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ArchivosXOrdenServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ArchivosXOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ArchivosXOrdenServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ArchivosXOrdenServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosXOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ArchivosXOrdenServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosXOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pArchivosXOrdenServicio">A BO of type ArchivosXOrdenServicio</param>
public void ReAttach(ArchivosXOrdenServicio pArchivosXOrdenServicio)
{
if( pArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pArchivosXOrdenServicio");
try 
{
Session.Lock(pArchivosXOrdenServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ArchivosXOrdenServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pArchivosXOrdenServicio">A BO of type ArchivosXOrdenServicio</param>
public void Insert(ArchivosXOrdenServicio pArchivosXOrdenServicio)
{
if( pArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pArchivosXOrdenServicio");
try 
{
BeginTransaction(false);
Session.Save(pArchivosXOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ArchivosXOrdenServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListArchivosXOrdenServicio">A List of ArchivosXOrdenServicio</param>
public void Insert(IEnumerable<ArchivosXOrdenServicio> pListArchivosXOrdenServicio)
{
if( pListArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pListArchivosXOrdenServicio");
try 
{
BeginTransaction(false);
foreach ( ArchivosXOrdenServicio _ArchivosXOrdenServicio in pListArchivosXOrdenServicio ) 
{
Session.Save(_ArchivosXOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pArchivosXOrdenServicio">A BO of type ArchivosXOrdenServicio</param>
public void Save(ArchivosXOrdenServicio pArchivosXOrdenServicio)
{
if( pArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pArchivosXOrdenServicio");
try 
{
BeginTransaction(false);
Session.Update(pArchivosXOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ArchivosXOrdenServicio
/// </summary>
///<param name="pArchivosXOrdenServicio">A BO of type ArchivosXOrdenServicio</param>
public void Delete(ArchivosXOrdenServicio pArchivosXOrdenServicio)
{
if( pArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pArchivosXOrdenServicio");
try 
{
BeginTransaction(false);
Session.Delete(pArchivosXOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ArchivosXOrdenServicio inside one transaction.
/// </summary>
///<param name="pListArchivosXOrdenServicio">A List of ArchivosXOrdenServicio</param>
public void Delete(IEnumerable<ArchivosXOrdenServicio> pListArchivosXOrdenServicio)
{
if( pListArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pListArchivosXOrdenServicio");
try 
{
...
foreach ( ArchivosXOrdenServicio _ArchivosXOrdenServicio in pListArchivosXOrdenServicio ) 
{
Session.Delete(_ArchivosXOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ArchivosXOrdenServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenServicio , System.Int32 pCodArchivo)
{
ArchivosXOrdenServicio _archivosXOrdenServicio = Fetch(pCodOrdenServicio , pCodArchivo);
if ( _archivosXOrdenServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_archivosXOrdenServicio);
...
/// </summary>
///<param name="pArchivosXOrdenServicio">A BO of type ArchivosXOrdenServicio</param>
public ArchivosXOrdenServicio Dummy(ArchivosXOrdenServicio pArchivosXOrdenServicio)
{
if( pArchivosXOrdenServicio == null  ) throw new ArgumentNullException("pArchivosXOrdenServicio");
return pArchivosXOrdenServicio;
