...
namespace BOLayer{
[DataObject]
public partial class ArchivosxEntradaSalidaEquipoFactory
 {
...
/// <summary>
/// Create a new ArchivosxEntradaSalidaEquipo Factory .
/// </summary>
public  ArchivosxEntradaSalidaEquipoFactory()
{
}

/// <summary>
/// Create a new ArchivosxEntradaSalidaEquipo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ArchivosxEntradaSalidaEquipoFactory(SessionScope pSessionScope)
{
...
/// </summary>
~ArchivosxEntradaSalidaEquipoFactory()
{
...
/// <summary>
/// Fetch an object of type ArchivosxEntradaSalidaEquipo by using it's Primary Key values. This is the Primary method to retrieve a ArchivosxEntradaSalidaEquipo.
/// </summary>
public ArchivosxEntradaSalidaEquipo Fetch(System.Int32 pCodarchivosxEntradaSalidaEquipos)
{
ArchivosxEntradaSalidaEquipo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodarchivosxEntradaSalidaEquipos" ,pCodarchivosxEntradaSalidaEquipos ));
_bo = (ArchivosxEntradaSalidaEquipo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type ArchivosxEntradaSalidaEquipointo the current session by using it's Primary Key values.
/// </summary>
public ArchivosxEntradaSalidaEquipo Get(System.Int32 pCodarchivosxEntradaSalidaEquipos)
{
ArchivosxEntradaSalidaEquipo _bo = null ;
try 
{
_bo = Session.Get(typeof(ArchivosxEntradaSalidaEquipo), pCodarchivosxEntradaSalidaEquipos) as ArchivosxEntradaSalidaEquipo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ArchivosxEntradaSalidaEquipoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ArchivosxEntradaSalidaEquipoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ArchivosxEntradaSalidaEquipo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ArchivosxEntradaSalidaEquipo),"ArchivosxEntradaSalidaEquipo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ArchivosxEntradaSalidaEquipo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ArchivosxEntradaSalidaEquipoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ArchivosxEntradaSalidaEquipoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ArchivosxEntradaSalidaEquipoCollection _list = new ArchivosxEntradaSalidaEquipoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ArchivosxEntradaSalidaEquipoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ArchivosxEntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ArchivosxEntradaSalidaEquipoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ArchivosxEntradaSalidaEquipoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosxEntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ArchivosxEntradaSalidaEquipoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosxEntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pArchivosxEntradaSalidaEquipo">A BO of type ArchivosxEntradaSalidaEquipo</param>
public void ReAttach(ArchivosxEntradaSalidaEquipo pArchivosxEntradaSalidaEquipo)
{
if( pArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pArchivosxEntradaSalidaEquipo");
try 
{
Session.Lock(pArchivosxEntradaSalidaEquipo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ArchivosxEntradaSalidaEquipo it saves it (insert) to the DataBase
/// </summary>
///<param name="pArchivosxEntradaSalidaEquipo">A BO of type ArchivosxEntradaSalidaEquipo</param>
public void Insert(ArchivosxEntradaSalidaEquipo pArchivosxEntradaSalidaEquipo)
{
if( pArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pArchivosxEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Save(pArchivosxEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ArchivosxEntradaSalidaEquipo it Inserts them into the DataBase
/// </summary>
///<param name="pListArchivosxEntradaSalidaEquipo">A List of ArchivosxEntradaSalidaEquipo</param>
public void Insert(IEnumerable<ArchivosxEntradaSalidaEquipo> pListArchivosxEntradaSalidaEquipo)
{
if( pListArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pListArchivosxEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
foreach ( ArchivosxEntradaSalidaEquipo _ArchivosxEntradaSalidaEquipo in pListArchivosxEntradaSalidaEquipo ) 
{
Session.Save(_ArchivosxEntradaSalidaEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pArchivosxEntradaSalidaEquipo">A BO of type ArchivosxEntradaSalidaEquipo</param>
public void Save(ArchivosxEntradaSalidaEquipo pArchivosxEntradaSalidaEquipo)
{
if( pArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pArchivosxEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Update(pArchivosxEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ArchivosxEntradaSalidaEquipo
/// </summary>
///<param name="pArchivosxEntradaSalidaEquipo">A BO of type ArchivosxEntradaSalidaEquipo</param>
public void Delete(ArchivosxEntradaSalidaEquipo pArchivosxEntradaSalidaEquipo)
{
if( pArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pArchivosxEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Delete(pArchivosxEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ArchivosxEntradaSalidaEquipo inside one transaction.
/// </summary>
///<param name="pListArchivosxEntradaSalidaEquipo">A List of ArchivosxEntradaSalidaEquipo</param>
public void Delete(IEnumerable<ArchivosxEntradaSalidaEquipo> pListArchivosxEntradaSalidaEquipo)
{
if( pListArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pListArchivosxEntradaSalidaEquipo");
try 
{
...
foreach ( ArchivosxEntradaSalidaEquipo _ArchivosxEntradaSalidaEquipo in pListArchivosxEntradaSalidaEquipo ) 
{
Session.Delete(_ArchivosxEntradaSalidaEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ArchivosxEntradaSalidaEquipo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodarchivosxEntradaSalidaEquipos)
{
ArchivosxEntradaSalidaEquipo _archivosxEntradaSalidaEquipo = Fetch(pCodarchivosxEntradaSalidaEquipos);
if ( _archivosxEntradaSalidaEquipo == null ) throw new Exception("Object not found , could not delete");
Delete(_archivosxEntradaSalidaEquipo);
...
/// </summary>
///<param name="pArchivosxEntradaSalidaEquipo">A BO of type ArchivosxEntradaSalidaEquipo</param>
public ArchivosxEntradaSalidaEquipo Dummy(ArchivosxEntradaSalidaEquipo pArchivosxEntradaSalidaEquipo)
{
if( pArchivosxEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pArchivosxEntradaSalidaEquipo");
return pArchivosxEntradaSalidaEquipo;
