...
namespace BOLayer{
[DataObject]
public partial class ArchivosxcontratoFactory
 {
...
/// <summary>
/// Create a new Archivosxcontrato Factory .
/// </summary>
public  ArchivosxcontratoFactory()
{
}

/// <summary>
/// Create a new Archivosxcontrato Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ArchivosxcontratoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Archivosxcontrato by using it's Primary Key values. This is the Primary method to retrieve a Archivosxcontrato.
/// </summary>
public Archivosxcontrato Fetch(System.String pNumeroContrato , System.Int32 pCodOtroSi , System.Int32 pCodArchivo)
{
...
_bo = (Archivosxcontrato) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type Archivosxcontrato by using it's Primary Key values. This is the Primary method to retrieve a Archivosxcontrato.
/// </summary>
public Archivosxcontrato FetchVirtual(string pVirtualKey)
{
...
return Fetch(_numeroContrato,_codOtroSi,_codArchivo);
...
/// <summary>
/// Get strongly typed collection of ArchivosxcontratoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ArchivosxcontratoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Archivosxcontrato
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Archivosxcontrato),"Archivosxcontrato"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Archivosxcontrato");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ArchivosxcontratoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ArchivosxcontratoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ArchivosxcontratoCollection _list = new ArchivosxcontratoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ArchivosxcontratoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ArchivosxcontratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ArchivosxcontratoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ArchivosxcontratoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosxcontratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ArchivosxcontratoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ArchivosxcontratoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pArchivosxcontrato">A BO of type Archivosxcontrato</param>
public void ReAttach(Archivosxcontrato pArchivosxcontrato)
{
if( pArchivosxcontrato == null  ) throw new ArgumentNullException("pArchivosxcontrato");
try 
{
Session.Lock(pArchivosxcontrato, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Archivosxcontrato it saves it (insert) to the DataBase
/// </summary>
///<param name="pArchivosxcontrato">A BO of type Archivosxcontrato</param>
public void Insert(Archivosxcontrato pArchivosxcontrato)
{
if( pArchivosxcontrato == null  ) throw new ArgumentNullException("pArchivosxcontrato");
try 
{
BeginTransaction(false);
Session.Save(pArchivosxcontrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Archivosxcontrato it Inserts them into the DataBase
/// </summary>
///<param name="pListArchivosxcontrato">A List of Archivosxcontrato</param>
public void Insert(IEnumerable<Archivosxcontrato> pListArchivosxcontrato)
{
if( pListArchivosxcontrato == null  ) throw new ArgumentNullException("pListArchivosxcontrato");
try 
{
BeginTransaction(false);
foreach ( Archivosxcontrato _Archivosxcontrato in pListArchivosxcontrato ) 
{
Session.Save(_Archivosxcontrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pArchivosxcontrato">A BO of type Archivosxcontrato</param>
public void Save(Archivosxcontrato pArchivosxcontrato)
{
if( pArchivosxcontrato == null  ) throw new ArgumentNullException("pArchivosxcontrato");
try 
{
BeginTransaction(false);
Session.Update(pArchivosxcontrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Archivosxcontrato
/// </summary>
///<param name="pArchivosxcontrato">A BO of type Archivosxcontrato</param>
public void Delete(Archivosxcontrato pArchivosxcontrato)
{
if( pArchivosxcontrato == null  ) throw new ArgumentNullException("pArchivosxcontrato");
try 
{
BeginTransaction(false);
Session.Delete(pArchivosxcontrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Archivosxcontrato inside one transaction.
/// </summary>
///<param name="pListArchivosxcontrato">A List of Archivosxcontrato</param>
public void Delete(IEnumerable<Archivosxcontrato> pListArchivosxcontrato)
{
if( pListArchivosxcontrato == null  ) throw new ArgumentNullException("pListArchivosxcontrato");
try 
{
...
foreach ( Archivosxcontrato _Archivosxcontrato in pListArchivosxcontrato ) 
{
Session.Delete(_Archivosxcontrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a Archivosxcontrato object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pNumeroContrato , System.Int32 pCodOtroSi , System.Int32 pCodArchivo)
{
Archivosxcontrato _archivosxcontrato = Fetch(pNumeroContrato , pCodOtroSi , pCodArchivo);
if ( _archivosxcontrato == null ) throw new Exception("Object not found , could not delete");
Delete(_archivosxcontrato);
...
/// </summary>
///<param name="pArchivosxcontrato">A BO of type Archivosxcontrato</param>
public Archivosxcontrato Dummy(Archivosxcontrato pArchivosxcontrato)
{
if( pArchivosxcontrato == null  ) throw new ArgumentNullException("pArchivosxcontrato");
return pArchivosxcontrato;
