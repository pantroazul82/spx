...
namespace BOLayer{
[DataObject]
public partial class CGQ_ParametrosQueryFactory
 {
...
/// <summary>
/// Create a new CGQ_ParametrosQuery Factory .
/// </summary>
public  CGQ_ParametrosQueryFactory()
{
}

/// <summary>
/// Create a new CGQ_ParametrosQuery Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CGQ_ParametrosQueryFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CGQ_ParametrosQuery by using it's Primary Key values. This is the Primary method to retrieve a CGQ_ParametrosQuery.
/// </summary>
public CGQ_ParametrosQuery Fetch(System.Int32 pCodQuery , System.Int32 pCodParametrosQuery)
{
CGQ_ParametrosQuery _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodQuery" ,pCodQuery ));
_criteria.Add(Restrictions.Eq("CodParametrosQuery" ,pCodParametrosQuery ));
_bo = (CGQ_ParametrosQuery) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type CGQ_ParametrosQuery by using it's Primary Key values. This is the Primary method to retrieve a CGQ_ParametrosQuery.
/// </summary>
public CGQ_ParametrosQuery FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codQuery = System.Int32.Parse(_keys[0]);
System.Int32 _codParametrosQuery = System.Int32.Parse(_keys[1]);
return Fetch(_codQuery,_codParametrosQuery);
...
/// <summary>
/// Get strongly typed collection of CGQ_ParametrosQueryCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CGQ_ParametrosQueryCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CGQ_ParametrosQuery
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CGQ_ParametrosQuery),"CGQ_ParametrosQuery"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CGQ_ParametrosQuery");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CGQ_ParametrosQueryCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CGQ_ParametrosQueryCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CGQ_ParametrosQueryCollection _list = new CGQ_ParametrosQueryCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CGQ_ParametrosQueryCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CGQ_ParametrosQueryCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CGQ_ParametrosQueryCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CGQ_ParametrosQueryCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_ParametrosQueryCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CGQ_ParametrosQueryCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_ParametrosQueryCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCGQ_ParametrosQuery">A BO of type CGQ_ParametrosQuery</param>
public void ReAttach(CGQ_ParametrosQuery pCGQ_ParametrosQuery)
{
if( pCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pCGQ_ParametrosQuery");
try 
{
Session.Lock(pCGQ_ParametrosQuery, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CGQ_ParametrosQuery it saves it (insert) to the DataBase
/// </summary>
///<param name="pCGQ_ParametrosQuery">A BO of type CGQ_ParametrosQuery</param>
public void Insert(CGQ_ParametrosQuery pCGQ_ParametrosQuery)
{
if( pCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pCGQ_ParametrosQuery");
try 
{
BeginTransaction(false);
Session.Save(pCGQ_ParametrosQuery);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CGQ_ParametrosQuery it Inserts them into the DataBase
/// </summary>
///<param name="pListCGQ_ParametrosQuery">A List of CGQ_ParametrosQuery</param>
public void Insert(IEnumerable<CGQ_ParametrosQuery> pListCGQ_ParametrosQuery)
{
if( pListCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pListCGQ_ParametrosQuery");
try 
{
BeginTransaction(false);
foreach ( CGQ_ParametrosQuery _CGQ_ParametrosQuery in pListCGQ_ParametrosQuery ) 
{
Session.Save(_CGQ_ParametrosQuery);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCGQ_ParametrosQuery">A BO of type CGQ_ParametrosQuery</param>
public void Save(CGQ_ParametrosQuery pCGQ_ParametrosQuery)
{
if( pCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pCGQ_ParametrosQuery");
try 
{
BeginTransaction(false);
Session.Update(pCGQ_ParametrosQuery);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CGQ_ParametrosQuery
/// </summary>
///<param name="pCGQ_ParametrosQuery">A BO of type CGQ_ParametrosQuery</param>
public void Delete(CGQ_ParametrosQuery pCGQ_ParametrosQuery)
{
if( pCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pCGQ_ParametrosQuery");
try 
{
BeginTransaction(false);
Session.Delete(pCGQ_ParametrosQuery);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CGQ_ParametrosQuery inside one transaction.
/// </summary>
///<param name="pListCGQ_ParametrosQuery">A List of CGQ_ParametrosQuery</param>
public void Delete(IEnumerable<CGQ_ParametrosQuery> pListCGQ_ParametrosQuery)
{
if( pListCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pListCGQ_ParametrosQuery");
try 
{
...
foreach ( CGQ_ParametrosQuery _CGQ_ParametrosQuery in pListCGQ_ParametrosQuery ) 
{
Session.Delete(_CGQ_ParametrosQuery);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a CGQ_ParametrosQuery object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodQuery , System.Int32 pCodParametrosQuery)
{
CGQ_ParametrosQuery _cGQ_ParametrosQuery = Fetch(pCodQuery , pCodParametrosQuery);
if ( _cGQ_ParametrosQuery == null ) throw new Exception("Object not found , could not delete");
Delete(_cGQ_ParametrosQuery);
...
/// </summary>
///<param name="pCGQ_ParametrosQuery">A BO of type CGQ_ParametrosQuery</param>
public CGQ_ParametrosQuery Dummy(CGQ_ParametrosQuery pCGQ_ParametrosQuery)
{
if( pCGQ_ParametrosQuery == null  ) throw new ArgumentNullException("pCGQ_ParametrosQuery");
return pCGQ_ParametrosQuery;
