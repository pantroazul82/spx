...
namespace BOLayer{
[DataObject]
public partial class CGQ_QueryFactory
 {
...
/// <summary>
/// Create a new CGQ_Query Factory .
/// </summary>
public  CGQ_QueryFactory()
{
}

/// <summary>
/// Create a new CGQ_Query Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CGQ_QueryFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CGQ_Query by using it's Primary Key values. This is the Primary method to retrieve a CGQ_Query.
/// </summary>
public CGQ_Query Fetch(System.Int32 pCodQuery)
{
CGQ_Query _bo = null ;
try 
{
...
_bo = (CGQ_Query) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CGQ_Queryinto the current session by using it's Primary Key values.
/// </summary>
public CGQ_Query Get(System.Int32 pCodQuery)
{
CGQ_Query _bo = null ;
try 
{
_bo = Session.Get(typeof(CGQ_Query), pCodQuery) as CGQ_Query;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CGQ_QueryCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CGQ_QueryCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CGQ_Query
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CGQ_Query),"CGQ_Query"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CGQ_Query");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CGQ_QueryCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CGQ_QueryCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CGQ_QueryCollection _list = new CGQ_QueryCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CGQ_QueryCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CGQ_QueryCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CGQ_QueryCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CGQ_QueryCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_QueryCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CGQ_QueryCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_QueryCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCGQ_Query">A BO of type CGQ_Query</param>
public void ReAttach(CGQ_Query pCGQ_Query)
{
if( pCGQ_Query == null  ) throw new ArgumentNullException("pCGQ_Query");
try 
{
Session.Lock(pCGQ_Query, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CGQ_Query it saves it (insert) to the DataBase
/// </summary>
///<param name="pCGQ_Query">A BO of type CGQ_Query</param>
public void Insert(CGQ_Query pCGQ_Query)
{
if( pCGQ_Query == null  ) throw new ArgumentNullException("pCGQ_Query");
try 
{
BeginTransaction(false);
Session.Save(pCGQ_Query);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CGQ_Query it Inserts them into the DataBase
/// </summary>
///<param name="pListCGQ_Query">A List of CGQ_Query</param>
public void Insert(IEnumerable<CGQ_Query> pListCGQ_Query)
{
if( pListCGQ_Query == null  ) throw new ArgumentNullException("pListCGQ_Query");
try 
{
BeginTransaction(false);
foreach ( CGQ_Query _CGQ_Query in pListCGQ_Query ) 
{
Session.Save(_CGQ_Query);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCGQ_Query">A BO of type CGQ_Query</param>
public void Save(CGQ_Query pCGQ_Query)
{
if( pCGQ_Query == null  ) throw new ArgumentNullException("pCGQ_Query");
try 
{
BeginTransaction(false);
Session.Update(pCGQ_Query);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CGQ_Query
/// </summary>
///<param name="pCGQ_Query">A BO of type CGQ_Query</param>
public void Delete(CGQ_Query pCGQ_Query)
{
if( pCGQ_Query == null  ) throw new ArgumentNullException("pCGQ_Query");
try 
{
BeginTransaction(false);
Session.Delete(pCGQ_Query);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CGQ_Query inside one transaction.
/// </summary>
///<param name="pListCGQ_Query">A List of CGQ_Query</param>
public void Delete(IEnumerable<CGQ_Query> pListCGQ_Query)
{
if( pListCGQ_Query == null  ) throw new ArgumentNullException("pListCGQ_Query");
try 
{
...
/// <summary>
/// Delete a CGQ_Query object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodQuery)
{
CGQ_Query _cGQ_Query = Fetch(pCodQuery);
if ( _cGQ_Query == null ) throw new Exception("Object not found , could not delete");
Delete(_cGQ_Query);
...
/// </summary>
///<param name="pCGQ_Query">A BO of type CGQ_Query</param>
public CGQ_Query Dummy(CGQ_Query pCGQ_Query)
{
if( pCGQ_Query == null  ) throw new ArgumentNullException("pCGQ_Query");
return pCGQ_Query;
