...
namespace BOLayer{
[DataObject]
public partial class CGQ_TipoFiltroFactory
 {
...
/// <summary>
/// Create a new CGQ_TipoFiltro Factory .
/// </summary>
public  CGQ_TipoFiltroFactory()
{
}

/// <summary>
/// Create a new CGQ_TipoFiltro Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CGQ_TipoFiltroFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CGQ_TipoFiltro by using it's Primary Key values. This is the Primary method to retrieve a CGQ_TipoFiltro.
/// </summary>
public CGQ_TipoFiltro Fetch(System.Int32 pCodTipoFiltro)
{
CGQ_TipoFiltro _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTipoFiltro" ,pCodTipoFiltro ));
_bo = (CGQ_TipoFiltro) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CGQ_TipoFiltrointo the current session by using it's Primary Key values.
/// </summary>
public CGQ_TipoFiltro Get(System.Int32 pCodTipoFiltro)
{
CGQ_TipoFiltro _bo = null ;
try 
{
_bo = Session.Get(typeof(CGQ_TipoFiltro), pCodTipoFiltro) as CGQ_TipoFiltro;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CGQ_TipoFiltroCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CGQ_TipoFiltroCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CGQ_TipoFiltro
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CGQ_TipoFiltro),"CGQ_TipoFiltro"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CGQ_TipoFiltro");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CGQ_TipoFiltroCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CGQ_TipoFiltroCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CGQ_TipoFiltroCollection _list = new CGQ_TipoFiltroCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CGQ_TipoFiltroCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CGQ_TipoFiltroCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CGQ_TipoFiltroCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CGQ_TipoFiltroCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_TipoFiltroCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CGQ_TipoFiltroCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CGQ_TipoFiltroCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCGQ_TipoFiltro">A BO of type CGQ_TipoFiltro</param>
public void ReAttach(CGQ_TipoFiltro pCGQ_TipoFiltro)
{
if( pCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pCGQ_TipoFiltro");
try 
{
Session.Lock(pCGQ_TipoFiltro, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CGQ_TipoFiltro it saves it (insert) to the DataBase
/// </summary>
///<param name="pCGQ_TipoFiltro">A BO of type CGQ_TipoFiltro</param>
public void Insert(CGQ_TipoFiltro pCGQ_TipoFiltro)
{
if( pCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pCGQ_TipoFiltro");
try 
{
BeginTransaction(false);
Session.Save(pCGQ_TipoFiltro);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CGQ_TipoFiltro it Inserts them into the DataBase
/// </summary>
///<param name="pListCGQ_TipoFiltro">A List of CGQ_TipoFiltro</param>
public void Insert(IEnumerable<CGQ_TipoFiltro> pListCGQ_TipoFiltro)
{
if( pListCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pListCGQ_TipoFiltro");
try 
{
BeginTransaction(false);
foreach ( CGQ_TipoFiltro _CGQ_TipoFiltro in pListCGQ_TipoFiltro ) 
{
Session.Save(_CGQ_TipoFiltro);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCGQ_TipoFiltro">A BO of type CGQ_TipoFiltro</param>
public void Save(CGQ_TipoFiltro pCGQ_TipoFiltro)
{
if( pCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pCGQ_TipoFiltro");
try 
{
BeginTransaction(false);
Session.Update(pCGQ_TipoFiltro);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CGQ_TipoFiltro
/// </summary>
///<param name="pCGQ_TipoFiltro">A BO of type CGQ_TipoFiltro</param>
public void Delete(CGQ_TipoFiltro pCGQ_TipoFiltro)
{
if( pCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pCGQ_TipoFiltro");
try 
{
BeginTransaction(false);
Session.Delete(pCGQ_TipoFiltro);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CGQ_TipoFiltro inside one transaction.
/// </summary>
///<param name="pListCGQ_TipoFiltro">A List of CGQ_TipoFiltro</param>
public void Delete(IEnumerable<CGQ_TipoFiltro> pListCGQ_TipoFiltro)
{
if( pListCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pListCGQ_TipoFiltro");
try 
{
...
foreach ( CGQ_TipoFiltro _CGQ_TipoFiltro in pListCGQ_TipoFiltro ) 
{
Session.Delete(_CGQ_TipoFiltro);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a CGQ_TipoFiltro object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTipoFiltro)
{
CGQ_TipoFiltro _cGQ_TipoFiltro = Fetch(pCodTipoFiltro);
if ( _cGQ_TipoFiltro == null ) throw new Exception("Object not found , could not delete");
Delete(_cGQ_TipoFiltro);
...
/// </summary>
///<param name="pCGQ_TipoFiltro">A BO of type CGQ_TipoFiltro</param>
public CGQ_TipoFiltro Dummy(CGQ_TipoFiltro pCGQ_TipoFiltro)
{
if( pCGQ_TipoFiltro == null  ) throw new ArgumentNullException("pCGQ_TipoFiltro");
return pCGQ_TipoFiltro;
