...
namespace BOLayer{
[DataObject]
public partial class CgSmtpAdjuntoFactory
 {
...
/// <summary>
/// Create a new CgSmtpAdjunto Factory .
/// </summary>
public  CgSmtpAdjuntoFactory()
{
}

/// <summary>
/// Create a new CgSmtpAdjunto Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpAdjuntoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpAdjunto by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpAdjunto.
/// </summary>
public CgSmtpAdjunto Fetch(System.Int32 pIdCgSmtpAdjuntos)
{
CgSmtpAdjunto _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpAdjuntos" ,pIdCgSmtpAdjuntos ));
_bo = (CgSmtpAdjunto) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpAdjuntointo the current session by using it's Primary Key values.
/// </summary>
public CgSmtpAdjunto Get(System.Int32 pIdCgSmtpAdjuntos)
{
CgSmtpAdjunto _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpAdjunto), pIdCgSmtpAdjuntos) as CgSmtpAdjunto;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpAdjuntoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpAdjuntoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpAdjunto
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpAdjunto),"CgSmtpAdjunto"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpAdjunto");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpAdjuntoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpAdjuntoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpAdjuntoCollection _list = new CgSmtpAdjuntoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpAdjuntoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpAdjuntoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpAdjuntoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpAdjuntoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpAdjunto">A BO of type CgSmtpAdjunto</param>
public void ReAttach(CgSmtpAdjunto pCgSmtpAdjunto)
{
if( pCgSmtpAdjunto == null  ) throw new ArgumentNullException("pCgSmtpAdjunto");
try 
{
Session.Lock(pCgSmtpAdjunto, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpAdjunto it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpAdjunto">A BO of type CgSmtpAdjunto</param>
public void Insert(CgSmtpAdjunto pCgSmtpAdjunto)
{
if( pCgSmtpAdjunto == null  ) throw new ArgumentNullException("pCgSmtpAdjunto");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpAdjunto it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpAdjunto">A List of CgSmtpAdjunto</param>
public void Insert(IEnumerable<CgSmtpAdjunto> pListCgSmtpAdjunto)
{
if( pListCgSmtpAdjunto == null  ) throw new ArgumentNullException("pListCgSmtpAdjunto");
try 
{
BeginTransaction(false);
foreach ( CgSmtpAdjunto _CgSmtpAdjunto in pListCgSmtpAdjunto ) 
{
Session.Save(_CgSmtpAdjunto);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpAdjunto">A BO of type CgSmtpAdjunto</param>
public void Save(CgSmtpAdjunto pCgSmtpAdjunto)
{
if( pCgSmtpAdjunto == null  ) throw new ArgumentNullException("pCgSmtpAdjunto");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpAdjunto
/// </summary>
///<param name="pCgSmtpAdjunto">A BO of type CgSmtpAdjunto</param>
public void Delete(CgSmtpAdjunto pCgSmtpAdjunto)
{
if( pCgSmtpAdjunto == null  ) throw new ArgumentNullException("pCgSmtpAdjunto");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpAdjunto inside one transaction.
/// </summary>
///<param name="pListCgSmtpAdjunto">A List of CgSmtpAdjunto</param>
public void Delete(IEnumerable<CgSmtpAdjunto> pListCgSmtpAdjunto)
{
if( pListCgSmtpAdjunto == null  ) throw new ArgumentNullException("pListCgSmtpAdjunto");
try 
{
...
/// <summary>
/// Delete a CgSmtpAdjunto object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpAdjuntos)
{
CgSmtpAdjunto _cgSmtpAdjunto = Fetch(pIdCgSmtpAdjuntos);
if ( _cgSmtpAdjunto == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpAdjunto);
...
/// </summary>
///<param name="pCgSmtpAdjunto">A BO of type CgSmtpAdjunto</param>
public CgSmtpAdjunto Dummy(CgSmtpAdjunto pCgSmtpAdjunto)
{
if( pCgSmtpAdjunto == null  ) throw new ArgumentNullException("pCgSmtpAdjunto");
return pCgSmtpAdjunto;
