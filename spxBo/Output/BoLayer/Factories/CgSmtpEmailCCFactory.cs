...
namespace BOLayer{
[DataObject]
public partial class CgSmtpEmailCCFactory
 {
...
/// <summary>
/// Create a new CgSmtpEmailCC Factory .
/// </summary>
public  CgSmtpEmailCCFactory()
{
}

/// <summary>
/// Create a new CgSmtpEmailCC Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpEmailCCFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpEmailCC by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpEmailCC.
/// </summary>
public CgSmtpEmailCC Fetch(System.Int32 pIdCgSmtpEmailCC)
{
CgSmtpEmailCC _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpEmailCC" ,pIdCgSmtpEmailCC ));
_bo = (CgSmtpEmailCC) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpEmailCCinto the current session by using it's Primary Key values.
/// </summary>
public CgSmtpEmailCC Get(System.Int32 pIdCgSmtpEmailCC)
{
CgSmtpEmailCC _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpEmailCC), pIdCgSmtpEmailCC) as CgSmtpEmailCC;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpEmailCCCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpEmailCCCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpEmailCC
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpEmailCC),"CgSmtpEmailCC"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpEmailCC");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCCCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpEmailCCCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpEmailCCCollection _list = new CgSmtpEmailCCCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCCCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpEmailCCCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCCCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpEmailCCCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailCCCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpEmailCCCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailCCCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpEmailCC">A BO of type CgSmtpEmailCC</param>
public void ReAttach(CgSmtpEmailCC pCgSmtpEmailCC)
{
if( pCgSmtpEmailCC == null  ) throw new ArgumentNullException("pCgSmtpEmailCC");
try 
{
Session.Lock(pCgSmtpEmailCC, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpEmailCC it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpEmailCC">A BO of type CgSmtpEmailCC</param>
public void Insert(CgSmtpEmailCC pCgSmtpEmailCC)
{
if( pCgSmtpEmailCC == null  ) throw new ArgumentNullException("pCgSmtpEmailCC");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpEmailCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpEmailCC it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpEmailCC">A List of CgSmtpEmailCC</param>
public void Insert(IEnumerable<CgSmtpEmailCC> pListCgSmtpEmailCC)
{
if( pListCgSmtpEmailCC == null  ) throw new ArgumentNullException("pListCgSmtpEmailCC");
try 
{
BeginTransaction(false);
foreach ( CgSmtpEmailCC _CgSmtpEmailCC in pListCgSmtpEmailCC ) 
{
Session.Save(_CgSmtpEmailCC);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpEmailCC">A BO of type CgSmtpEmailCC</param>
public void Save(CgSmtpEmailCC pCgSmtpEmailCC)
{
if( pCgSmtpEmailCC == null  ) throw new ArgumentNullException("pCgSmtpEmailCC");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpEmailCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpEmailCC
/// </summary>
///<param name="pCgSmtpEmailCC">A BO of type CgSmtpEmailCC</param>
public void Delete(CgSmtpEmailCC pCgSmtpEmailCC)
{
if( pCgSmtpEmailCC == null  ) throw new ArgumentNullException("pCgSmtpEmailCC");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpEmailCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpEmailCC inside one transaction.
/// </summary>
///<param name="pListCgSmtpEmailCC">A List of CgSmtpEmailCC</param>
public void Delete(IEnumerable<CgSmtpEmailCC> pListCgSmtpEmailCC)
{
if( pListCgSmtpEmailCC == null  ) throw new ArgumentNullException("pListCgSmtpEmailCC");
try 
{
...
/// <summary>
/// Delete a CgSmtpEmailCC object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpEmailCC)
{
CgSmtpEmailCC _cgSmtpEmailCC = Fetch(pIdCgSmtpEmailCC);
if ( _cgSmtpEmailCC == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpEmailCC);
...
/// </summary>
///<param name="pCgSmtpEmailCC">A BO of type CgSmtpEmailCC</param>
public CgSmtpEmailCC Dummy(CgSmtpEmailCC pCgSmtpEmailCC)
{
if( pCgSmtpEmailCC == null  ) throw new ArgumentNullException("pCgSmtpEmailCC");
return pCgSmtpEmailCC;
