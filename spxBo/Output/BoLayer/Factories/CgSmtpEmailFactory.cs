...
namespace BOLayer{
[DataObject]
public partial class CgSmtpEmailFactory
 {
...
/// <summary>
/// Create a new CgSmtpEmail Factory .
/// </summary>
public  CgSmtpEmailFactory()
{
}

/// <summary>
/// Create a new CgSmtpEmail Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpEmailFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpEmail by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpEmail.
/// </summary>
public CgSmtpEmail Fetch(System.Int32 pIdCgSmtpEmail)
{
CgSmtpEmail _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpEmail" ,pIdCgSmtpEmail ));
_bo = (CgSmtpEmail) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpEmailinto the current session by using it's Primary Key values.
/// </summary>
public CgSmtpEmail Get(System.Int32 pIdCgSmtpEmail)
{
CgSmtpEmail _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpEmail), pIdCgSmtpEmail) as CgSmtpEmail;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpEmailCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpEmailCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpEmail
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpEmail),"CgSmtpEmail"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpEmail");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpEmailCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpEmailCollection _list = new CgSmtpEmailCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpEmailCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpEmailCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpEmailCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpEmailCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpEmail">A BO of type CgSmtpEmail</param>
public void ReAttach(CgSmtpEmail pCgSmtpEmail)
{
if( pCgSmtpEmail == null  ) throw new ArgumentNullException("pCgSmtpEmail");
try 
{
Session.Lock(pCgSmtpEmail, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpEmail it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpEmail">A BO of type CgSmtpEmail</param>
public void Insert(CgSmtpEmail pCgSmtpEmail)
{
if( pCgSmtpEmail == null  ) throw new ArgumentNullException("pCgSmtpEmail");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpEmail);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpEmail it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpEmail">A List of CgSmtpEmail</param>
public void Insert(IEnumerable<CgSmtpEmail> pListCgSmtpEmail)
{
if( pListCgSmtpEmail == null  ) throw new ArgumentNullException("pListCgSmtpEmail");
try 
{
BeginTransaction(false);
foreach ( CgSmtpEmail _CgSmtpEmail in pListCgSmtpEmail ) 
{
Session.Save(_CgSmtpEmail);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpEmail">A BO of type CgSmtpEmail</param>
public void Save(CgSmtpEmail pCgSmtpEmail)
{
if( pCgSmtpEmail == null  ) throw new ArgumentNullException("pCgSmtpEmail");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpEmail);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpEmail
/// </summary>
///<param name="pCgSmtpEmail">A BO of type CgSmtpEmail</param>
public void Delete(CgSmtpEmail pCgSmtpEmail)
{
if( pCgSmtpEmail == null  ) throw new ArgumentNullException("pCgSmtpEmail");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpEmail);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpEmail inside one transaction.
/// </summary>
///<param name="pListCgSmtpEmail">A List of CgSmtpEmail</param>
public void Delete(IEnumerable<CgSmtpEmail> pListCgSmtpEmail)
{
if( pListCgSmtpEmail == null  ) throw new ArgumentNullException("pListCgSmtpEmail");
try 
{
...
/// <summary>
/// Delete a CgSmtpEmail object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpEmail)
{
CgSmtpEmail _cgSmtpEmail = Fetch(pIdCgSmtpEmail);
if ( _cgSmtpEmail == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpEmail);
...
/// </summary>
///<param name="pCgSmtpEmail">A BO of type CgSmtpEmail</param>
public CgSmtpEmail Dummy(CgSmtpEmail pCgSmtpEmail)
{
if( pCgSmtpEmail == null  ) throw new ArgumentNullException("pCgSmtpEmail");
return pCgSmtpEmail;
