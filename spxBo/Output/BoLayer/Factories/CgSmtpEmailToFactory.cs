...
namespace BOLayer{
[DataObject]
public partial class CgSmtpEmailToFactory
 {
...
/// <summary>
/// Create a new CgSmtpEmailTo Factory .
/// </summary>
public  CgSmtpEmailToFactory()
{
}

/// <summary>
/// Create a new CgSmtpEmailTo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpEmailToFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpEmailTo by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpEmailTo.
/// </summary>
public CgSmtpEmailTo Fetch(System.Int32 pIdCgSmtpEmailTo)
{
CgSmtpEmailTo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpEmailTo" ,pIdCgSmtpEmailTo ));
_bo = (CgSmtpEmailTo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpEmailTointo the current session by using it's Primary Key values.
/// </summary>
public CgSmtpEmailTo Get(System.Int32 pIdCgSmtpEmailTo)
{
CgSmtpEmailTo _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpEmailTo), pIdCgSmtpEmailTo) as CgSmtpEmailTo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpEmailToCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpEmailToCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpEmailTo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpEmailTo),"CgSmtpEmailTo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpEmailTo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailToCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpEmailToCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpEmailToCollection _list = new CgSmtpEmailToCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpEmailToCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpEmailToCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpEmailToCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpEmailToCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailToCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpEmailToCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpEmailToCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpEmailTo">A BO of type CgSmtpEmailTo</param>
public void ReAttach(CgSmtpEmailTo pCgSmtpEmailTo)
{
if( pCgSmtpEmailTo == null  ) throw new ArgumentNullException("pCgSmtpEmailTo");
try 
{
Session.Lock(pCgSmtpEmailTo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpEmailTo it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpEmailTo">A BO of type CgSmtpEmailTo</param>
public void Insert(CgSmtpEmailTo pCgSmtpEmailTo)
{
if( pCgSmtpEmailTo == null  ) throw new ArgumentNullException("pCgSmtpEmailTo");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpEmailTo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpEmailTo it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpEmailTo">A List of CgSmtpEmailTo</param>
public void Insert(IEnumerable<CgSmtpEmailTo> pListCgSmtpEmailTo)
{
if( pListCgSmtpEmailTo == null  ) throw new ArgumentNullException("pListCgSmtpEmailTo");
try 
{
BeginTransaction(false);
foreach ( CgSmtpEmailTo _CgSmtpEmailTo in pListCgSmtpEmailTo ) 
{
Session.Save(_CgSmtpEmailTo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpEmailTo">A BO of type CgSmtpEmailTo</param>
public void Save(CgSmtpEmailTo pCgSmtpEmailTo)
{
if( pCgSmtpEmailTo == null  ) throw new ArgumentNullException("pCgSmtpEmailTo");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpEmailTo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpEmailTo
/// </summary>
///<param name="pCgSmtpEmailTo">A BO of type CgSmtpEmailTo</param>
public void Delete(CgSmtpEmailTo pCgSmtpEmailTo)
{
if( pCgSmtpEmailTo == null  ) throw new ArgumentNullException("pCgSmtpEmailTo");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpEmailTo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpEmailTo inside one transaction.
/// </summary>
///<param name="pListCgSmtpEmailTo">A List of CgSmtpEmailTo</param>
public void Delete(IEnumerable<CgSmtpEmailTo> pListCgSmtpEmailTo)
{
if( pListCgSmtpEmailTo == null  ) throw new ArgumentNullException("pListCgSmtpEmailTo");
try 
{
...
/// <summary>
/// Delete a CgSmtpEmailTo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpEmailTo)
{
CgSmtpEmailTo _cgSmtpEmailTo = Fetch(pIdCgSmtpEmailTo);
if ( _cgSmtpEmailTo == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpEmailTo);
...
/// </summary>
///<param name="pCgSmtpEmailTo">A BO of type CgSmtpEmailTo</param>
public CgSmtpEmailTo Dummy(CgSmtpEmailTo pCgSmtpEmailTo)
{
if( pCgSmtpEmailTo == null  ) throw new ArgumentNullException("pCgSmtpEmailTo");
return pCgSmtpEmailTo;
