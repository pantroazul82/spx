...
namespace BOLayer{
[DataObject]
public partial class CgSmtpServerCCFactory
 {
...
/// <summary>
/// Create a new CgSmtpServerCC Factory .
/// </summary>
public  CgSmtpServerCCFactory()
{
}

/// <summary>
/// Create a new CgSmtpServerCC Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpServerCCFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpServerCC by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpServerCC.
/// </summary>
public CgSmtpServerCC Fetch(System.Int32 pIdCgSmtpServerCC)
{
CgSmtpServerCC _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpServerCC" ,pIdCgSmtpServerCC ));
_bo = (CgSmtpServerCC) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpServerCCinto the current session by using it's Primary Key values.
/// </summary>
public CgSmtpServerCC Get(System.Int32 pIdCgSmtpServerCC)
{
CgSmtpServerCC _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpServerCC), pIdCgSmtpServerCC) as CgSmtpServerCC;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpServerCCCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpServerCCCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpServerCC
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpServerCC),"CgSmtpServerCC"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpServerCC");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpServerCCCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpServerCCCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpServerCCCollection _list = new CgSmtpServerCCCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpServerCCCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpServerCCCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpServerCCCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpServerCCCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpServerCCCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpServerCCCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpServerCCCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpServerCC">A BO of type CgSmtpServerCC</param>
public void ReAttach(CgSmtpServerCC pCgSmtpServerCC)
{
if( pCgSmtpServerCC == null  ) throw new ArgumentNullException("pCgSmtpServerCC");
try 
{
Session.Lock(pCgSmtpServerCC, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpServerCC it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpServerCC">A BO of type CgSmtpServerCC</param>
public void Insert(CgSmtpServerCC pCgSmtpServerCC)
{
if( pCgSmtpServerCC == null  ) throw new ArgumentNullException("pCgSmtpServerCC");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpServerCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpServerCC it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpServerCC">A List of CgSmtpServerCC</param>
public void Insert(IEnumerable<CgSmtpServerCC> pListCgSmtpServerCC)
{
if( pListCgSmtpServerCC == null  ) throw new ArgumentNullException("pListCgSmtpServerCC");
try 
{
BeginTransaction(false);
foreach ( CgSmtpServerCC _CgSmtpServerCC in pListCgSmtpServerCC ) 
{
Session.Save(_CgSmtpServerCC);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpServerCC">A BO of type CgSmtpServerCC</param>
public void Save(CgSmtpServerCC pCgSmtpServerCC)
{
if( pCgSmtpServerCC == null  ) throw new ArgumentNullException("pCgSmtpServerCC");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpServerCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpServerCC
/// </summary>
///<param name="pCgSmtpServerCC">A BO of type CgSmtpServerCC</param>
public void Delete(CgSmtpServerCC pCgSmtpServerCC)
{
if( pCgSmtpServerCC == null  ) throw new ArgumentNullException("pCgSmtpServerCC");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpServerCC);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpServerCC inside one transaction.
/// </summary>
///<param name="pListCgSmtpServerCC">A List of CgSmtpServerCC</param>
public void Delete(IEnumerable<CgSmtpServerCC> pListCgSmtpServerCC)
{
if( pListCgSmtpServerCC == null  ) throw new ArgumentNullException("pListCgSmtpServerCC");
try 
{
...
foreach ( CgSmtpServerCC _CgSmtpServerCC in pListCgSmtpServerCC ) 
{
Session.Delete(_CgSmtpServerCC);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a CgSmtpServerCC object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpServerCC)
{
CgSmtpServerCC _cgSmtpServerCC = Fetch(pIdCgSmtpServerCC);
if ( _cgSmtpServerCC == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpServerCC);
...
/// </summary>
///<param name="pCgSmtpServerCC">A BO of type CgSmtpServerCC</param>
public CgSmtpServerCC Dummy(CgSmtpServerCC pCgSmtpServerCC)
{
if( pCgSmtpServerCC == null  ) throw new ArgumentNullException("pCgSmtpServerCC");
return pCgSmtpServerCC;
