...
namespace BOLayer{
[DataObject]
public partial class CgSmtpServerFactory
 {
...
/// <summary>
/// Create a new CgSmtpServer Factory .
/// </summary>
public  CgSmtpServerFactory()
{
}

/// <summary>
/// Create a new CgSmtpServer Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CgSmtpServerFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type CgSmtpServer by using it's Primary Key values. This is the Primary method to retrieve a CgSmtpServer.
/// </summary>
public CgSmtpServer Fetch(System.Int32 pIdCgSmtpServer)
{
CgSmtpServer _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdCgSmtpServer" ,pIdCgSmtpServer ));
_bo = (CgSmtpServer) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type CgSmtpServerinto the current session by using it's Primary Key values.
/// </summary>
public CgSmtpServer Get(System.Int32 pIdCgSmtpServer)
{
CgSmtpServer _bo = null ;
try 
{
_bo = Session.Get(typeof(CgSmtpServer), pIdCgSmtpServer) as CgSmtpServer;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of CgSmtpServerCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CgSmtpServerCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object CgSmtpServer
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(CgSmtpServer),"CgSmtpServer"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for CgSmtpServer");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpServerCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CgSmtpServerCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CgSmtpServerCollection _list = new CgSmtpServerCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CgSmtpServerCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CgSmtpServerCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CgSmtpServerCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CgSmtpServerCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpServerCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CgSmtpServerCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CgSmtpServerCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCgSmtpServer">A BO of type CgSmtpServer</param>
public void ReAttach(CgSmtpServer pCgSmtpServer)
{
if( pCgSmtpServer == null  ) throw new ArgumentNullException("pCgSmtpServer");
try 
{
Session.Lock(pCgSmtpServer, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class CgSmtpServer it saves it (insert) to the DataBase
/// </summary>
///<param name="pCgSmtpServer">A BO of type CgSmtpServer</param>
public void Insert(CgSmtpServer pCgSmtpServer)
{
if( pCgSmtpServer == null  ) throw new ArgumentNullException("pCgSmtpServer");
try 
{
BeginTransaction(false);
Session.Save(pCgSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class CgSmtpServer it Inserts them into the DataBase
/// </summary>
///<param name="pListCgSmtpServer">A List of CgSmtpServer</param>
public void Insert(IEnumerable<CgSmtpServer> pListCgSmtpServer)
{
if( pListCgSmtpServer == null  ) throw new ArgumentNullException("pListCgSmtpServer");
try 
{
BeginTransaction(false);
foreach ( CgSmtpServer _CgSmtpServer in pListCgSmtpServer ) 
{
Session.Save(_CgSmtpServer);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCgSmtpServer">A BO of type CgSmtpServer</param>
public void Save(CgSmtpServer pCgSmtpServer)
{
if( pCgSmtpServer == null  ) throw new ArgumentNullException("pCgSmtpServer");
try 
{
BeginTransaction(false);
Session.Update(pCgSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type CgSmtpServer
/// </summary>
///<param name="pCgSmtpServer">A BO of type CgSmtpServer</param>
public void Delete(CgSmtpServer pCgSmtpServer)
{
if( pCgSmtpServer == null  ) throw new ArgumentNullException("pCgSmtpServer");
try 
{
BeginTransaction(false);
Session.Delete(pCgSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type CgSmtpServer inside one transaction.
/// </summary>
///<param name="pListCgSmtpServer">A List of CgSmtpServer</param>
public void Delete(IEnumerable<CgSmtpServer> pListCgSmtpServer)
{
if( pListCgSmtpServer == null  ) throw new ArgumentNullException("pListCgSmtpServer");
try 
{
...
/// <summary>
/// Delete a CgSmtpServer object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpServer)
{
CgSmtpServer _cgSmtpServer = Fetch(pIdCgSmtpServer);
if ( _cgSmtpServer == null ) throw new Exception("Object not found , could not delete");
Delete(_cgSmtpServer);
...
/// </summary>
///<param name="pCgSmtpServer">A BO of type CgSmtpServer</param>
public CgSmtpServer Dummy(CgSmtpServer pCgSmtpServer)
{
if( pCgSmtpServer == null  ) throw new ArgumentNullException("pCgSmtpServer");
return pCgSmtpServer;
