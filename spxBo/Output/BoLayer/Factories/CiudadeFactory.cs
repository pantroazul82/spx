...
namespace BOLayer{
[DataObject]
public partial class CiudadeFactory
 {
...
/// <summary>
/// Create a new Ciudade Factory .
/// </summary>
public  CiudadeFactory()
{
}

/// <summary>
/// Create a new Ciudade Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  CiudadeFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Ciudade by using it's Primary Key values. This is the Primary method to retrieve a Ciudade.
/// </summary>
public Ciudade Fetch(System.String pCodPais , System.String pCodDepartamento , System.String pCodCiudad)
{
...
_bo = (Ciudade) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type Ciudade by using it's Primary Key values. This is the Primary method to retrieve a Ciudade.
/// </summary>
public Ciudade FetchVirtual(string pVirtualKey)
{
...
System.String _codCiudad = _keys[2];
return Fetch(_codPais,_codDepartamento,_codCiudad);
...
/// <summary>
/// Get strongly typed collection of CiudadeCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public CiudadeCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Ciudade
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Ciudade),"Ciudade"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Ciudade");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of CiudadeCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public CiudadeCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 CiudadeCollection _list = new CiudadeCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of CiudadeCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public CiudadeCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of CiudadeCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public CiudadeCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CiudadeCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of CiudadeCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public CiudadeCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCiudade">A BO of type Ciudade</param>
public void ReAttach(Ciudade pCiudade)
{
if( pCiudade == null  ) throw new ArgumentNullException("pCiudade");
try 
{
Session.Lock(pCiudade, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Ciudade it saves it (insert) to the DataBase
/// </summary>
///<param name="pCiudade">A BO of type Ciudade</param>
public void Insert(Ciudade pCiudade)
{
if( pCiudade == null  ) throw new ArgumentNullException("pCiudade");
try 
{
BeginTransaction(false);
Session.Save(pCiudade);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Ciudade it Inserts them into the DataBase
/// </summary>
///<param name="pListCiudade">A List of Ciudade</param>
public void Insert(IEnumerable<Ciudade> pListCiudade)
{
if( pListCiudade == null  ) throw new ArgumentNullException("pListCiudade");
try 
{
BeginTransaction(false);
foreach ( Ciudade _Ciudade in pListCiudade ) 
{
Session.Save(_Ciudade);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCiudade">A BO of type Ciudade</param>
public void Save(Ciudade pCiudade)
{
if( pCiudade == null  ) throw new ArgumentNullException("pCiudade");
try 
{
BeginTransaction(false);
Session.Update(pCiudade);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Ciudade
/// </summary>
///<param name="pCiudade">A BO of type Ciudade</param>
public void Delete(Ciudade pCiudade)
{
if( pCiudade == null  ) throw new ArgumentNullException("pCiudade");
try 
{
BeginTransaction(false);
Session.Delete(pCiudade);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Ciudade inside one transaction.
/// </summary>
///<param name="pListCiudade">A List of Ciudade</param>
public void Delete(IEnumerable<Ciudade> pListCiudade)
{
if( pListCiudade == null  ) throw new ArgumentNullException("pListCiudade");
try 
{
...
/// <summary>
/// Delete a Ciudade object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodPais , System.String pCodDepartamento , System.String pCodCiudad)
{
Ciudade _ciudade = Fetch(pCodPais , pCodDepartamento , pCodCiudad);
if ( _ciudade == null ) throw new Exception("Object not found , could not delete");
Delete(_ciudade);
...
/// </summary>
///<param name="pCiudade">A BO of type Ciudade</param>
public Ciudade Dummy(Ciudade pCiudade)
{
if( pCiudade == null  ) throw new ArgumentNullException("pCiudade");
return pCiudade;
