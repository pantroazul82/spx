...
namespace BOLayer{
[DataObject]
public partial class ClienteFactory
 {
...
/// <summary>
/// Create a new Cliente Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ClienteFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Cliente by using it's Primary Key values. This is the Primary method to retrieve a Cliente.
/// </summary>
public Cliente Fetch(System.String pNitCliente)
{
...
_bo = (Cliente) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Clienteinto the current session by using it's Primary Key values.
/// </summary>
public Cliente Get(System.String pNitCliente)
{
if ( String.IsNullOrEmpty(pNitCliente)) throw new ArgumentException("Argument Name:pNitCliente. Primary Key Column must have a value (different from null or empty)");
pNitCliente = pNitCliente.PadRight(20,' ') ;
Cliente _bo = null ;
try 
{
_bo = Session.Get(typeof(Cliente), pNitCliente) as Cliente;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ClienteCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Cliente
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Cliente),"Cliente"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Cliente");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ClienteCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ClienteCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ClienteCollection _list = new ClienteCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ClienteCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ClienteCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ClienteCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ClienteCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ClienteCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ClienteCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ClienteCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pCliente">A BO of type Cliente</param>
public void ReAttach(Cliente pCliente)
{
if( pCliente == null  ) throw new ArgumentNullException("pCliente");
try 
{
Session.Lock(pCliente, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Cliente it saves it (insert) to the DataBase
/// </summary>
///<param name="pCliente">A BO of type Cliente</param>
...
/// <summary>
/// Given an List of BO of class Cliente it Inserts them into the DataBase
/// </summary>
///<param name="pListCliente">A List of Cliente</param>
public void Insert(IEnumerable<Cliente> pListCliente)
{
if( pListCliente == null  ) throw new ArgumentNullException("pListCliente");
try 
{
BeginTransaction(false);
foreach ( Cliente _Cliente in pListCliente ) 
{
Session.Save(_Cliente);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pCliente">A BO of type Cliente</param>
public void Save(Cliente pCliente)
{
if( pCliente == null  ) throw new ArgumentNullException("pCliente");
try 
{
...
/// <summary>
/// Deletes an object of Type Cliente
/// </summary>
///<param name="pCliente">A BO of type Cliente</param>
...
/// <summary>
/// Deletes multiple objects of Type Cliente inside one transaction.
/// </summary>
///<param name="pListCliente">A List of Cliente</param>
public void Delete(IEnumerable<Cliente> pListCliente)
{
if( pListCliente == null  ) throw new ArgumentNullException("pListCliente");
try 
{
...
/// <summary>
/// Delete a Cliente object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pNitCliente)
{
Cliente _cliente = Fetch(pNitCliente);
if ( _cliente == null ) throw new Exception("Object not found , could not delete");
Delete(_cliente);
...
/// </summary>
///<param name="pCliente">A BO of type Cliente</param>
public Cliente Dummy(Cliente pCliente)
{
if( pCliente == null  ) throw new ArgumentNullException("pCliente");
return pCliente;
