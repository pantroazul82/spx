...
namespace BOLayer{
[DataObject]
public partial class ContratoFactory
 {
...
/// <summary>
/// Create a new Contrato Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ContratoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Contrato by using it's Primary Key values. This is the Primary method to retrieve a Contrato.
/// </summary>
public Contrato Fetch(System.String pNumeroContrato , System.Int32 pCodOtroSI)
{
...
_bo = (Contrato) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type Contrato by using it's Primary Key values. This is the Primary method to retrieve a Contrato.
/// </summary>
public Contrato FetchVirtual(string pVirtualKey)
{
...
return Fetch(_numeroContrato,_codOtroSI);
...
/// <summary>
/// Get strongly typed collection of ContratoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ContratoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Contrato
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Contrato),"Contrato"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Contrato");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ContratoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ContratoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ContratoCollection _list = new ContratoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ContratoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ContratoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ContratoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ContratoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ContratoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pContrato">A BO of type Contrato</param>
public void ReAttach(Contrato pContrato)
{
if( pContrato == null  ) throw new ArgumentNullException("pContrato");
try 
{
Session.Lock(pContrato, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Contrato it saves it (insert) to the DataBase
/// </summary>
///<param name="pContrato">A BO of type Contrato</param>
public void Insert(Contrato pContrato)
{
if( pContrato == null  ) throw new ArgumentNullException("pContrato");
try 
{
BeginTransaction(false);
Session.Save(pContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Contrato it Inserts them into the DataBase
/// </summary>
///<param name="pListContrato">A List of Contrato</param>
public void Insert(IEnumerable<Contrato> pListContrato)
{
if( pListContrato == null  ) throw new ArgumentNullException("pListContrato");
try 
{
BeginTransaction(false);
foreach ( Contrato _Contrato in pListContrato ) 
{
Session.Save(_Contrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pContrato">A BO of type Contrato</param>
public void Save(Contrato pContrato)
{
if( pContrato == null  ) throw new ArgumentNullException("pContrato");
try 
{
BeginTransaction(false);
Session.Update(pContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Contrato
/// </summary>
///<param name="pContrato">A BO of type Contrato</param>
...
/// <summary>
/// Deletes multiple objects of Type Contrato inside one transaction.
/// </summary>
///<param name="pListContrato">A List of Contrato</param>
public void Delete(IEnumerable<Contrato> pListContrato)
{
if( pListContrato == null  ) throw new ArgumentNullException("pListContrato");
try 
{
...
/// <summary>
/// Delete a Contrato object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pNumeroContrato , System.Int32 pCodOtroSI)
{
Contrato _contrato = Fetch(pNumeroContrato , pCodOtroSI);
if ( _contrato == null ) throw new Exception("Object not found , could not delete");
Delete(_contrato);
...
/// </summary>
///<param name="pContrato">A BO of type Contrato</param>
public Contrato Dummy(Contrato pContrato)
{
if( pContrato == null  ) throw new ArgumentNullException("pContrato");
return pContrato;
