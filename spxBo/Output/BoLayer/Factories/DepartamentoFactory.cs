...
namespace BOLayer{
[DataObject]
public partial class DepartamentoFactory
 {
...
/// <summary>
/// Create a new Departamento Factory .
/// </summary>
...
/// <summary>
/// Create a new Departamento Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  DepartamentoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Departamento by using it's Primary Key values. This is the Primary method to retrieve a Departamento.
/// </summary>
public Departamento Fetch(System.String pCodPais , System.String pCodDepartamento)
{
...
_bo = (Departamento) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type Departamento by using it's Primary Key values. This is the Primary method to retrieve a Departamento.
/// </summary>
public Departamento FetchVirtual(string pVirtualKey)
{
...
System.String _codPais = _keys[0];
System.String _codDepartamento = _keys[1];
return Fetch(_codPais,_codDepartamento);
...
/// <summary>
/// Get strongly typed collection of DepartamentoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public DepartamentoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Departamento
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Departamento),"Departamento"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Departamento");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of DepartamentoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public DepartamentoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 DepartamentoCollection _list = new DepartamentoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of DepartamentoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public DepartamentoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of DepartamentoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public DepartamentoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public DepartamentoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of DepartamentoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public DepartamentoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pDepartamento">A BO of type Departamento</param>
public void ReAttach(Departamento pDepartamento)
{
if( pDepartamento == null  ) throw new ArgumentNullException("pDepartamento");
try 
{
Session.Lock(pDepartamento, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Departamento it saves it (insert) to the DataBase
/// </summary>
///<param name="pDepartamento">A BO of type Departamento</param>
public void Insert(Departamento pDepartamento)
{
if( pDepartamento == null  ) throw new ArgumentNullException("pDepartamento");
try 
{
BeginTransaction(false);
Session.Save(pDepartamento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Departamento it Inserts them into the DataBase
/// </summary>
///<param name="pListDepartamento">A List of Departamento</param>
public void Insert(IEnumerable<Departamento> pListDepartamento)
{
if( pListDepartamento == null  ) throw new ArgumentNullException("pListDepartamento");
try 
{
BeginTransaction(false);
foreach ( Departamento _Departamento in pListDepartamento ) 
{
Session.Save(_Departamento);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Deletes an object of Type Departamento
/// </summary>
///<param name="pDepartamento">A BO of type Departamento</param>
public void Delete(Departamento pDepartamento)
{
if( pDepartamento == null  ) throw new ArgumentNullException("pDepartamento");
try 
{
BeginTransaction(false);
Session.Delete(pDepartamento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Departamento inside one transaction.
/// </summary>
///<param name="pListDepartamento">A List of Departamento</param>
public void Delete(IEnumerable<Departamento> pListDepartamento)
{
if( pListDepartamento == null  ) throw new ArgumentNullException("pListDepartamento");
try 
{
...
/// <summary>
/// Delete a Departamento object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodPais , System.String pCodDepartamento)
{
Departamento _departamento = Fetch(pCodPais , pCodDepartamento);
if ( _departamento == null ) throw new Exception("Object not found , could not delete");
Delete(_departamento);
...
/// </summary>
///<param name="pDepartamento">A BO of type Departamento</param>
public Departamento Dummy(Departamento pDepartamento)
{
if( pDepartamento == null  ) throw new ArgumentNullException("pDepartamento");
