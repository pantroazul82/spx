...
namespace BOLayer{
[DataObject]
public partial class DetalleProgramacionViajeFactory
 {
...
/// <summary>
/// Create a new DetalleProgramacionViaje Factory .
/// </summary>
public  DetalleProgramacionViajeFactory()
{
}

/// <summary>
/// Create a new DetalleProgramacionViaje Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  DetalleProgramacionViajeFactory(SessionScope pSessionScope)
{
...
/// </summary>
~DetalleProgramacionViajeFactory()
{
...
/// <summary>
/// Fetch an object of type DetalleProgramacionViaje by using it's Primary Key values. This is the Primary method to retrieve a DetalleProgramacionViaje.
/// </summary>
public DetalleProgramacionViaje Fetch(System.Int32 pCodProgramacionViajes , System.Int32 pCodDetalleProgramacionViajes)
{
DetalleProgramacionViaje _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodProgramacionViajes" ,pCodProgramacionViajes ));
_criteria.Add(Restrictions.Eq("CodDetalleProgramacionViajes" ,pCodDetalleProgramacionViajes ));
_bo = (DetalleProgramacionViaje) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type DetalleProgramacionViaje by using it's Primary Key values. This is the Primary method to retrieve a DetalleProgramacionViaje.
/// </summary>
public DetalleProgramacionViaje FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codProgramacionViajes = System.Int32.Parse(_keys[0]);
System.Int32 _codDetalleProgramacionViajes = System.Int32.Parse(_keys[1]);
return Fetch(_codProgramacionViajes,_codDetalleProgramacionViajes);
...
/// <summary>
/// Get strongly typed collection of DetalleProgramacionViajeCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public DetalleProgramacionViajeCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object DetalleProgramacionViaje
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(DetalleProgramacionViaje),"DetalleProgramacionViaje"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for DetalleProgramacionViaje");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of DetalleProgramacionViajeCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public DetalleProgramacionViajeCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 DetalleProgramacionViajeCollection _list = new DetalleProgramacionViajeCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of DetalleProgramacionViajeCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public DetalleProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of DetalleProgramacionViajeCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public DetalleProgramacionViajeCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public DetalleProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of DetalleProgramacionViajeCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public DetalleProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pDetalleProgramacionViaje">A BO of type DetalleProgramacionViaje</param>
public void ReAttach(DetalleProgramacionViaje pDetalleProgramacionViaje)
{
if( pDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pDetalleProgramacionViaje");
try 
{
Session.Lock(pDetalleProgramacionViaje, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class DetalleProgramacionViaje it saves it (insert) to the DataBase
/// </summary>
///<param name="pDetalleProgramacionViaje">A BO of type DetalleProgramacionViaje</param>
public void Insert(DetalleProgramacionViaje pDetalleProgramacionViaje)
{
if( pDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pDetalleProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Save(pDetalleProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class DetalleProgramacionViaje it Inserts them into the DataBase
/// </summary>
///<param name="pListDetalleProgramacionViaje">A List of DetalleProgramacionViaje</param>
public void Insert(IEnumerable<DetalleProgramacionViaje> pListDetalleProgramacionViaje)
{
if( pListDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pListDetalleProgramacionViaje");
try 
{
BeginTransaction(false);
foreach ( DetalleProgramacionViaje _DetalleProgramacionViaje in pListDetalleProgramacionViaje ) 
{
Session.Save(_DetalleProgramacionViaje);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pDetalleProgramacionViaje">A BO of type DetalleProgramacionViaje</param>
public void Save(DetalleProgramacionViaje pDetalleProgramacionViaje)
{
if( pDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pDetalleProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Update(pDetalleProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type DetalleProgramacionViaje
/// </summary>
///<param name="pDetalleProgramacionViaje">A BO of type DetalleProgramacionViaje</param>
public void Delete(DetalleProgramacionViaje pDetalleProgramacionViaje)
{
if( pDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pDetalleProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Delete(pDetalleProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type DetalleProgramacionViaje inside one transaction.
/// </summary>
///<param name="pListDetalleProgramacionViaje">A List of DetalleProgramacionViaje</param>
public void Delete(IEnumerable<DetalleProgramacionViaje> pListDetalleProgramacionViaje)
{
if( pListDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pListDetalleProgramacionViaje");
try 
{
...
foreach ( DetalleProgramacionViaje _DetalleProgramacionViaje in pListDetalleProgramacionViaje ) 
{
Session.Delete(_DetalleProgramacionViaje);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a DetalleProgramacionViaje object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodProgramacionViajes , System.Int32 pCodDetalleProgramacionViajes)
{
DetalleProgramacionViaje _detalleProgramacionViaje = Fetch(pCodProgramacionViajes , pCodDetalleProgramacionViajes);
if ( _detalleProgramacionViaje == null ) throw new Exception("Object not found , could not delete");
Delete(_detalleProgramacionViaje);
...
/// </summary>
///<param name="pDetalleProgramacionViaje">A BO of type DetalleProgramacionViaje</param>
public DetalleProgramacionViaje Dummy(DetalleProgramacionViaje pDetalleProgramacionViaje)
{
if( pDetalleProgramacionViaje == null  ) throw new ArgumentNullException("pDetalleProgramacionViaje");
return pDetalleProgramacionViaje;
