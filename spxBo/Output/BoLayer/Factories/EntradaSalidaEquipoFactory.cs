...
namespace BOLayer{
[DataObject]
public partial class EntradaSalidaEquipoFactory
 {
...
/// <summary>
/// Create a new EntradaSalidaEquipo Factory .
/// </summary>
public  EntradaSalidaEquipoFactory()
{
}

/// <summary>
/// Create a new EntradaSalidaEquipo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EntradaSalidaEquipoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EntradaSalidaEquipo by using it's Primary Key values. This is the Primary method to retrieve a EntradaSalidaEquipo.
/// </summary>
public EntradaSalidaEquipo Fetch(System.Int32 pCodEntradaSalidaEquipos)
{
EntradaSalidaEquipo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEntradaSalidaEquipos" ,pCodEntradaSalidaEquipos ));
_bo = (EntradaSalidaEquipo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EntradaSalidaEquipointo the current session by using it's Primary Key values.
/// </summary>
public EntradaSalidaEquipo Get(System.Int32 pCodEntradaSalidaEquipos)
{
EntradaSalidaEquipo _bo = null ;
try 
{
_bo = Session.Get(typeof(EntradaSalidaEquipo), pCodEntradaSalidaEquipos) as EntradaSalidaEquipo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EntradaSalidaEquipoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EntradaSalidaEquipoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EntradaSalidaEquipo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EntradaSalidaEquipo),"EntradaSalidaEquipo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EntradaSalidaEquipo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EntradaSalidaEquipoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EntradaSalidaEquipoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EntradaSalidaEquipoCollection _list = new EntradaSalidaEquipoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EntradaSalidaEquipoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EntradaSalidaEquipoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EntradaSalidaEquipoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EntradaSalidaEquipoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EntradaSalidaEquipoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEntradaSalidaEquipo">A BO of type EntradaSalidaEquipo</param>
public void ReAttach(EntradaSalidaEquipo pEntradaSalidaEquipo)
{
if( pEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pEntradaSalidaEquipo");
try 
{
Session.Lock(pEntradaSalidaEquipo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EntradaSalidaEquipo it saves it (insert) to the DataBase
/// </summary>
///<param name="pEntradaSalidaEquipo">A BO of type EntradaSalidaEquipo</param>
public void Insert(EntradaSalidaEquipo pEntradaSalidaEquipo)
{
if( pEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Save(pEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EntradaSalidaEquipo it Inserts them into the DataBase
/// </summary>
///<param name="pListEntradaSalidaEquipo">A List of EntradaSalidaEquipo</param>
public void Insert(IEnumerable<EntradaSalidaEquipo> pListEntradaSalidaEquipo)
{
if( pListEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pListEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
foreach ( EntradaSalidaEquipo _EntradaSalidaEquipo in pListEntradaSalidaEquipo ) 
{
Session.Save(_EntradaSalidaEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEntradaSalidaEquipo">A BO of type EntradaSalidaEquipo</param>
public void Save(EntradaSalidaEquipo pEntradaSalidaEquipo)
{
if( pEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Update(pEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EntradaSalidaEquipo
/// </summary>
///<param name="pEntradaSalidaEquipo">A BO of type EntradaSalidaEquipo</param>
public void Delete(EntradaSalidaEquipo pEntradaSalidaEquipo)
{
if( pEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pEntradaSalidaEquipo");
try 
{
BeginTransaction(false);
Session.Delete(pEntradaSalidaEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EntradaSalidaEquipo inside one transaction.
/// </summary>
///<param name="pListEntradaSalidaEquipo">A List of EntradaSalidaEquipo</param>
public void Delete(IEnumerable<EntradaSalidaEquipo> pListEntradaSalidaEquipo)
{
if( pListEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pListEntradaSalidaEquipo");
try 
{
...
foreach ( EntradaSalidaEquipo _EntradaSalidaEquipo in pListEntradaSalidaEquipo ) 
{
Session.Delete(_EntradaSalidaEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EntradaSalidaEquipo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodEntradaSalidaEquipos)
{
EntradaSalidaEquipo _entradaSalidaEquipo = Fetch(pCodEntradaSalidaEquipos);
if ( _entradaSalidaEquipo == null ) throw new Exception("Object not found , could not delete");
Delete(_entradaSalidaEquipo);
...
/// </summary>
///<param name="pEntradaSalidaEquipo">A BO of type EntradaSalidaEquipo</param>
public EntradaSalidaEquipo Dummy(EntradaSalidaEquipo pEntradaSalidaEquipo)
{
if( pEntradaSalidaEquipo == null  ) throw new ArgumentNullException("pEntradaSalidaEquipo");
return pEntradaSalidaEquipo;
