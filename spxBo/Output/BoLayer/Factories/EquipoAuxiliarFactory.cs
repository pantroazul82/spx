...
namespace BOLayer{
[DataObject]
public partial class EquipoAuxiliarFactory
 {
...
/// <summary>
/// Create a new EquipoAuxiliar Factory .
/// </summary>
public  EquipoAuxiliarFactory()
{
}

/// <summary>
/// Create a new EquipoAuxiliar Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EquipoAuxiliarFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EquipoAuxiliar by using it's Primary Key values. This is the Primary method to retrieve a EquipoAuxiliar.
/// </summary>
public EquipoAuxiliar Fetch(System.String pSerialEquipo , System.String pSerialAuxiliar)
{
if ( String.IsNullOrEmpty(pSerialEquipo)) throw new ArgumentException("Argument Name:pSerialEquipo. Primary Key Column must have a value (different from null or empty)");
pSerialEquipo = pSerialEquipo.PadRight(30,' ') ;
if ( String.IsNullOrEmpty(pSerialAuxiliar)) throw new ArgumentException("Argument Name:pSerialAuxiliar. Primary Key Column must have a value (different from null or empty)");
pSerialAuxiliar = pSerialAuxiliar.PadRight(30,' ') ;
EquipoAuxiliar _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("SerialEquipo" ,pSerialEquipo ));
_criteria.Add(Restrictions.Eq("SerialAuxiliar" ,pSerialAuxiliar ));
_bo = (EquipoAuxiliar) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type EquipoAuxiliar by using it's Primary Key values. This is the Primary method to retrieve a EquipoAuxiliar.
/// </summary>
public EquipoAuxiliar FetchVirtual(string pVirtualKey)
{
...
System.String _serialEquipo = _keys[0];
System.String _serialAuxiliar = _keys[1];
return Fetch(_serialEquipo,_serialAuxiliar);
...
/// <summary>
/// Get strongly typed collection of EquipoAuxiliarCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EquipoAuxiliarCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EquipoAuxiliar
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EquipoAuxiliar),"EquipoAuxiliar"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EquipoAuxiliar");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EquipoAuxiliarCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EquipoAuxiliarCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EquipoAuxiliarCollection _list = new EquipoAuxiliarCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EquipoAuxiliarCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EquipoAuxiliarCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EquipoAuxiliarCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EquipoAuxiliarCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EquipoAuxiliarCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EquipoAuxiliarCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EquipoAuxiliarCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEquipoAuxiliar">A BO of type EquipoAuxiliar</param>
public void ReAttach(EquipoAuxiliar pEquipoAuxiliar)
{
if( pEquipoAuxiliar == null  ) throw new ArgumentNullException("pEquipoAuxiliar");
try 
{
Session.Lock(pEquipoAuxiliar, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EquipoAuxiliar it saves it (insert) to the DataBase
/// </summary>
///<param name="pEquipoAuxiliar">A BO of type EquipoAuxiliar</param>
public void Insert(EquipoAuxiliar pEquipoAuxiliar)
{
if( pEquipoAuxiliar == null  ) throw new ArgumentNullException("pEquipoAuxiliar");
try 
{
BeginTransaction(false);
Session.Save(pEquipoAuxiliar);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EquipoAuxiliar it Inserts them into the DataBase
/// </summary>
///<param name="pListEquipoAuxiliar">A List of EquipoAuxiliar</param>
public void Insert(IEnumerable<EquipoAuxiliar> pListEquipoAuxiliar)
{
if( pListEquipoAuxiliar == null  ) throw new ArgumentNullException("pListEquipoAuxiliar");
try 
{
BeginTransaction(false);
foreach ( EquipoAuxiliar _EquipoAuxiliar in pListEquipoAuxiliar ) 
{
Session.Save(_EquipoAuxiliar);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEquipoAuxiliar">A BO of type EquipoAuxiliar</param>
public void Save(EquipoAuxiliar pEquipoAuxiliar)
{
if( pEquipoAuxiliar == null  ) throw new ArgumentNullException("pEquipoAuxiliar");
try 
{
BeginTransaction(false);
Session.Update(pEquipoAuxiliar);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EquipoAuxiliar
/// </summary>
///<param name="pEquipoAuxiliar">A BO of type EquipoAuxiliar</param>
public void Delete(EquipoAuxiliar pEquipoAuxiliar)
{
if( pEquipoAuxiliar == null  ) throw new ArgumentNullException("pEquipoAuxiliar");
try 
{
BeginTransaction(false);
Session.Delete(pEquipoAuxiliar);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EquipoAuxiliar inside one transaction.
/// </summary>
///<param name="pListEquipoAuxiliar">A List of EquipoAuxiliar</param>
public void Delete(IEnumerable<EquipoAuxiliar> pListEquipoAuxiliar)
{
if( pListEquipoAuxiliar == null  ) throw new ArgumentNullException("pListEquipoAuxiliar");
try 
{
...
foreach ( EquipoAuxiliar _EquipoAuxiliar in pListEquipoAuxiliar ) 
{
Session.Delete(_EquipoAuxiliar);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EquipoAuxiliar object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pSerialEquipo , System.String pSerialAuxiliar)
{
EquipoAuxiliar _equipoAuxiliar = Fetch(pSerialEquipo , pSerialAuxiliar);
if ( _equipoAuxiliar == null ) throw new Exception("Object not found , could not delete");
Delete(_equipoAuxiliar);
...
/// </summary>
///<param name="pEquipoAuxiliar">A BO of type EquipoAuxiliar</param>
public EquipoAuxiliar Dummy(EquipoAuxiliar pEquipoAuxiliar)
{
if( pEquipoAuxiliar == null  ) throw new ArgumentNullException("pEquipoAuxiliar");
return pEquipoAuxiliar;
