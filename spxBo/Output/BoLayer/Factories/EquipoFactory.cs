...
namespace BOLayer{
[DataObject]
public partial class EquipoFactory
 {
...
/// <summary>
/// Create a new Equipo Factory .
/// </summary>
public  EquipoFactory()
{
}

/// <summary>
/// Create a new Equipo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EquipoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Equipo by using it's Primary Key values. This is the Primary method to retrieve a Equipo.
/// </summary>
public Equipo Fetch(System.String pSerial)
{
...
_bo = (Equipo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Equipointo the current session by using it's Primary Key values.
/// </summary>
public Equipo Get(System.String pSerial)
{
if ( String.IsNullOrEmpty(pSerial)) throw new ArgumentException("Argument Name:pSerial. Primary Key Column must have a value (different from null or empty)");
pSerial = pSerial.PadRight(30,' ') ;
Equipo _bo = null ;
try 
{
_bo = Session.Get(typeof(Equipo), pSerial) as Equipo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EquipoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EquipoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Equipo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Equipo),"Equipo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Equipo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EquipoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EquipoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EquipoCollection _list = new EquipoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EquipoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EquipoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EquipoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EquipoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EquipoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEquipo">A BO of type Equipo</param>
public void ReAttach(Equipo pEquipo)
{
if( pEquipo == null  ) throw new ArgumentNullException("pEquipo");
try 
{
Session.Lock(pEquipo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Equipo it saves it (insert) to the DataBase
/// </summary>
///<param name="pEquipo">A BO of type Equipo</param>
public void Insert(Equipo pEquipo)
{
if( pEquipo == null  ) throw new ArgumentNullException("pEquipo");
try 
{
BeginTransaction(false);
Session.Save(pEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Equipo it Inserts them into the DataBase
/// </summary>
///<param name="pListEquipo">A List of Equipo</param>
public void Insert(IEnumerable<Equipo> pListEquipo)
{
if( pListEquipo == null  ) throw new ArgumentNullException("pListEquipo");
try 
{
BeginTransaction(false);
foreach ( Equipo _Equipo in pListEquipo ) 
{
Session.Save(_Equipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEquipo">A BO of type Equipo</param>
public void Save(Equipo pEquipo)
{
if( pEquipo == null  ) throw new ArgumentNullException("pEquipo");
try 
{
BeginTransaction(false);
Session.Update(pEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Equipo
/// </summary>
///<param name="pEquipo">A BO of type Equipo</param>
public void Delete(Equipo pEquipo)
{
if( pEquipo == null  ) throw new ArgumentNullException("pEquipo");
try 
{
BeginTransaction(false);
Session.Delete(pEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Equipo inside one transaction.
/// </summary>
///<param name="pListEquipo">A List of Equipo</param>
public void Delete(IEnumerable<Equipo> pListEquipo)
{
if( pListEquipo == null  ) throw new ArgumentNullException("pListEquipo");
try 
{
...
/// <summary>
/// Delete a Equipo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pSerial)
{
Equipo _equipo = Fetch(pSerial);
if ( _equipo == null ) throw new Exception("Object not found , could not delete");
Delete(_equipo);
...
/// </summary>
///<param name="pEquipo">A BO of type Equipo</param>
public Equipo Dummy(Equipo pEquipo)
{
if( pEquipo == null  ) throw new ArgumentNullException("pEquipo");
return pEquipo;
