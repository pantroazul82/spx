...
namespace BOLayer{
[DataObject]
public partial class EstadoLocalEquipoFactory
 {
...
/// <summary>
/// Create a new EstadoLocalEquipo Factory .
/// </summary>
public  EstadoLocalEquipoFactory()
{
}

/// <summary>
/// Create a new EstadoLocalEquipo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EstadoLocalEquipoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EstadoLocalEquipo by using it's Primary Key values. This is the Primary method to retrieve a EstadoLocalEquipo.
/// </summary>
public EstadoLocalEquipo Fetch(System.String pCodEstadoLocal)
{
if ( String.IsNullOrEmpty(pCodEstadoLocal)) throw new ArgumentException("Argument Name:pCodEstadoLocal. Primary Key Column must have a value (different from null or empty)");
pCodEstadoLocal = pCodEstadoLocal.PadRight(5,' ') ;
EstadoLocalEquipo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEstadoLocal" ,pCodEstadoLocal ));
_bo = (EstadoLocalEquipo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EstadoLocalEquipointo the current session by using it's Primary Key values.
/// </summary>
public EstadoLocalEquipo Get(System.String pCodEstadoLocal)
{
if ( String.IsNullOrEmpty(pCodEstadoLocal)) throw new ArgumentException("Argument Name:pCodEstadoLocal. Primary Key Column must have a value (different from null or empty)");
pCodEstadoLocal = pCodEstadoLocal.PadRight(5,' ') ;
EstadoLocalEquipo _bo = null ;
try 
{
_bo = Session.Get(typeof(EstadoLocalEquipo), pCodEstadoLocal) as EstadoLocalEquipo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EstadoLocalEquipoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EstadoLocalEquipoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EstadoLocalEquipo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EstadoLocalEquipo),"EstadoLocalEquipo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EstadoLocalEquipo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EstadoLocalEquipoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EstadoLocalEquipoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EstadoLocalEquipoCollection _list = new EstadoLocalEquipoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EstadoLocalEquipoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EstadoLocalEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EstadoLocalEquipoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EstadoLocalEquipoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadoLocalEquipoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EstadoLocalEquipoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadoLocalEquipoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEstadoLocalEquipo">A BO of type EstadoLocalEquipo</param>
public void ReAttach(EstadoLocalEquipo pEstadoLocalEquipo)
{
if( pEstadoLocalEquipo == null  ) throw new ArgumentNullException("pEstadoLocalEquipo");
try 
{
Session.Lock(pEstadoLocalEquipo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EstadoLocalEquipo it saves it (insert) to the DataBase
/// </summary>
///<param name="pEstadoLocalEquipo">A BO of type EstadoLocalEquipo</param>
public void Insert(EstadoLocalEquipo pEstadoLocalEquipo)
{
if( pEstadoLocalEquipo == null  ) throw new ArgumentNullException("pEstadoLocalEquipo");
try 
{
BeginTransaction(false);
Session.Save(pEstadoLocalEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EstadoLocalEquipo it Inserts them into the DataBase
/// </summary>
///<param name="pListEstadoLocalEquipo">A List of EstadoLocalEquipo</param>
public void Insert(IEnumerable<EstadoLocalEquipo> pListEstadoLocalEquipo)
{
if( pListEstadoLocalEquipo == null  ) throw new ArgumentNullException("pListEstadoLocalEquipo");
try 
{
BeginTransaction(false);
foreach ( EstadoLocalEquipo _EstadoLocalEquipo in pListEstadoLocalEquipo ) 
{
Session.Save(_EstadoLocalEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEstadoLocalEquipo">A BO of type EstadoLocalEquipo</param>
public void Save(EstadoLocalEquipo pEstadoLocalEquipo)
{
if( pEstadoLocalEquipo == null  ) throw new ArgumentNullException("pEstadoLocalEquipo");
try 
{
BeginTransaction(false);
Session.Update(pEstadoLocalEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EstadoLocalEquipo
/// </summary>
///<param name="pEstadoLocalEquipo">A BO of type EstadoLocalEquipo</param>
public void Delete(EstadoLocalEquipo pEstadoLocalEquipo)
{
if( pEstadoLocalEquipo == null  ) throw new ArgumentNullException("pEstadoLocalEquipo");
try 
{
BeginTransaction(false);
Session.Delete(pEstadoLocalEquipo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EstadoLocalEquipo inside one transaction.
/// </summary>
///<param name="pListEstadoLocalEquipo">A List of EstadoLocalEquipo</param>
public void Delete(IEnumerable<EstadoLocalEquipo> pListEstadoLocalEquipo)
{
if( pListEstadoLocalEquipo == null  ) throw new ArgumentNullException("pListEstadoLocalEquipo");
try 
{
...
foreach ( EstadoLocalEquipo _EstadoLocalEquipo in pListEstadoLocalEquipo ) 
{
Session.Delete(_EstadoLocalEquipo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EstadoLocalEquipo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodEstadoLocal)
{
EstadoLocalEquipo _estadoLocalEquipo = Fetch(pCodEstadoLocal);
if ( _estadoLocalEquipo == null ) throw new Exception("Object not found , could not delete");
Delete(_estadoLocalEquipo);
...
/// </summary>
///<param name="pEstadoLocalEquipo">A BO of type EstadoLocalEquipo</param>
public EstadoLocalEquipo Dummy(EstadoLocalEquipo pEstadoLocalEquipo)
{
if( pEstadoLocalEquipo == null  ) throw new ArgumentNullException("pEstadoLocalEquipo");
return pEstadoLocalEquipo;
