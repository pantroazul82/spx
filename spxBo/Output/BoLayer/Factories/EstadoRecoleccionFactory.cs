...
namespace BOLayer{
[DataObject]
public partial class EstadoRecoleccionFactory
 {
...
/// <summary>
/// Create a new EstadoRecoleccion Factory .
/// </summary>
public  EstadoRecoleccionFactory()
{
}

/// <summary>
/// Create a new EstadoRecoleccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EstadoRecoleccionFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EstadoRecoleccion by using it's Primary Key values. This is the Primary method to retrieve a EstadoRecoleccion.
/// </summary>
public EstadoRecoleccion Fetch(System.Int32 pCodEstadoRecoleccion)
{
EstadoRecoleccion _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEstadoRecoleccion" ,pCodEstadoRecoleccion ));
_bo = (EstadoRecoleccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EstadoRecoleccioninto the current session by using it's Primary Key values.
/// </summary>
public EstadoRecoleccion Get(System.Int32 pCodEstadoRecoleccion)
{
EstadoRecoleccion _bo = null ;
try 
{
_bo = Session.Get(typeof(EstadoRecoleccion), pCodEstadoRecoleccion) as EstadoRecoleccion;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EstadoRecoleccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EstadoRecoleccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EstadoRecoleccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EstadoRecoleccion),"EstadoRecoleccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EstadoRecoleccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EstadoRecoleccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EstadoRecoleccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EstadoRecoleccionCollection _list = new EstadoRecoleccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EstadoRecoleccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EstadoRecoleccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EstadoRecoleccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EstadoRecoleccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadoRecoleccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EstadoRecoleccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadoRecoleccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEstadoRecoleccion">A BO of type EstadoRecoleccion</param>
public void ReAttach(EstadoRecoleccion pEstadoRecoleccion)
{
if( pEstadoRecoleccion == null  ) throw new ArgumentNullException("pEstadoRecoleccion");
try 
{
Session.Lock(pEstadoRecoleccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EstadoRecoleccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pEstadoRecoleccion">A BO of type EstadoRecoleccion</param>
public void Insert(EstadoRecoleccion pEstadoRecoleccion)
{
if( pEstadoRecoleccion == null  ) throw new ArgumentNullException("pEstadoRecoleccion");
try 
{
BeginTransaction(false);
Session.Save(pEstadoRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EstadoRecoleccion it Inserts them into the DataBase
/// </summary>
///<param name="pListEstadoRecoleccion">A List of EstadoRecoleccion</param>
public void Insert(IEnumerable<EstadoRecoleccion> pListEstadoRecoleccion)
{
if( pListEstadoRecoleccion == null  ) throw new ArgumentNullException("pListEstadoRecoleccion");
try 
{
BeginTransaction(false);
foreach ( EstadoRecoleccion _EstadoRecoleccion in pListEstadoRecoleccion ) 
{
Session.Save(_EstadoRecoleccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEstadoRecoleccion">A BO of type EstadoRecoleccion</param>
public void Save(EstadoRecoleccion pEstadoRecoleccion)
{
if( pEstadoRecoleccion == null  ) throw new ArgumentNullException("pEstadoRecoleccion");
try 
{
BeginTransaction(false);
Session.Update(pEstadoRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EstadoRecoleccion
/// </summary>
///<param name="pEstadoRecoleccion">A BO of type EstadoRecoleccion</param>
public void Delete(EstadoRecoleccion pEstadoRecoleccion)
{
if( pEstadoRecoleccion == null  ) throw new ArgumentNullException("pEstadoRecoleccion");
try 
{
BeginTransaction(false);
Session.Delete(pEstadoRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EstadoRecoleccion inside one transaction.
/// </summary>
///<param name="pListEstadoRecoleccion">A List of EstadoRecoleccion</param>
public void Delete(IEnumerable<EstadoRecoleccion> pListEstadoRecoleccion)
{
if( pListEstadoRecoleccion == null  ) throw new ArgumentNullException("pListEstadoRecoleccion");
try 
{
...
foreach ( EstadoRecoleccion _EstadoRecoleccion in pListEstadoRecoleccion ) 
{
Session.Delete(_EstadoRecoleccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EstadoRecoleccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodEstadoRecoleccion)
{
EstadoRecoleccion _estadoRecoleccion = Fetch(pCodEstadoRecoleccion);
if ( _estadoRecoleccion == null ) throw new Exception("Object not found , could not delete");
Delete(_estadoRecoleccion);
...
/// </summary>
///<param name="pEstadoRecoleccion">A BO of type EstadoRecoleccion</param>
public EstadoRecoleccion Dummy(EstadoRecoleccion pEstadoRecoleccion)
{
if( pEstadoRecoleccion == null  ) throw new ArgumentNullException("pEstadoRecoleccion");
return pEstadoRecoleccion;
