...
namespace BOLayer{
[DataObject]
public partial class EstadosLLamadasTecnicaFactory
 {
...
/// <summary>
/// Create a new EstadosLLamadasTecnica Factory .
/// </summary>
public  EstadosLLamadasTecnicaFactory()
{
}

/// <summary>
/// Create a new EstadosLLamadasTecnica Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EstadosLLamadasTecnicaFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EstadosLLamadasTecnica by using it's Primary Key values. This is the Primary method to retrieve a EstadosLLamadasTecnica.
/// </summary>
public EstadosLLamadasTecnica Fetch(System.String pCodEstadoLlamada)
{
if ( String.IsNullOrEmpty(pCodEstadoLlamada)) throw new ArgumentException("Argument Name:pCodEstadoLlamada. Primary Key Column must have a value (different from null or empty)");
pCodEstadoLlamada = pCodEstadoLlamada.PadRight(5,' ') ;
EstadosLLamadasTecnica _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEstadoLlamada" ,pCodEstadoLlamada ));
_bo = (EstadosLLamadasTecnica) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EstadosLLamadasTecnicainto the current session by using it's Primary Key values.
/// </summary>
public EstadosLLamadasTecnica Get(System.String pCodEstadoLlamada)
{
if ( String.IsNullOrEmpty(pCodEstadoLlamada)) throw new ArgumentException("Argument Name:pCodEstadoLlamada. Primary Key Column must have a value (different from null or empty)");
pCodEstadoLlamada = pCodEstadoLlamada.PadRight(5,' ') ;
EstadosLLamadasTecnica _bo = null ;
try 
{
_bo = Session.Get(typeof(EstadosLLamadasTecnica), pCodEstadoLlamada) as EstadosLLamadasTecnica;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EstadosLLamadasTecnicaCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EstadosLLamadasTecnicaCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EstadosLLamadasTecnica
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EstadosLLamadasTecnica),"EstadosLLamadasTecnica"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EstadosLLamadasTecnica");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EstadosLLamadasTecnicaCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EstadosLLamadasTecnicaCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EstadosLLamadasTecnicaCollection _list = new EstadosLLamadasTecnicaCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EstadosLLamadasTecnicaCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EstadosLLamadasTecnicaCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EstadosLLamadasTecnicaCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EstadosLLamadasTecnicaCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosLLamadasTecnicaCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EstadosLLamadasTecnicaCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosLLamadasTecnicaCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEstadosLLamadasTecnica">A BO of type EstadosLLamadasTecnica</param>
public void ReAttach(EstadosLLamadasTecnica pEstadosLLamadasTecnica)
{
if( pEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pEstadosLLamadasTecnica");
try 
{
Session.Lock(pEstadosLLamadasTecnica, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EstadosLLamadasTecnica it saves it (insert) to the DataBase
/// </summary>
///<param name="pEstadosLLamadasTecnica">A BO of type EstadosLLamadasTecnica</param>
public void Insert(EstadosLLamadasTecnica pEstadosLLamadasTecnica)
{
if( pEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pEstadosLLamadasTecnica");
try 
{
BeginTransaction(false);
Session.Save(pEstadosLLamadasTecnica);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EstadosLLamadasTecnica it Inserts them into the DataBase
/// </summary>
///<param name="pListEstadosLLamadasTecnica">A List of EstadosLLamadasTecnica</param>
public void Insert(IEnumerable<EstadosLLamadasTecnica> pListEstadosLLamadasTecnica)
{
if( pListEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pListEstadosLLamadasTecnica");
try 
{
BeginTransaction(false);
foreach ( EstadosLLamadasTecnica _EstadosLLamadasTecnica in pListEstadosLLamadasTecnica ) 
{
Session.Save(_EstadosLLamadasTecnica);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEstadosLLamadasTecnica">A BO of type EstadosLLamadasTecnica</param>
public void Save(EstadosLLamadasTecnica pEstadosLLamadasTecnica)
{
if( pEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pEstadosLLamadasTecnica");
try 
{
BeginTransaction(false);
Session.Update(pEstadosLLamadasTecnica);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EstadosLLamadasTecnica
/// </summary>
///<param name="pEstadosLLamadasTecnica">A BO of type EstadosLLamadasTecnica</param>
public void Delete(EstadosLLamadasTecnica pEstadosLLamadasTecnica)
{
if( pEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pEstadosLLamadasTecnica");
try 
{
BeginTransaction(false);
Session.Delete(pEstadosLLamadasTecnica);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EstadosLLamadasTecnica inside one transaction.
/// </summary>
///<param name="pListEstadosLLamadasTecnica">A List of EstadosLLamadasTecnica</param>
public void Delete(IEnumerable<EstadosLLamadasTecnica> pListEstadosLLamadasTecnica)
{
if( pListEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pListEstadosLLamadasTecnica");
try 
{
...
foreach ( EstadosLLamadasTecnica _EstadosLLamadasTecnica in pListEstadosLLamadasTecnica ) 
{
Session.Delete(_EstadosLLamadasTecnica);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EstadosLLamadasTecnica object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodEstadoLlamada)
{
EstadosLLamadasTecnica _estadosLLamadasTecnica = Fetch(pCodEstadoLlamada);
if ( _estadosLLamadasTecnica == null ) throw new Exception("Object not found , could not delete");
Delete(_estadosLLamadasTecnica);
...
/// </summary>
///<param name="pEstadosLLamadasTecnica">A BO of type EstadosLLamadasTecnica</param>
public EstadosLLamadasTecnica Dummy(EstadosLLamadasTecnica pEstadosLLamadasTecnica)
{
if( pEstadosLLamadasTecnica == null  ) throw new ArgumentNullException("pEstadosLLamadasTecnica");
return pEstadosLLamadasTecnica;
