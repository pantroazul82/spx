...
namespace BOLayer{
[DataObject]
public partial class EstadosOrdenPrestamoFactory
 {
...
/// <summary>
/// Create a new EstadosOrdenPrestamo Factory .
/// </summary>
public  EstadosOrdenPrestamoFactory()
{
}

/// <summary>
/// Create a new EstadosOrdenPrestamo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EstadosOrdenPrestamoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EstadosOrdenPrestamo by using it's Primary Key values. This is the Primary method to retrieve a EstadosOrdenPrestamo.
/// </summary>
public EstadosOrdenPrestamo Fetch(System.Int32 pCodEstadoOrdenPrestamo)
{
EstadosOrdenPrestamo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEstadoOrdenPrestamo" ,pCodEstadoOrdenPrestamo ));
_bo = (EstadosOrdenPrestamo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EstadosOrdenPrestamointo the current session by using it's Primary Key values.
/// </summary>
public EstadosOrdenPrestamo Get(System.Int32 pCodEstadoOrdenPrestamo)
{
EstadosOrdenPrestamo _bo = null ;
try 
{
_bo = Session.Get(typeof(EstadosOrdenPrestamo), pCodEstadoOrdenPrestamo) as EstadosOrdenPrestamo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EstadosOrdenPrestamoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EstadosOrdenPrestamoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EstadosOrdenPrestamo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EstadosOrdenPrestamo),"EstadosOrdenPrestamo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EstadosOrdenPrestamo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EstadosOrdenPrestamoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EstadosOrdenPrestamoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EstadosOrdenPrestamoCollection _list = new EstadosOrdenPrestamoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EstadosOrdenPrestamoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EstadosOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EstadosOrdenPrestamoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EstadosOrdenPrestamoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EstadosOrdenPrestamoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEstadosOrdenPrestamo">A BO of type EstadosOrdenPrestamo</param>
public void ReAttach(EstadosOrdenPrestamo pEstadosOrdenPrestamo)
{
if( pEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pEstadosOrdenPrestamo");
try 
{
Session.Lock(pEstadosOrdenPrestamo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EstadosOrdenPrestamo it saves it (insert) to the DataBase
/// </summary>
///<param name="pEstadosOrdenPrestamo">A BO of type EstadosOrdenPrestamo</param>
public void Insert(EstadosOrdenPrestamo pEstadosOrdenPrestamo)
{
if( pEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pEstadosOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Save(pEstadosOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EstadosOrdenPrestamo it Inserts them into the DataBase
/// </summary>
///<param name="pListEstadosOrdenPrestamo">A List of EstadosOrdenPrestamo</param>
public void Insert(IEnumerable<EstadosOrdenPrestamo> pListEstadosOrdenPrestamo)
{
if( pListEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pListEstadosOrdenPrestamo");
try 
{
BeginTransaction(false);
foreach ( EstadosOrdenPrestamo _EstadosOrdenPrestamo in pListEstadosOrdenPrestamo ) 
{
Session.Save(_EstadosOrdenPrestamo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEstadosOrdenPrestamo">A BO of type EstadosOrdenPrestamo</param>
public void Save(EstadosOrdenPrestamo pEstadosOrdenPrestamo)
{
if( pEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pEstadosOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Update(pEstadosOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EstadosOrdenPrestamo
/// </summary>
///<param name="pEstadosOrdenPrestamo">A BO of type EstadosOrdenPrestamo</param>
public void Delete(EstadosOrdenPrestamo pEstadosOrdenPrestamo)
{
if( pEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pEstadosOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Delete(pEstadosOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EstadosOrdenPrestamo inside one transaction.
/// </summary>
///<param name="pListEstadosOrdenPrestamo">A List of EstadosOrdenPrestamo</param>
public void Delete(IEnumerable<EstadosOrdenPrestamo> pListEstadosOrdenPrestamo)
{
if( pListEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pListEstadosOrdenPrestamo");
try 
{
...
foreach ( EstadosOrdenPrestamo _EstadosOrdenPrestamo in pListEstadosOrdenPrestamo ) 
{
Session.Delete(_EstadosOrdenPrestamo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EstadosOrdenPrestamo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodEstadoOrdenPrestamo)
{
EstadosOrdenPrestamo _estadosOrdenPrestamo = Fetch(pCodEstadoOrdenPrestamo);
if ( _estadosOrdenPrestamo == null ) throw new Exception("Object not found , could not delete");
Delete(_estadosOrdenPrestamo);
...
/// </summary>
///<param name="pEstadosOrdenPrestamo">A BO of type EstadosOrdenPrestamo</param>
public EstadosOrdenPrestamo Dummy(EstadosOrdenPrestamo pEstadosOrdenPrestamo)
{
if( pEstadosOrdenPrestamo == null  ) throw new ArgumentNullException("pEstadosOrdenPrestamo");
return pEstadosOrdenPrestamo;
