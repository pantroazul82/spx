...
namespace BOLayer{
[DataObject]
public partial class EstadosSolicitudFactory
 {
...
/// <summary>
/// Create a new EstadosSolicitud Factory .
/// </summary>
public  EstadosSolicitudFactory()
{
}

/// <summary>
/// Create a new EstadosSolicitud Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  EstadosSolicitudFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type EstadosSolicitud by using it's Primary Key values. This is the Primary method to retrieve a EstadosSolicitud.
/// </summary>
public EstadosSolicitud Fetch(System.Int32 pCodEstadoSolicitud)
{
EstadosSolicitud _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodEstadoSolicitud" ,pCodEstadoSolicitud ));
_bo = (EstadosSolicitud) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type EstadosSolicitudinto the current session by using it's Primary Key values.
/// </summary>
public EstadosSolicitud Get(System.Int32 pCodEstadoSolicitud)
{
EstadosSolicitud _bo = null ;
try 
{
_bo = Session.Get(typeof(EstadosSolicitud), pCodEstadoSolicitud) as EstadosSolicitud;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of EstadosSolicitudCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public EstadosSolicitudCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object EstadosSolicitud
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(EstadosSolicitud),"EstadosSolicitud"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for EstadosSolicitud");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of EstadosSolicitudCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public EstadosSolicitudCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 EstadosSolicitudCollection _list = new EstadosSolicitudCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of EstadosSolicitudCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public EstadosSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of EstadosSolicitudCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public EstadosSolicitudCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of EstadosSolicitudCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public EstadosSolicitudCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pEstadosSolicitud">A BO of type EstadosSolicitud</param>
public void ReAttach(EstadosSolicitud pEstadosSolicitud)
{
if( pEstadosSolicitud == null  ) throw new ArgumentNullException("pEstadosSolicitud");
try 
{
Session.Lock(pEstadosSolicitud, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class EstadosSolicitud it saves it (insert) to the DataBase
/// </summary>
///<param name="pEstadosSolicitud">A BO of type EstadosSolicitud</param>
public void Insert(EstadosSolicitud pEstadosSolicitud)
{
if( pEstadosSolicitud == null  ) throw new ArgumentNullException("pEstadosSolicitud");
try 
{
BeginTransaction(false);
Session.Save(pEstadosSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class EstadosSolicitud it Inserts them into the DataBase
/// </summary>
///<param name="pListEstadosSolicitud">A List of EstadosSolicitud</param>
public void Insert(IEnumerable<EstadosSolicitud> pListEstadosSolicitud)
{
if( pListEstadosSolicitud == null  ) throw new ArgumentNullException("pListEstadosSolicitud");
try 
{
BeginTransaction(false);
foreach ( EstadosSolicitud _EstadosSolicitud in pListEstadosSolicitud ) 
{
Session.Save(_EstadosSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pEstadosSolicitud">A BO of type EstadosSolicitud</param>
public void Save(EstadosSolicitud pEstadosSolicitud)
{
if( pEstadosSolicitud == null  ) throw new ArgumentNullException("pEstadosSolicitud");
try 
{
BeginTransaction(false);
Session.Update(pEstadosSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type EstadosSolicitud
/// </summary>
///<param name="pEstadosSolicitud">A BO of type EstadosSolicitud</param>
public void Delete(EstadosSolicitud pEstadosSolicitud)
{
if( pEstadosSolicitud == null  ) throw new ArgumentNullException("pEstadosSolicitud");
try 
{
BeginTransaction(false);
Session.Delete(pEstadosSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type EstadosSolicitud inside one transaction.
/// </summary>
///<param name="pListEstadosSolicitud">A List of EstadosSolicitud</param>
public void Delete(IEnumerable<EstadosSolicitud> pListEstadosSolicitud)
{
if( pListEstadosSolicitud == null  ) throw new ArgumentNullException("pListEstadosSolicitud");
try 
{
...
foreach ( EstadosSolicitud _EstadosSolicitud in pListEstadosSolicitud ) 
{
Session.Delete(_EstadosSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a EstadosSolicitud object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodEstadoSolicitud)
{
EstadosSolicitud _estadosSolicitud = Fetch(pCodEstadoSolicitud);
if ( _estadosSolicitud == null ) throw new Exception("Object not found , could not delete");
Delete(_estadosSolicitud);
...
/// </summary>
///<param name="pEstadosSolicitud">A BO of type EstadosSolicitud</param>
public EstadosSolicitud Dummy(EstadosSolicitud pEstadosSolicitud)
{
if( pEstadosSolicitud == null  ) throw new ArgumentNullException("pEstadosSolicitud");
return pEstadosSolicitud;
