...
namespace BOLayer{
[DataObject]
public partial class FabricanteFactory
 {
...
/// <summary>
/// Create a new Fabricante Factory .
/// </summary>
public  FabricanteFactory()
{
}

/// <summary>
/// Create a new Fabricante Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  FabricanteFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Fabricante by using it's Primary Key values. This is the Primary method to retrieve a Fabricante.
/// </summary>
public Fabricante Fetch(System.String pCodFabricante)
{
...
_bo = (Fabricante) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Fabricanteinto the current session by using it's Primary Key values.
/// </summary>
public Fabricante Get(System.String pCodFabricante)
{
if ( String.IsNullOrEmpty(pCodFabricante)) throw new ArgumentException("Argument Name:pCodFabricante. Primary Key Column must have a value (different from null or empty)");
pCodFabricante = pCodFabricante.PadRight(5,' ') ;
Fabricante _bo = null ;
try 
{
_bo = Session.Get(typeof(Fabricante), pCodFabricante) as Fabricante;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of FabricanteCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public FabricanteCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Fabricante
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Fabricante),"Fabricante"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Fabricante");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of FabricanteCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public FabricanteCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 FabricanteCollection _list = new FabricanteCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of FabricanteCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public FabricanteCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of FabricanteCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public FabricanteCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FabricanteCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of FabricanteCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FabricanteCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pFabricante">A BO of type Fabricante</param>
public void ReAttach(Fabricante pFabricante)
{
if( pFabricante == null  ) throw new ArgumentNullException("pFabricante");
try 
{
Session.Lock(pFabricante, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Fabricante it saves it (insert) to the DataBase
/// </summary>
///<param name="pFabricante">A BO of type Fabricante</param>
public void Insert(Fabricante pFabricante)
{
if( pFabricante == null  ) throw new ArgumentNullException("pFabricante");
try 
{
BeginTransaction(false);
Session.Save(pFabricante);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Fabricante it Inserts them into the DataBase
/// </summary>
///<param name="pListFabricante">A List of Fabricante</param>
public void Insert(IEnumerable<Fabricante> pListFabricante)
{
if( pListFabricante == null  ) throw new ArgumentNullException("pListFabricante");
try 
{
BeginTransaction(false);
foreach ( Fabricante _Fabricante in pListFabricante ) 
{
Session.Save(_Fabricante);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pFabricante">A BO of type Fabricante</param>
public void Save(Fabricante pFabricante)
{
if( pFabricante == null  ) throw new ArgumentNullException("pFabricante");
try 
{
BeginTransaction(false);
Session.Update(pFabricante);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Fabricante
/// </summary>
///<param name="pFabricante">A BO of type Fabricante</param>
public void Delete(Fabricante pFabricante)
{
if( pFabricante == null  ) throw new ArgumentNullException("pFabricante");
try 
{
BeginTransaction(false);
Session.Delete(pFabricante);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Fabricante inside one transaction.
/// </summary>
///<param name="pListFabricante">A List of Fabricante</param>
public void Delete(IEnumerable<Fabricante> pListFabricante)
{
if( pListFabricante == null  ) throw new ArgumentNullException("pListFabricante");
try 
{
...
/// <summary>
/// Delete a Fabricante object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodFabricante)
{
Fabricante _fabricante = Fetch(pCodFabricante);
if ( _fabricante == null ) throw new Exception("Object not found , could not delete");
Delete(_fabricante);
...
/// </summary>
///<param name="pFabricante">A BO of type Fabricante</param>
public Fabricante Dummy(Fabricante pFabricante)
{
if( pFabricante == null  ) throw new ArgumentNullException("pFabricante");
return pFabricante;
