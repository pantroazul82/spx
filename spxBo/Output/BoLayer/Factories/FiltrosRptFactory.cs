...
namespace BOLayer{
[DataObject]
public partial class FiltrosRptFactory
 {
...
/// <summary>
/// Create a new FiltrosRpt Factory .
/// </summary>
public  FiltrosRptFactory()
{
}

/// <summary>
/// Create a new FiltrosRpt Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  FiltrosRptFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type FiltrosRpt by using it's Primary Key values. This is the Primary method to retrieve a FiltrosRpt.
/// </summary>
public FiltrosRpt Fetch(System.Int32 pIdRpt , System.Int32 pCodFiltroRpt)
{
FiltrosRpt _bo = null ;
try 
{
...
_criteria.Add(Restrictions.Eq("CodFiltroRpt" ,pCodFiltroRpt ));
_bo = (FiltrosRpt) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type FiltrosRpt by using it's Primary Key values. This is the Primary method to retrieve a FiltrosRpt.
/// </summary>
public FiltrosRpt FetchVirtual(string pVirtualKey)
{
...
System.Int32 _idRpt = System.Int32.Parse(_keys[0]);
System.Int32 _codFiltroRpt = System.Int32.Parse(_keys[1]);
return Fetch(_idRpt,_codFiltroRpt);
...
/// <summary>
/// Get strongly typed collection of FiltrosRptCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public FiltrosRptCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object FiltrosRpt
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(FiltrosRpt),"FiltrosRpt"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for FiltrosRpt");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of FiltrosRptCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public FiltrosRptCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 FiltrosRptCollection _list = new FiltrosRptCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of FiltrosRptCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public FiltrosRptCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of FiltrosRptCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public FiltrosRptCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FiltrosRptCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of FiltrosRptCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FiltrosRptCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pFiltrosRpt">A BO of type FiltrosRpt</param>
public void ReAttach(FiltrosRpt pFiltrosRpt)
{
if( pFiltrosRpt == null  ) throw new ArgumentNullException("pFiltrosRpt");
try 
{
Session.Lock(pFiltrosRpt, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class FiltrosRpt it saves it (insert) to the DataBase
/// </summary>
///<param name="pFiltrosRpt">A BO of type FiltrosRpt</param>
public void Insert(FiltrosRpt pFiltrosRpt)
{
if( pFiltrosRpt == null  ) throw new ArgumentNullException("pFiltrosRpt");
try 
{
BeginTransaction(false);
Session.Save(pFiltrosRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class FiltrosRpt it Inserts them into the DataBase
/// </summary>
///<param name="pListFiltrosRpt">A List of FiltrosRpt</param>
public void Insert(IEnumerable<FiltrosRpt> pListFiltrosRpt)
{
if( pListFiltrosRpt == null  ) throw new ArgumentNullException("pListFiltrosRpt");
try 
{
BeginTransaction(false);
foreach ( FiltrosRpt _FiltrosRpt in pListFiltrosRpt ) 
{
Session.Save(_FiltrosRpt);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pFiltrosRpt">A BO of type FiltrosRpt</param>
public void Save(FiltrosRpt pFiltrosRpt)
{
if( pFiltrosRpt == null  ) throw new ArgumentNullException("pFiltrosRpt");
try 
{
BeginTransaction(false);
Session.Update(pFiltrosRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type FiltrosRpt
/// </summary>
///<param name="pFiltrosRpt">A BO of type FiltrosRpt</param>
public void Delete(FiltrosRpt pFiltrosRpt)
{
if( pFiltrosRpt == null  ) throw new ArgumentNullException("pFiltrosRpt");
try 
{
BeginTransaction(false);
Session.Delete(pFiltrosRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type FiltrosRpt inside one transaction.
/// </summary>
///<param name="pListFiltrosRpt">A List of FiltrosRpt</param>
public void Delete(IEnumerable<FiltrosRpt> pListFiltrosRpt)
{
if( pListFiltrosRpt == null  ) throw new ArgumentNullException("pListFiltrosRpt");
try 
{
...
/// <summary>
/// Delete a FiltrosRpt object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdRpt , System.Int32 pCodFiltroRpt)
{
FiltrosRpt _filtrosRpt = Fetch(pIdRpt , pCodFiltroRpt);
if ( _filtrosRpt == null ) throw new Exception("Object not found , could not delete");
Delete(_filtrosRpt);
...
/// </summary>
///<param name="pFiltrosRpt">A BO of type FiltrosRpt</param>
public FiltrosRpt Dummy(FiltrosRpt pFiltrosRpt)
{
if( pFiltrosRpt == null  ) throw new ArgumentNullException("pFiltrosRpt");
return pFiltrosRpt;
