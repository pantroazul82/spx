...
namespace BOLayer{
[DataObject]
public partial class FotografiumFactory
 {
...
/// <summary>
/// Create a new Fotografium Factory .
/// </summary>
public  FotografiumFactory()
{
}

/// <summary>
/// Create a new Fotografium Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  FotografiumFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Fotografium by using it's Primary Key values. This is the Primary method to retrieve a Fotografium.
/// </summary>
public Fotografium Fetch(System.Int32 pCodFotografia)
{
Fotografium _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodFotografia" ,pCodFotografia ));
_bo = (Fotografium) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Fotografiuminto the current session by using it's Primary Key values.
/// </summary>
public Fotografium Get(System.Int32 pCodFotografia)
{
Fotografium _bo = null ;
try 
{
_bo = Session.Get(typeof(Fotografium), pCodFotografia) as Fotografium;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of FotografiumCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public FotografiumCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Fotografium
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Fotografium),"Fotografium"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Fotografium");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of FotografiumCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public FotografiumCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 FotografiumCollection _list = new FotografiumCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of FotografiumCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public FotografiumCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of FotografiumCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public FotografiumCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FotografiumCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of FotografiumCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public FotografiumCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pFotografium">A BO of type Fotografium</param>
public void ReAttach(Fotografium pFotografium)
{
if( pFotografium == null  ) throw new ArgumentNullException("pFotografium");
try 
{
Session.Lock(pFotografium, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Fotografium it saves it (insert) to the DataBase
/// </summary>
///<param name="pFotografium">A BO of type Fotografium</param>
public void Insert(Fotografium pFotografium)
{
if( pFotografium == null  ) throw new ArgumentNullException("pFotografium");
try 
{
BeginTransaction(false);
Session.Save(pFotografium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Fotografium it Inserts them into the DataBase
/// </summary>
///<param name="pListFotografium">A List of Fotografium</param>
public void Insert(IEnumerable<Fotografium> pListFotografium)
{
if( pListFotografium == null  ) throw new ArgumentNullException("pListFotografium");
try 
{
BeginTransaction(false);
foreach ( Fotografium _Fotografium in pListFotografium ) 
{
Session.Save(_Fotografium);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pFotografium">A BO of type Fotografium</param>
public void Save(Fotografium pFotografium)
{
if( pFotografium == null  ) throw new ArgumentNullException("pFotografium");
try 
{
BeginTransaction(false);
Session.Update(pFotografium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Fotografium
/// </summary>
///<param name="pFotografium">A BO of type Fotografium</param>
public void Delete(Fotografium pFotografium)
{
if( pFotografium == null  ) throw new ArgumentNullException("pFotografium");
try 
{
BeginTransaction(false);
Session.Delete(pFotografium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Fotografium inside one transaction.
/// </summary>
///<param name="pListFotografium">A List of Fotografium</param>
public void Delete(IEnumerable<Fotografium> pListFotografium)
{
if( pListFotografium == null  ) throw new ArgumentNullException("pListFotografium");
try 
{
...
/// <summary>
/// Delete a Fotografium object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodFotografia)
{
Fotografium _fotografium = Fetch(pCodFotografia);
if ( _fotografium == null ) throw new Exception("Object not found , could not delete");
Delete(_fotografium);
...
/// </summary>
///<param name="pFotografium">A BO of type Fotografium</param>
public Fotografium Dummy(Fotografium pFotografium)
{
if( pFotografium == null  ) throw new ArgumentNullException("pFotografium");
return pFotografium;
