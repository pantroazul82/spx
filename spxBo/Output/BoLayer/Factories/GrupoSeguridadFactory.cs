...
namespace BOLayer{
[DataObject]
public partial class GrupoSeguridadFactory
 {
...
/// <summary>
/// Create a new GrupoSeguridad Factory .
/// </summary>
public  GrupoSeguridadFactory()
{
}

/// <summary>
/// Create a new GrupoSeguridad Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GrupoSeguridadFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GrupoSeguridad by using it's Primary Key values. This is the Primary method to retrieve a GrupoSeguridad.
/// </summary>
public GrupoSeguridad Fetch(System.Int32 pCodGrupoSeguridad)
{
GrupoSeguridad _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodGrupoSeguridad" ,pCodGrupoSeguridad ));
_bo = (GrupoSeguridad) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type GrupoSeguridadinto the current session by using it's Primary Key values.
/// </summary>
public GrupoSeguridad Get(System.Int32 pCodGrupoSeguridad)
{
GrupoSeguridad _bo = null ;
try 
{
_bo = Session.Get(typeof(GrupoSeguridad), pCodGrupoSeguridad) as GrupoSeguridad;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of GrupoSeguridadCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GrupoSeguridadCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GrupoSeguridad
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GrupoSeguridad),"GrupoSeguridad"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GrupoSeguridad");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridadCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GrupoSeguridadCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GrupoSeguridadCollection _list = new GrupoSeguridadCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridadCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GrupoSeguridadCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GrupoSeguridadCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GrupoSeguridadCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridadCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GrupoSeguridadCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridadCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGrupoSeguridad">A BO of type GrupoSeguridad</param>
public void ReAttach(GrupoSeguridad pGrupoSeguridad)
{
if( pGrupoSeguridad == null  ) throw new ArgumentNullException("pGrupoSeguridad");
try 
{
Session.Lock(pGrupoSeguridad, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GrupoSeguridad it saves it (insert) to the DataBase
/// </summary>
///<param name="pGrupoSeguridad">A BO of type GrupoSeguridad</param>
public void Insert(GrupoSeguridad pGrupoSeguridad)
{
if( pGrupoSeguridad == null  ) throw new ArgumentNullException("pGrupoSeguridad");
try 
{
BeginTransaction(false);
Session.Save(pGrupoSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GrupoSeguridad it Inserts them into the DataBase
/// </summary>
///<param name="pListGrupoSeguridad">A List of GrupoSeguridad</param>
public void Insert(IEnumerable<GrupoSeguridad> pListGrupoSeguridad)
{
if( pListGrupoSeguridad == null  ) throw new ArgumentNullException("pListGrupoSeguridad");
try 
{
BeginTransaction(false);
foreach ( GrupoSeguridad _GrupoSeguridad in pListGrupoSeguridad ) 
{
Session.Save(_GrupoSeguridad);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGrupoSeguridad">A BO of type GrupoSeguridad</param>
public void Save(GrupoSeguridad pGrupoSeguridad)
{
if( pGrupoSeguridad == null  ) throw new ArgumentNullException("pGrupoSeguridad");
try 
{
BeginTransaction(false);
Session.Update(pGrupoSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GrupoSeguridad
/// </summary>
///<param name="pGrupoSeguridad">A BO of type GrupoSeguridad</param>
public void Delete(GrupoSeguridad pGrupoSeguridad)
{
if( pGrupoSeguridad == null  ) throw new ArgumentNullException("pGrupoSeguridad");
try 
{
BeginTransaction(false);
Session.Delete(pGrupoSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GrupoSeguridad inside one transaction.
/// </summary>
///<param name="pListGrupoSeguridad">A List of GrupoSeguridad</param>
public void Delete(IEnumerable<GrupoSeguridad> pListGrupoSeguridad)
{
if( pListGrupoSeguridad == null  ) throw new ArgumentNullException("pListGrupoSeguridad");
try 
{
...
foreach ( GrupoSeguridad _GrupoSeguridad in pListGrupoSeguridad ) 
{
Session.Delete(_GrupoSeguridad);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GrupoSeguridad object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodGrupoSeguridad)
{
GrupoSeguridad _grupoSeguridad = Fetch(pCodGrupoSeguridad);
if ( _grupoSeguridad == null ) throw new Exception("Object not found , could not delete");
Delete(_grupoSeguridad);
...
/// </summary>
///<param name="pGrupoSeguridad">A BO of type GrupoSeguridad</param>
public GrupoSeguridad Dummy(GrupoSeguridad pGrupoSeguridad)
{
if( pGrupoSeguridad == null  ) throw new ArgumentNullException("pGrupoSeguridad");
