...
namespace BOLayer{
[DataObject]
public partial class GrupoSeguridad_grupoUsuarioFactory
 {
...
/// <summary>
/// Create a new GrupoSeguridad_grupoUsuario Factory .
/// </summary>
public  GrupoSeguridad_grupoUsuarioFactory()
{
}

/// <summary>
/// Create a new GrupoSeguridad_grupoUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GrupoSeguridad_grupoUsuarioFactory(SessionScope pSessionScope)
{
...
/// </summary>
~GrupoSeguridad_grupoUsuarioFactory()
{
...
/// <summary>
/// Fetch an object of type GrupoSeguridad_grupoUsuario by using it's Primary Key values. This is the Primary method to retrieve a GrupoSeguridad_grupoUsuario.
/// </summary>
public GrupoSeguridad_grupoUsuario Fetch(System.Int32 pCodGrupoSeguridad_grupoUsuario)
{
GrupoSeguridad_grupoUsuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodGrupoSeguridad_grupoUsuario" ,pCodGrupoSeguridad_grupoUsuario ));
_bo = (GrupoSeguridad_grupoUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type GrupoSeguridad_grupoUsuariointo the current session by using it's Primary Key values.
/// </summary>
public GrupoSeguridad_grupoUsuario Get(System.Int32 pCodGrupoSeguridad_grupoUsuario)
{
GrupoSeguridad_grupoUsuario _bo = null ;
try 
{
_bo = Session.Get(typeof(GrupoSeguridad_grupoUsuario), pCodGrupoSeguridad_grupoUsuario) as GrupoSeguridad_grupoUsuario;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of GrupoSeguridad_grupoUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GrupoSeguridad_grupoUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GrupoSeguridad_grupoUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GrupoSeguridad_grupoUsuario),"GrupoSeguridad_grupoUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GrupoSeguridad_grupoUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_grupoUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GrupoSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GrupoSeguridad_grupoUsuarioCollection _list = new GrupoSeguridad_grupoUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_grupoUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GrupoSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_grupoUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GrupoSeguridad_grupoUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GrupoSeguridad_grupoUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGrupoSeguridad_grupoUsuario">A BO of type GrupoSeguridad_grupoUsuario</param>
public void ReAttach(GrupoSeguridad_grupoUsuario pGrupoSeguridad_grupoUsuario)
{
if( pGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_grupoUsuario");
try 
{
Session.Lock(pGrupoSeguridad_grupoUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GrupoSeguridad_grupoUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGrupoSeguridad_grupoUsuario">A BO of type GrupoSeguridad_grupoUsuario</param>
public void Insert(GrupoSeguridad_grupoUsuario pGrupoSeguridad_grupoUsuario)
{
if( pGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Save(pGrupoSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GrupoSeguridad_grupoUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGrupoSeguridad_grupoUsuario">A List of GrupoSeguridad_grupoUsuario</param>
public void Insert(IEnumerable<GrupoSeguridad_grupoUsuario> pListGrupoSeguridad_grupoUsuario)
{
if( pListGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pListGrupoSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
foreach ( GrupoSeguridad_grupoUsuario _GrupoSeguridad_grupoUsuario in pListGrupoSeguridad_grupoUsuario ) 
{
Session.Save(_GrupoSeguridad_grupoUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGrupoSeguridad_grupoUsuario">A BO of type GrupoSeguridad_grupoUsuario</param>
public void Save(GrupoSeguridad_grupoUsuario pGrupoSeguridad_grupoUsuario)
{
if( pGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Update(pGrupoSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GrupoSeguridad_grupoUsuario
/// </summary>
///<param name="pGrupoSeguridad_grupoUsuario">A BO of type GrupoSeguridad_grupoUsuario</param>
public void Delete(GrupoSeguridad_grupoUsuario pGrupoSeguridad_grupoUsuario)
{
if( pGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pGrupoSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GrupoSeguridad_grupoUsuario inside one transaction.
/// </summary>
///<param name="pListGrupoSeguridad_grupoUsuario">A List of GrupoSeguridad_grupoUsuario</param>
public void Delete(IEnumerable<GrupoSeguridad_grupoUsuario> pListGrupoSeguridad_grupoUsuario)
{
if( pListGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pListGrupoSeguridad_grupoUsuario");
try 
{
...
foreach ( GrupoSeguridad_grupoUsuario _GrupoSeguridad_grupoUsuario in pListGrupoSeguridad_grupoUsuario ) 
{
Session.Delete(_GrupoSeguridad_grupoUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GrupoSeguridad_grupoUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodGrupoSeguridad_grupoUsuario)
{
GrupoSeguridad_grupoUsuario _grupoSeguridad_grupoUsuario = Fetch(pCodGrupoSeguridad_grupoUsuario);
if ( _grupoSeguridad_grupoUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_grupoSeguridad_grupoUsuario);
...
/// </summary>
///<param name="pGrupoSeguridad_grupoUsuario">A BO of type GrupoSeguridad_grupoUsuario</param>
public GrupoSeguridad_grupoUsuario Dummy(GrupoSeguridad_grupoUsuario pGrupoSeguridad_grupoUsuario)
{
if( pGrupoSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_grupoUsuario");
return pGrupoSeguridad_grupoUsuario;
