...
namespace BOLayer{
[DataObject]
public partial class GrupoSeguridad_usuarioFactory
 {
...
/// <summary>
/// Create a new GrupoSeguridad_usuario Factory .
/// </summary>
public  GrupoSeguridad_usuarioFactory()
{
}

/// <summary>
/// Create a new GrupoSeguridad_usuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GrupoSeguridad_usuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GrupoSeguridad_usuario by using it's Primary Key values. This is the Primary method to retrieve a GrupoSeguridad_usuario.
/// </summary>
public GrupoSeguridad_usuario Fetch(System.Int32 pCodGrupoSeguridad_usuario)
{
GrupoSeguridad_usuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodGrupoSeguridad_usuario" ,pCodGrupoSeguridad_usuario ));
_bo = (GrupoSeguridad_usuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type GrupoSeguridad_usuariointo the current session by using it's Primary Key values.
/// </summary>
public GrupoSeguridad_usuario Get(System.Int32 pCodGrupoSeguridad_usuario)
{
GrupoSeguridad_usuario _bo = null ;
try 
{
_bo = Session.Get(typeof(GrupoSeguridad_usuario), pCodGrupoSeguridad_usuario) as GrupoSeguridad_usuario;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of GrupoSeguridad_usuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GrupoSeguridad_usuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GrupoSeguridad_usuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GrupoSeguridad_usuario),"GrupoSeguridad_usuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GrupoSeguridad_usuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_usuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GrupoSeguridad_usuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GrupoSeguridad_usuarioCollection _list = new GrupoSeguridad_usuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_usuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GrupoSeguridad_usuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GrupoSeguridad_usuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GrupoSeguridad_usuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridad_usuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GrupoSeguridad_usuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoSeguridad_usuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGrupoSeguridad_usuario">A BO of type GrupoSeguridad_usuario</param>
public void ReAttach(GrupoSeguridad_usuario pGrupoSeguridad_usuario)
{
if( pGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_usuario");
try 
{
Session.Lock(pGrupoSeguridad_usuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GrupoSeguridad_usuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGrupoSeguridad_usuario">A BO of type GrupoSeguridad_usuario</param>
public void Insert(GrupoSeguridad_usuario pGrupoSeguridad_usuario)
{
if( pGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_usuario");
try 
{
BeginTransaction(false);
Session.Save(pGrupoSeguridad_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GrupoSeguridad_usuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGrupoSeguridad_usuario">A List of GrupoSeguridad_usuario</param>
public void Insert(IEnumerable<GrupoSeguridad_usuario> pListGrupoSeguridad_usuario)
{
if( pListGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pListGrupoSeguridad_usuario");
try 
{
BeginTransaction(false);
foreach ( GrupoSeguridad_usuario _GrupoSeguridad_usuario in pListGrupoSeguridad_usuario ) 
{
Session.Save(_GrupoSeguridad_usuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGrupoSeguridad_usuario">A BO of type GrupoSeguridad_usuario</param>
public void Save(GrupoSeguridad_usuario pGrupoSeguridad_usuario)
{
if( pGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_usuario");
try 
{
BeginTransaction(false);
Session.Update(pGrupoSeguridad_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GrupoSeguridad_usuario
/// </summary>
///<param name="pGrupoSeguridad_usuario">A BO of type GrupoSeguridad_usuario</param>
public void Delete(GrupoSeguridad_usuario pGrupoSeguridad_usuario)
{
if( pGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_usuario");
try 
{
BeginTransaction(false);
Session.Delete(pGrupoSeguridad_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GrupoSeguridad_usuario inside one transaction.
/// </summary>
///<param name="pListGrupoSeguridad_usuario">A List of GrupoSeguridad_usuario</param>
public void Delete(IEnumerable<GrupoSeguridad_usuario> pListGrupoSeguridad_usuario)
{
if( pListGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pListGrupoSeguridad_usuario");
try 
{
...
foreach ( GrupoSeguridad_usuario _GrupoSeguridad_usuario in pListGrupoSeguridad_usuario ) 
{
Session.Delete(_GrupoSeguridad_usuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GrupoSeguridad_usuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodGrupoSeguridad_usuario)
{
GrupoSeguridad_usuario _grupoSeguridad_usuario = Fetch(pCodGrupoSeguridad_usuario);
if ( _grupoSeguridad_usuario == null ) throw new Exception("Object not found , could not delete");
Delete(_grupoSeguridad_usuario);
...
/// </summary>
///<param name="pGrupoSeguridad_usuario">A BO of type GrupoSeguridad_usuario</param>
public GrupoSeguridad_usuario Dummy(GrupoSeguridad_usuario pGrupoSeguridad_usuario)
{
if( pGrupoSeguridad_usuario == null  ) throw new ArgumentNullException("pGrupoSeguridad_usuario");
return pGrupoSeguridad_usuario;
