...
namespace BOLayer{
[DataObject]
public partial class GrupoUsuario_usuarioFactory
 {
...
/// <summary>
/// Create a new GrupoUsuario_usuario Factory .
/// </summary>
public  GrupoUsuario_usuarioFactory()
{
}

/// <summary>
/// Create a new GrupoUsuario_usuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GrupoUsuario_usuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GrupoUsuario_usuario by using it's Primary Key values. This is the Primary method to retrieve a GrupoUsuario_usuario.
/// </summary>
public GrupoUsuario_usuario Fetch(System.Int32 pCodGrupoUsuario_usuario)
{
GrupoUsuario_usuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodGrupoUsuario_usuario" ,pCodGrupoUsuario_usuario ));
_bo = (GrupoUsuario_usuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type GrupoUsuario_usuariointo the current session by using it's Primary Key values.
/// </summary>
public GrupoUsuario_usuario Get(System.Int32 pCodGrupoUsuario_usuario)
{
GrupoUsuario_usuario _bo = null ;
try 
{
_bo = Session.Get(typeof(GrupoUsuario_usuario), pCodGrupoUsuario_usuario) as GrupoUsuario_usuario;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of GrupoUsuario_usuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GrupoUsuario_usuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GrupoUsuario_usuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GrupoUsuario_usuario),"GrupoUsuario_usuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GrupoUsuario_usuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GrupoUsuario_usuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GrupoUsuario_usuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GrupoUsuario_usuarioCollection _list = new GrupoUsuario_usuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GrupoUsuario_usuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GrupoUsuario_usuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GrupoUsuario_usuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GrupoUsuario_usuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoUsuario_usuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GrupoUsuario_usuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GrupoUsuario_usuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGrupoUsuario_usuario">A BO of type GrupoUsuario_usuario</param>
public void ReAttach(GrupoUsuario_usuario pGrupoUsuario_usuario)
{
if( pGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pGrupoUsuario_usuario");
try 
{
Session.Lock(pGrupoUsuario_usuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GrupoUsuario_usuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGrupoUsuario_usuario">A BO of type GrupoUsuario_usuario</param>
public void Insert(GrupoUsuario_usuario pGrupoUsuario_usuario)
{
if( pGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pGrupoUsuario_usuario");
try 
{
BeginTransaction(false);
Session.Save(pGrupoUsuario_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GrupoUsuario_usuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGrupoUsuario_usuario">A List of GrupoUsuario_usuario</param>
public void Insert(IEnumerable<GrupoUsuario_usuario> pListGrupoUsuario_usuario)
{
if( pListGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pListGrupoUsuario_usuario");
try 
{
BeginTransaction(false);
foreach ( GrupoUsuario_usuario _GrupoUsuario_usuario in pListGrupoUsuario_usuario ) 
{
Session.Save(_GrupoUsuario_usuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGrupoUsuario_usuario">A BO of type GrupoUsuario_usuario</param>
public void Save(GrupoUsuario_usuario pGrupoUsuario_usuario)
{
if( pGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pGrupoUsuario_usuario");
try 
{
BeginTransaction(false);
Session.Update(pGrupoUsuario_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GrupoUsuario_usuario
/// </summary>
///<param name="pGrupoUsuario_usuario">A BO of type GrupoUsuario_usuario</param>
public void Delete(GrupoUsuario_usuario pGrupoUsuario_usuario)
{
if( pGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pGrupoUsuario_usuario");
try 
{
BeginTransaction(false);
Session.Delete(pGrupoUsuario_usuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GrupoUsuario_usuario inside one transaction.
/// </summary>
///<param name="pListGrupoUsuario_usuario">A List of GrupoUsuario_usuario</param>
public void Delete(IEnumerable<GrupoUsuario_usuario> pListGrupoUsuario_usuario)
{
if( pListGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pListGrupoUsuario_usuario");
try 
{
...
foreach ( GrupoUsuario_usuario _GrupoUsuario_usuario in pListGrupoUsuario_usuario ) 
{
Session.Delete(_GrupoUsuario_usuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GrupoUsuario_usuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodGrupoUsuario_usuario)
{
GrupoUsuario_usuario _grupoUsuario_usuario = Fetch(pCodGrupoUsuario_usuario);
if ( _grupoUsuario_usuario == null ) throw new Exception("Object not found , could not delete");
Delete(_grupoUsuario_usuario);
...
/// </summary>
///<param name="pGrupoUsuario_usuario">A BO of type GrupoUsuario_usuario</param>
public GrupoUsuario_usuario Dummy(GrupoUsuario_usuario pGrupoUsuario_usuario)
{
if( pGrupoUsuario_usuario == null  ) throw new ArgumentNullException("pGrupoUsuario_usuario");
return pGrupoUsuario_usuario;
