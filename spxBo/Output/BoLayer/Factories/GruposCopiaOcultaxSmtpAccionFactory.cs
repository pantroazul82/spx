...
namespace BOLayer{
[DataObject]
public partial class GruposCopiaOcultaxSmtpAccionFactory
 {
...
/// <summary>
/// Create a new GruposCopiaOcultaxSmtpAccion Factory .
/// </summary>
public  GruposCopiaOcultaxSmtpAccionFactory()
{
}

/// <summary>
/// Create a new GruposCopiaOcultaxSmtpAccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposCopiaOcultaxSmtpAccionFactory(SessionScope pSessionScope)
{
...
/// </summary>
~GruposCopiaOcultaxSmtpAccionFactory()
{
...
/// <summary>
/// Fetch an object of type GruposCopiaOcultaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposCopiaOcultaxSmtpAccion.
/// </summary>
public GruposCopiaOcultaxSmtpAccion Fetch(System.Int32 pIdCgSmtpAccion , System.String pCodGruposUsu)
{
...
GruposCopiaOcultaxSmtpAccion _bo = null ;
try 
{
...
_bo = (GruposCopiaOcultaxSmtpAccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposCopiaOcultaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposCopiaOcultaxSmtpAccion.
/// </summary>
public GruposCopiaOcultaxSmtpAccion FetchVirtual(string pVirtualKey)
{
...
System.Int32 _idCgSmtpAccion = System.Int32.Parse(_keys[0]);
System.String _codGruposUsu = _keys[1];
return Fetch(_idCgSmtpAccion,_codGruposUsu);
...
/// <summary>
/// Get strongly typed collection of GruposCopiaOcultaxSmtpAccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposCopiaOcultaxSmtpAccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposCopiaOcultaxSmtpAccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposCopiaOcultaxSmtpAccion),"GruposCopiaOcultaxSmtpAccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposCopiaOcultaxSmtpAccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposCopiaOcultaxSmtpAccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposCopiaOcultaxSmtpAccionCollection _list = new GruposCopiaOcultaxSmtpAccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposCopiaOcultaxSmtpAccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposCopiaOcultaxSmtpAccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposCopiaOcultaxSmtpAccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposCopiaOcultaxSmtpAccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposCopiaOcultaxSmtpAccion">A BO of type GruposCopiaOcultaxSmtpAccion</param>
public void ReAttach(GruposCopiaOcultaxSmtpAccion pGruposCopiaOcultaxSmtpAccion)
{
if( pGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaOcultaxSmtpAccion");
try 
{
Session.Lock(pGruposCopiaOcultaxSmtpAccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposCopiaOcultaxSmtpAccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposCopiaOcultaxSmtpAccion">A BO of type GruposCopiaOcultaxSmtpAccion</param>
public void Insert(GruposCopiaOcultaxSmtpAccion pGruposCopiaOcultaxSmtpAccion)
{
if( pGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Save(pGruposCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposCopiaOcultaxSmtpAccion it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposCopiaOcultaxSmtpAccion">A List of GruposCopiaOcultaxSmtpAccion</param>
public void Insert(IEnumerable<GruposCopiaOcultaxSmtpAccion> pListGruposCopiaOcultaxSmtpAccion)
{
if( pListGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
foreach ( GruposCopiaOcultaxSmtpAccion _GruposCopiaOcultaxSmtpAccion in pListGruposCopiaOcultaxSmtpAccion ) 
{
Session.Save(_GruposCopiaOcultaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposCopiaOcultaxSmtpAccion">A BO of type GruposCopiaOcultaxSmtpAccion</param>
public void Save(GruposCopiaOcultaxSmtpAccion pGruposCopiaOcultaxSmtpAccion)
{
if( pGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Update(pGruposCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposCopiaOcultaxSmtpAccion
/// </summary>
///<param name="pGruposCopiaOcultaxSmtpAccion">A BO of type GruposCopiaOcultaxSmtpAccion</param>
public void Delete(GruposCopiaOcultaxSmtpAccion pGruposCopiaOcultaxSmtpAccion)
{
if( pGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Delete(pGruposCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposCopiaOcultaxSmtpAccion inside one transaction.
/// </summary>
///<param name="pListGruposCopiaOcultaxSmtpAccion">A List of GruposCopiaOcultaxSmtpAccion</param>
public void Delete(IEnumerable<GruposCopiaOcultaxSmtpAccion> pListGruposCopiaOcultaxSmtpAccion)
{
if( pListGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposCopiaOcultaxSmtpAccion");
try 
{
...
foreach ( GruposCopiaOcultaxSmtpAccion _GruposCopiaOcultaxSmtpAccion in pListGruposCopiaOcultaxSmtpAccion ) 
{
Session.Delete(_GruposCopiaOcultaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposCopiaOcultaxSmtpAccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdCgSmtpAccion , System.String pCodGruposUsu)
{
GruposCopiaOcultaxSmtpAccion _gruposCopiaOcultaxSmtpAccion = Fetch(pIdCgSmtpAccion , pCodGruposUsu);
if ( _gruposCopiaOcultaxSmtpAccion == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposCopiaOcultaxSmtpAccion);
...
/// </summary>
///<param name="pGruposCopiaOcultaxSmtpAccion">A BO of type GruposCopiaOcultaxSmtpAccion</param>
public GruposCopiaOcultaxSmtpAccion Dummy(GruposCopiaOcultaxSmtpAccion pGruposCopiaOcultaxSmtpAccion)
{
if( pGruposCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaOcultaxSmtpAccion");
return pGruposCopiaOcultaxSmtpAccion;
