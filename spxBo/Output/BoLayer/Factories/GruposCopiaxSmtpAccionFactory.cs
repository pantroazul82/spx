...
namespace BOLayer{
[DataObject]
public partial class GruposCopiaxSmtpAccionFactory
 {
...
/// <summary>
/// Create a new GruposCopiaxSmtpAccion Factory .
/// </summary>
public  GruposCopiaxSmtpAccionFactory()
{
}

/// <summary>
/// Create a new GruposCopiaxSmtpAccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposCopiaxSmtpAccionFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposCopiaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposCopiaxSmtpAccion.
/// </summary>
public GruposCopiaxSmtpAccion Fetch(System.Int32 pIdCgSmtpAccion , System.String pCodGruposUsu)
{
...
GruposCopiaxSmtpAccion _bo = null ;
try 
{
...
_bo = (GruposCopiaxSmtpAccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposCopiaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposCopiaxSmtpAccion.
/// </summary>
public GruposCopiaxSmtpAccion FetchVirtual(string pVirtualKey)
{
...
/// <summary>
/// Get strongly typed collection of GruposCopiaxSmtpAccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposCopiaxSmtpAccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposCopiaxSmtpAccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposCopiaxSmtpAccion),"GruposCopiaxSmtpAccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposCopiaxSmtpAccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposCopiaxSmtpAccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposCopiaxSmtpAccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposCopiaxSmtpAccionCollection _list = new GruposCopiaxSmtpAccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposCopiaxSmtpAccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposCopiaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposCopiaxSmtpAccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposCopiaxSmtpAccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposCopiaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposCopiaxSmtpAccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposCopiaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposCopiaxSmtpAccion">A BO of type GruposCopiaxSmtpAccion</param>
public void ReAttach(GruposCopiaxSmtpAccion pGruposCopiaxSmtpAccion)
{
if( pGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaxSmtpAccion");
try 
{
Session.Lock(pGruposCopiaxSmtpAccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposCopiaxSmtpAccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposCopiaxSmtpAccion">A BO of type GruposCopiaxSmtpAccion</param>
public void Insert(GruposCopiaxSmtpAccion pGruposCopiaxSmtpAccion)
{
if( pGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Save(pGruposCopiaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposCopiaxSmtpAccion it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposCopiaxSmtpAccion">A List of GruposCopiaxSmtpAccion</param>
public void Insert(IEnumerable<GruposCopiaxSmtpAccion> pListGruposCopiaxSmtpAccion)
{
if( pListGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposCopiaxSmtpAccion");
try 
{
BeginTransaction(false);
foreach ( GruposCopiaxSmtpAccion _GruposCopiaxSmtpAccion in pListGruposCopiaxSmtpAccion ) 
{
Session.Save(_GruposCopiaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposCopiaxSmtpAccion">A BO of type GruposCopiaxSmtpAccion</param>
public void Save(GruposCopiaxSmtpAccion pGruposCopiaxSmtpAccion)
{
if( pGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Update(pGruposCopiaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposCopiaxSmtpAccion
/// </summary>
///<param name="pGruposCopiaxSmtpAccion">A BO of type GruposCopiaxSmtpAccion</param>
public void Delete(GruposCopiaxSmtpAccion pGruposCopiaxSmtpAccion)
{
if( pGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Delete(pGruposCopiaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposCopiaxSmtpAccion inside one transaction.
/// </summary>
///<param name="pListGruposCopiaxSmtpAccion">A List of GruposCopiaxSmtpAccion</param>
public void Delete(IEnumerable<GruposCopiaxSmtpAccion> pListGruposCopiaxSmtpAccion)
{
if( pListGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposCopiaxSmtpAccion");
try 
{
...
foreach ( GruposCopiaxSmtpAccion _GruposCopiaxSmtpAccion in pListGruposCopiaxSmtpAccion ) 
{
Session.Delete(_GruposCopiaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposCopiaxSmtpAccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
{
GruposCopiaxSmtpAccion _gruposCopiaxSmtpAccion = Fetch(pIdCgSmtpAccion , pCodGruposUsu);
if ( _gruposCopiaxSmtpAccion == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposCopiaxSmtpAccion);
...
/// </summary>
///<param name="pGruposCopiaxSmtpAccion">A BO of type GruposCopiaxSmtpAccion</param>
public GruposCopiaxSmtpAccion Dummy(GruposCopiaxSmtpAccion pGruposCopiaxSmtpAccion)
{
if( pGruposCopiaxSmtpAccion == null  ) throw new ArgumentNullException("pGruposCopiaxSmtpAccion");
return pGruposCopiaxSmtpAccion;
