...
namespace BOLayer{
[DataObject]
public partial class GruposModuloFactory
 {
...
/// <summary>
/// Create a new GruposModulo Factory .
/// </summary>
public  GruposModuloFactory()
{
}

/// <summary>
/// Create a new GruposModulo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposModuloFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposModulo by using it's Primary Key values. This is the Primary method to retrieve a GruposModulo.
/// </summary>
public GruposModulo Fetch(System.String pCodGrupoModulo)
{
...
/// <summary>
/// Load an object of type GruposModulointo the current session by using it's Primary Key values.
/// </summary>
public GruposModulo Get(System.String pCodGrupoModulo)
{
if ( String.IsNullOrEmpty(pCodGrupoModulo)) throw new ArgumentException("Argument Name:pCodGrupoModulo. Primary Key Column must have a value (different from null or empty)");
pCodGrupoModulo = pCodGrupoModulo.PadRight(10,' ') ;
GruposModulo _bo = null ;
try 
{
_bo = Session.Get(typeof(GruposModulo), pCodGrupoModulo) as GruposModulo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of GruposModuloCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposModuloCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposModulo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposModulo),"GruposModulo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposModulo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposModuloCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposModuloCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposModuloCollection _list = new GruposModuloCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposModuloCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposModuloCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposModuloCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposModuloCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModuloCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposModuloCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModuloCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposModulo">A BO of type GruposModulo</param>
public void ReAttach(GruposModulo pGruposModulo)
{
if( pGruposModulo == null  ) throw new ArgumentNullException("pGruposModulo");
try 
{
Session.Lock(pGruposModulo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposModulo it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposModulo">A BO of type GruposModulo</param>
public void Insert(GruposModulo pGruposModulo)
{
if( pGruposModulo == null  ) throw new ArgumentNullException("pGruposModulo");
try 
{
BeginTransaction(false);
Session.Save(pGruposModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposModulo it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposModulo">A List of GruposModulo</param>
public void Insert(IEnumerable<GruposModulo> pListGruposModulo)
{
if( pListGruposModulo == null  ) throw new ArgumentNullException("pListGruposModulo");
try 
{
BeginTransaction(false);
foreach ( GruposModulo _GruposModulo in pListGruposModulo ) 
{
Session.Save(_GruposModulo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposModulo">A BO of type GruposModulo</param>
public void Save(GruposModulo pGruposModulo)
{
if( pGruposModulo == null  ) throw new ArgumentNullException("pGruposModulo");
try 
{
BeginTransaction(false);
Session.Update(pGruposModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposModulo
/// </summary>
///<param name="pGruposModulo">A BO of type GruposModulo</param>
public void Delete(GruposModulo pGruposModulo)
{
if( pGruposModulo == null  ) throw new ArgumentNullException("pGruposModulo");
try 
{
BeginTransaction(false);
Session.Delete(pGruposModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposModulo inside one transaction.
/// </summary>
///<param name="pListGruposModulo">A List of GruposModulo</param>
public void Delete(IEnumerable<GruposModulo> pListGruposModulo)
{
if( pListGruposModulo == null  ) throw new ArgumentNullException("pListGruposModulo");
try 
{
...
/// <summary>
/// Delete a GruposModulo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodGrupoModulo)
{
GruposModulo _gruposModulo = Fetch(pCodGrupoModulo);
if ( _gruposModulo == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposModulo);
...
/// </summary>
///<param name="pGruposModulo">A BO of type GruposModulo</param>
public GruposModulo Dummy(GruposModulo pGruposModulo)
{
if( pGruposModulo == null  ) throw new ArgumentNullException("pGruposModulo");
return pGruposModulo;
