...
namespace BOLayer{
[DataObject]
public partial class GruposModulosxGruposUsuarioFactory
 {
...
/// <summary>
/// Create a new GruposModulosxGruposUsuario Factory .
/// </summary>
public  GruposModulosxGruposUsuarioFactory()
{
}

/// <summary>
/// Create a new GruposModulosxGruposUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposModulosxGruposUsuarioFactory(SessionScope pSessionScope)
{
...
/// </summary>
~GruposModulosxGruposUsuarioFactory()
{
...
/// <summary>
/// Fetch an object of type GruposModulosxGruposUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposModulosxGruposUsuario.
/// </summary>
public GruposModulosxGruposUsuario Fetch(System.String pCodGrupoModulo , System.String pCodGruposUsu)
{
if ( String.IsNullOrEmpty(pCodGrupoModulo)) throw new ArgumentException("Argument Name:pCodGrupoModulo. Primary Key Column must have a value (different from null or empty)");
pCodGrupoModulo = pCodGrupoModulo.PadRight(10,' ') ;
...
GruposModulosxGruposUsuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodGrupoModulo" ,pCodGrupoModulo ));
_criteria.Add(Restrictions.Eq("CodGruposUsu" ,pCodGruposUsu ));
_bo = (GruposModulosxGruposUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposModulosxGruposUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposModulosxGruposUsuario.
/// </summary>
public GruposModulosxGruposUsuario FetchVirtual(string pVirtualKey)
{
...
System.String _codGrupoModulo = _keys[0];
System.String _codGruposUsu = _keys[1];
return Fetch(_codGrupoModulo,_codGruposUsu);
...
/// <summary>
/// Get strongly typed collection of GruposModulosxGruposUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposModulosxGruposUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposModulosxGruposUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposModulosxGruposUsuario),"GruposModulosxGruposUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposModulosxGruposUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposModulosxGruposUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposModulosxGruposUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposModulosxGruposUsuarioCollection _list = new GruposModulosxGruposUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposModulosxGruposUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposModulosxGruposUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposModulosxGruposUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposModulosxGruposUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModulosxGruposUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposModulosxGruposUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModulosxGruposUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposModulosxGruposUsuario">A BO of type GruposModulosxGruposUsuario</param>
public void ReAttach(GruposModulosxGruposUsuario pGruposModulosxGruposUsuario)
{
if( pGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pGruposModulosxGruposUsuario");
try 
{
Session.Lock(pGruposModulosxGruposUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposModulosxGruposUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposModulosxGruposUsuario">A BO of type GruposModulosxGruposUsuario</param>
public void Insert(GruposModulosxGruposUsuario pGruposModulosxGruposUsuario)
{
if( pGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pGruposModulosxGruposUsuario");
try 
{
BeginTransaction(false);
Session.Save(pGruposModulosxGruposUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposModulosxGruposUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposModulosxGruposUsuario">A List of GruposModulosxGruposUsuario</param>
public void Insert(IEnumerable<GruposModulosxGruposUsuario> pListGruposModulosxGruposUsuario)
{
if( pListGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pListGruposModulosxGruposUsuario");
try 
{
BeginTransaction(false);
foreach ( GruposModulosxGruposUsuario _GruposModulosxGruposUsuario in pListGruposModulosxGruposUsuario ) 
{
Session.Save(_GruposModulosxGruposUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposModulosxGruposUsuario">A BO of type GruposModulosxGruposUsuario</param>
public void Save(GruposModulosxGruposUsuario pGruposModulosxGruposUsuario)
{
if( pGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pGruposModulosxGruposUsuario");
try 
{
BeginTransaction(false);
Session.Update(pGruposModulosxGruposUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposModulosxGruposUsuario
/// </summary>
///<param name="pGruposModulosxGruposUsuario">A BO of type GruposModulosxGruposUsuario</param>
public void Delete(GruposModulosxGruposUsuario pGruposModulosxGruposUsuario)
{
if( pGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pGruposModulosxGruposUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pGruposModulosxGruposUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposModulosxGruposUsuario inside one transaction.
/// </summary>
///<param name="pListGruposModulosxGruposUsuario">A List of GruposModulosxGruposUsuario</param>
public void Delete(IEnumerable<GruposModulosxGruposUsuario> pListGruposModulosxGruposUsuario)
{
if( pListGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pListGruposModulosxGruposUsuario");
try 
{
...
foreach ( GruposModulosxGruposUsuario _GruposModulosxGruposUsuario in pListGruposModulosxGruposUsuario ) 
{
Session.Delete(_GruposModulosxGruposUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposModulosxGruposUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodGrupoModulo , System.String pCodGruposUsu)
{
GruposModulosxGruposUsuario _gruposModulosxGruposUsuario = Fetch(pCodGrupoModulo , pCodGruposUsu);
if ( _gruposModulosxGruposUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposModulosxGruposUsuario);
...
/// </summary>
///<param name="pGruposModulosxGruposUsuario">A BO of type GruposModulosxGruposUsuario</param>
public GruposModulosxGruposUsuario Dummy(GruposModulosxGruposUsuario pGruposModulosxGruposUsuario)
{
if( pGruposModulosxGruposUsuario == null  ) throw new ArgumentNullException("pGruposModulosxGruposUsuario");
return pGruposModulosxGruposUsuario;
