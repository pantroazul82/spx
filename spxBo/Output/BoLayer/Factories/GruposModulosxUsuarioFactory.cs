...
namespace BOLayer{
[DataObject]
public partial class GruposModulosxUsuarioFactory
 {
...
/// <summary>
/// Create a new GruposModulosxUsuario Factory .
/// </summary>
public  GruposModulosxUsuarioFactory()
{
}

/// <summary>
/// Create a new GruposModulosxUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposModulosxUsuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposModulosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposModulosxUsuario.
/// </summary>
public GruposModulosxUsuario Fetch(System.String pCodGrupoModulo , System.String pLogin)
{
...
GruposModulosxUsuario _bo = null ;
try 
{
...
_bo = (GruposModulosxUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposModulosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposModulosxUsuario.
/// </summary>
public GruposModulosxUsuario FetchVirtual(string pVirtualKey)
{
...
System.String _login = _keys[1];
return Fetch(_codGrupoModulo,_login);
...
/// <summary>
/// Get strongly typed collection of GruposModulosxUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposModulosxUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposModulosxUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposModulosxUsuario),"GruposModulosxUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposModulosxUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposModulosxUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposModulosxUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposModulosxUsuarioCollection _list = new GruposModulosxUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposModulosxUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposModulosxUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposModulosxUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposModulosxUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposModulosxUsuario">A BO of type GruposModulosxUsuario</param>
public void ReAttach(GruposModulosxUsuario pGruposModulosxUsuario)
{
if( pGruposModulosxUsuario == null  ) throw new ArgumentNullException("pGruposModulosxUsuario");
try 
{
Session.Lock(pGruposModulosxUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposModulosxUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposModulosxUsuario">A BO of type GruposModulosxUsuario</param>
public void Insert(GruposModulosxUsuario pGruposModulosxUsuario)
{
if( pGruposModulosxUsuario == null  ) throw new ArgumentNullException("pGruposModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Save(pGruposModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposModulosxUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposModulosxUsuario">A List of GruposModulosxUsuario</param>
public void Insert(IEnumerable<GruposModulosxUsuario> pListGruposModulosxUsuario)
{
if( pListGruposModulosxUsuario == null  ) throw new ArgumentNullException("pListGruposModulosxUsuario");
try 
{
BeginTransaction(false);
foreach ( GruposModulosxUsuario _GruposModulosxUsuario in pListGruposModulosxUsuario ) 
{
Session.Save(_GruposModulosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposModulosxUsuario">A BO of type GruposModulosxUsuario</param>
public void Save(GruposModulosxUsuario pGruposModulosxUsuario)
{
if( pGruposModulosxUsuario == null  ) throw new ArgumentNullException("pGruposModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Update(pGruposModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposModulosxUsuario
/// </summary>
///<param name="pGruposModulosxUsuario">A BO of type GruposModulosxUsuario</param>
public void Delete(GruposModulosxUsuario pGruposModulosxUsuario)
{
if( pGruposModulosxUsuario == null  ) throw new ArgumentNullException("pGruposModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pGruposModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposModulosxUsuario inside one transaction.
/// </summary>
///<param name="pListGruposModulosxUsuario">A List of GruposModulosxUsuario</param>
public void Delete(IEnumerable<GruposModulosxUsuario> pListGruposModulosxUsuario)
{
if( pListGruposModulosxUsuario == null  ) throw new ArgumentNullException("pListGruposModulosxUsuario");
try 
{
...
foreach ( GruposModulosxUsuario _GruposModulosxUsuario in pListGruposModulosxUsuario ) 
{
Session.Delete(_GruposModulosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposModulosxUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodGrupoModulo , System.String pLogin)
{
GruposModulosxUsuario _gruposModulosxUsuario = Fetch(pCodGrupoModulo , pLogin);
if ( _gruposModulosxUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposModulosxUsuario);
...
/// </summary>
///<param name="pGruposModulosxUsuario">A BO of type GruposModulosxUsuario</param>
public GruposModulosxUsuario Dummy(GruposModulosxUsuario pGruposModulosxUsuario)
{
if( pGruposModulosxUsuario == null  ) throw new ArgumentNullException("pGruposModulosxUsuario");
return pGruposModulosxUsuario;
