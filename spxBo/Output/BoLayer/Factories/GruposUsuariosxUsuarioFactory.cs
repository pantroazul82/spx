...
namespace BOLayer{
[DataObject]
public partial class GruposUsuariosxUsuarioFactory
 {
...
/// <summary>
/// Create a new GruposUsuariosxUsuario Factory .
/// </summary>
public  GruposUsuariosxUsuarioFactory()
{
}

/// <summary>
/// Create a new GruposUsuariosxUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposUsuariosxUsuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposUsuariosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposUsuariosxUsuario.
/// </summary>
public GruposUsuariosxUsuario Fetch(System.String pLogin , System.String pCodGruposUsu)
{
...
GruposUsuariosxUsuario _bo = null ;
try 
{
...
_bo = (GruposUsuariosxUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposUsuariosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a GruposUsuariosxUsuario.
/// </summary>
public GruposUsuariosxUsuario FetchVirtual(string pVirtualKey)
{
...
return Fetch(_login,_codGruposUsu);
...
/// <summary>
/// Get strongly typed collection of GruposUsuariosxUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposUsuariosxUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposUsuariosxUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposUsuariosxUsuario),"GruposUsuariosxUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposUsuariosxUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposUsuariosxUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposUsuariosxUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposUsuariosxUsuarioCollection _list = new GruposUsuariosxUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposUsuariosxUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposUsuariosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposUsuariosxUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposUsuariosxUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposUsuariosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposUsuariosxUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposUsuariosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposUsuariosxUsuario">A BO of type GruposUsuariosxUsuario</param>
public void ReAttach(GruposUsuariosxUsuario pGruposUsuariosxUsuario)
{
if( pGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pGruposUsuariosxUsuario");
try 
{
Session.Lock(pGruposUsuariosxUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposUsuariosxUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposUsuariosxUsuario">A BO of type GruposUsuariosxUsuario</param>
public void Insert(GruposUsuariosxUsuario pGruposUsuariosxUsuario)
{
if( pGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pGruposUsuariosxUsuario");
try 
{
BeginTransaction(false);
Session.Save(pGruposUsuariosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposUsuariosxUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposUsuariosxUsuario">A List of GruposUsuariosxUsuario</param>
public void Insert(IEnumerable<GruposUsuariosxUsuario> pListGruposUsuariosxUsuario)
{
if( pListGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pListGruposUsuariosxUsuario");
try 
{
BeginTransaction(false);
foreach ( GruposUsuariosxUsuario _GruposUsuariosxUsuario in pListGruposUsuariosxUsuario ) 
{
Session.Save(_GruposUsuariosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposUsuariosxUsuario">A BO of type GruposUsuariosxUsuario</param>
public void Save(GruposUsuariosxUsuario pGruposUsuariosxUsuario)
{
if( pGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pGruposUsuariosxUsuario");
try 
{
BeginTransaction(false);
Session.Update(pGruposUsuariosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposUsuariosxUsuario
/// </summary>
///<param name="pGruposUsuariosxUsuario">A BO of type GruposUsuariosxUsuario</param>
public void Delete(GruposUsuariosxUsuario pGruposUsuariosxUsuario)
{
if( pGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pGruposUsuariosxUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pGruposUsuariosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposUsuariosxUsuario inside one transaction.
/// </summary>
///<param name="pListGruposUsuariosxUsuario">A List of GruposUsuariosxUsuario</param>
public void Delete(IEnumerable<GruposUsuariosxUsuario> pListGruposUsuariosxUsuario)
{
if( pListGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pListGruposUsuariosxUsuario");
try 
{
...
foreach ( GruposUsuariosxUsuario _GruposUsuariosxUsuario in pListGruposUsuariosxUsuario ) 
{
Session.Delete(_GruposUsuariosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposUsuariosxUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pLogin , System.String pCodGruposUsu)
{
GruposUsuariosxUsuario _gruposUsuariosxUsuario = Fetch(pLogin , pCodGruposUsu);
if ( _gruposUsuariosxUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposUsuariosxUsuario);
...
/// </summary>
///<param name="pGruposUsuariosxUsuario">A BO of type GruposUsuariosxUsuario</param>
public GruposUsuariosxUsuario Dummy(GruposUsuariosxUsuario pGruposUsuariosxUsuario)
{
if( pGruposUsuariosxUsuario == null  ) throw new ArgumentNullException("pGruposUsuariosxUsuario");
return pGruposUsuariosxUsuario;
