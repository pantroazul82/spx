...
namespace BOLayer{
[DataObject]
public partial class GruposXgrupoFactory
 {
...
/// <summary>
/// Create a new GruposXgrupo Factory .
/// </summary>
public  GruposXgrupoFactory()
{
}

/// <summary>
/// Create a new GruposXgrupo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposXgrupoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposXgrupo by using it's Primary Key values. This is the Primary method to retrieve a GruposXgrupo.
/// </summary>
public GruposXgrupo Fetch(System.String pCodGruposUsu , System.String pSubordinadoDe)
{
...
_bo = (GruposXgrupo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposXgrupo by using it's Primary Key values. This is the Primary method to retrieve a GruposXgrupo.
/// </summary>
public GruposXgrupo FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codGruposUsu,_subordinadoDe);
...
/// <summary>
/// Get strongly typed collection of GruposXgrupoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposXgrupoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposXgrupo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposXgrupo),"GruposXgrupo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposXgrupo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposXgrupoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposXgrupoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposXgrupoCollection _list = new GruposXgrupoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposXgrupoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposXgrupoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposXgrupoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposXgrupoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposXgrupoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposXgrupoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposXgrupoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposXgrupo">A BO of type GruposXgrupo</param>
public void ReAttach(GruposXgrupo pGruposXgrupo)
{
if( pGruposXgrupo == null  ) throw new ArgumentNullException("pGruposXgrupo");
try 
{
Session.Lock(pGruposXgrupo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposXgrupo it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposXgrupo">A BO of type GruposXgrupo</param>
public void Insert(GruposXgrupo pGruposXgrupo)
{
if( pGruposXgrupo == null  ) throw new ArgumentNullException("pGruposXgrupo");
try 
{
BeginTransaction(false);
Session.Save(pGruposXgrupo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposXgrupo it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposXgrupo">A List of GruposXgrupo</param>
public void Insert(IEnumerable<GruposXgrupo> pListGruposXgrupo)
{
if( pListGruposXgrupo == null  ) throw new ArgumentNullException("pListGruposXgrupo");
try 
{
BeginTransaction(false);
foreach ( GruposXgrupo _GruposXgrupo in pListGruposXgrupo ) 
{
Session.Save(_GruposXgrupo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposXgrupo">A BO of type GruposXgrupo</param>
public void Save(GruposXgrupo pGruposXgrupo)
{
if( pGruposXgrupo == null  ) throw new ArgumentNullException("pGruposXgrupo");
try 
{
BeginTransaction(false);
Session.Update(pGruposXgrupo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposXgrupo
/// </summary>
///<param name="pGruposXgrupo">A BO of type GruposXgrupo</param>
public void Delete(GruposXgrupo pGruposXgrupo)
{
if( pGruposXgrupo == null  ) throw new ArgumentNullException("pGruposXgrupo");
try 
{
BeginTransaction(false);
Session.Delete(pGruposXgrupo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposXgrupo inside one transaction.
/// </summary>
///<param name="pListGruposXgrupo">A List of GruposXgrupo</param>
public void Delete(IEnumerable<GruposXgrupo> pListGruposXgrupo)
{
if( pListGruposXgrupo == null  ) throw new ArgumentNullException("pListGruposXgrupo");
try 
{
...
/// <summary>
/// Delete a GruposXgrupo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodGruposUsu , System.String pSubordinadoDe)
{
GruposXgrupo _gruposXgrupo = Fetch(pCodGruposUsu , pSubordinadoDe);
if ( _gruposXgrupo == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposXgrupo);
...
/// </summary>
///<param name="pGruposXgrupo">A BO of type GruposXgrupo</param>
public GruposXgrupo Dummy(GruposXgrupo pGruposXgrupo)
{
if( pGruposXgrupo == null  ) throw new ArgumentNullException("pGruposXgrupo");
return pGruposXgrupo;
