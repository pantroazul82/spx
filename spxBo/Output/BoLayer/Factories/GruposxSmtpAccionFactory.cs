...
namespace BOLayer{
[DataObject]
public partial class GruposxSmtpAccionFactory
 {
...
/// <summary>
/// Create a new GruposxSmtpAccion Factory .
/// </summary>
public  GruposxSmtpAccionFactory()
{
}

/// <summary>
/// Create a new GruposxSmtpAccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  GruposxSmtpAccionFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type GruposxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposxSmtpAccion.
/// </summary>
public GruposxSmtpAccion Fetch(System.String pCodGruposUsu , System.Int32 pIdCgSmtpAccion)
{
...
_bo = (GruposxSmtpAccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type GruposxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a GruposxSmtpAccion.
/// </summary>
public GruposxSmtpAccion FetchVirtual(string pVirtualKey)
{
...
System.String _codGruposUsu = _keys[0];
System.Int32 _idCgSmtpAccion = System.Int32.Parse(_keys[1]);
return Fetch(_codGruposUsu,_idCgSmtpAccion);
...
/// <summary>
/// Get strongly typed collection of GruposxSmtpAccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public GruposxSmtpAccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object GruposxSmtpAccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(GruposxSmtpAccion),"GruposxSmtpAccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for GruposxSmtpAccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of GruposxSmtpAccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public GruposxSmtpAccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 GruposxSmtpAccionCollection _list = new GruposxSmtpAccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of GruposxSmtpAccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public GruposxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of GruposxSmtpAccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public GruposxSmtpAccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of GruposxSmtpAccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public GruposxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pGruposxSmtpAccion">A BO of type GruposxSmtpAccion</param>
public void ReAttach(GruposxSmtpAccion pGruposxSmtpAccion)
{
if( pGruposxSmtpAccion == null  ) throw new ArgumentNullException("pGruposxSmtpAccion");
try 
{
Session.Lock(pGruposxSmtpAccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class GruposxSmtpAccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pGruposxSmtpAccion">A BO of type GruposxSmtpAccion</param>
public void Insert(GruposxSmtpAccion pGruposxSmtpAccion)
{
if( pGruposxSmtpAccion == null  ) throw new ArgumentNullException("pGruposxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Save(pGruposxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class GruposxSmtpAccion it Inserts them into the DataBase
/// </summary>
///<param name="pListGruposxSmtpAccion">A List of GruposxSmtpAccion</param>
public void Insert(IEnumerable<GruposxSmtpAccion> pListGruposxSmtpAccion)
{
if( pListGruposxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposxSmtpAccion");
try 
{
BeginTransaction(false);
foreach ( GruposxSmtpAccion _GruposxSmtpAccion in pListGruposxSmtpAccion ) 
{
Session.Save(_GruposxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pGruposxSmtpAccion">A BO of type GruposxSmtpAccion</param>
public void Save(GruposxSmtpAccion pGruposxSmtpAccion)
{
if( pGruposxSmtpAccion == null  ) throw new ArgumentNullException("pGruposxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Update(pGruposxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type GruposxSmtpAccion
/// </summary>
///<param name="pGruposxSmtpAccion">A BO of type GruposxSmtpAccion</param>
public void Delete(GruposxSmtpAccion pGruposxSmtpAccion)
{
if( pGruposxSmtpAccion == null  ) throw new ArgumentNullException("pGruposxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Delete(pGruposxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type GruposxSmtpAccion inside one transaction.
/// </summary>
///<param name="pListGruposxSmtpAccion">A List of GruposxSmtpAccion</param>
public void Delete(IEnumerable<GruposxSmtpAccion> pListGruposxSmtpAccion)
{
if( pListGruposxSmtpAccion == null  ) throw new ArgumentNullException("pListGruposxSmtpAccion");
try 
{
...
foreach ( GruposxSmtpAccion _GruposxSmtpAccion in pListGruposxSmtpAccion ) 
{
Session.Delete(_GruposxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a GruposxSmtpAccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodGruposUsu , System.Int32 pIdCgSmtpAccion)
{
GruposxSmtpAccion _gruposxSmtpAccion = Fetch(pCodGruposUsu , pIdCgSmtpAccion);
if ( _gruposxSmtpAccion == null ) throw new Exception("Object not found , could not delete");
Delete(_gruposxSmtpAccion);
...
/// </summary>
///<param name="pGruposxSmtpAccion">A BO of type GruposxSmtpAccion</param>
public GruposxSmtpAccion Dummy(GruposxSmtpAccion pGruposxSmtpAccion)
{
if( pGruposxSmtpAccion == null  ) throw new ArgumentNullException("pGruposxSmtpAccion");
return pGruposxSmtpAccion;
