...
namespace BOLayer{
[DataObject]
public partial class IndicacionesLLamadaFactory
 {
...
/// <summary>
/// Create a new IndicacionesLLamada Factory .
/// </summary>
public  IndicacionesLLamadaFactory()
{
}

/// <summary>
/// Create a new IndicacionesLLamada Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  IndicacionesLLamadaFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type IndicacionesLLamada by using it's Primary Key values. This is the Primary method to retrieve a IndicacionesLLamada.
/// </summary>
public IndicacionesLLamada Fetch(System.Int32 pIdLLamadaSoporte , System.Int32 pCodIndicacion)
{
IndicacionesLLamada _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdLLamadaSoporte" ,pIdLLamadaSoporte ));
_criteria.Add(Restrictions.Eq("CodIndicacion" ,pCodIndicacion ));
_bo = (IndicacionesLLamada) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type IndicacionesLLamada by using it's Primary Key values. This is the Primary method to retrieve a IndicacionesLLamada.
/// </summary>
public IndicacionesLLamada FetchVirtual(string pVirtualKey)
{
...
System.Int32 _idLLamadaSoporte = System.Int32.Parse(_keys[0]);
System.Int32 _codIndicacion = System.Int32.Parse(_keys[1]);
return Fetch(_idLLamadaSoporte,_codIndicacion);
...
/// <summary>
/// Get strongly typed collection of IndicacionesLLamadaCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public IndicacionesLLamadaCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object IndicacionesLLamada
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(IndicacionesLLamada),"IndicacionesLLamada"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for IndicacionesLLamada");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of IndicacionesLLamadaCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public IndicacionesLLamadaCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 IndicacionesLLamadaCollection _list = new IndicacionesLLamadaCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of IndicacionesLLamadaCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public IndicacionesLLamadaCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of IndicacionesLLamadaCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public IndicacionesLLamadaCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public IndicacionesLLamadaCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of IndicacionesLLamadaCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public IndicacionesLLamadaCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pIndicacionesLLamada">A BO of type IndicacionesLLamada</param>
public void ReAttach(IndicacionesLLamada pIndicacionesLLamada)
{
if( pIndicacionesLLamada == null  ) throw new ArgumentNullException("pIndicacionesLLamada");
try 
{
Session.Lock(pIndicacionesLLamada, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class IndicacionesLLamada it saves it (insert) to the DataBase
/// </summary>
///<param name="pIndicacionesLLamada">A BO of type IndicacionesLLamada</param>
public void Insert(IndicacionesLLamada pIndicacionesLLamada)
{
if( pIndicacionesLLamada == null  ) throw new ArgumentNullException("pIndicacionesLLamada");
try 
{
BeginTransaction(false);
Session.Save(pIndicacionesLLamada);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class IndicacionesLLamada it Inserts them into the DataBase
/// </summary>
///<param name="pListIndicacionesLLamada">A List of IndicacionesLLamada</param>
public void Insert(IEnumerable<IndicacionesLLamada> pListIndicacionesLLamada)
{
if( pListIndicacionesLLamada == null  ) throw new ArgumentNullException("pListIndicacionesLLamada");
try 
{
BeginTransaction(false);
foreach ( IndicacionesLLamada _IndicacionesLLamada in pListIndicacionesLLamada ) 
{
Session.Save(_IndicacionesLLamada);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pIndicacionesLLamada">A BO of type IndicacionesLLamada</param>
public void Save(IndicacionesLLamada pIndicacionesLLamada)
{
if( pIndicacionesLLamada == null  ) throw new ArgumentNullException("pIndicacionesLLamada");
try 
{
BeginTransaction(false);
Session.Update(pIndicacionesLLamada);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type IndicacionesLLamada
/// </summary>
///<param name="pIndicacionesLLamada">A BO of type IndicacionesLLamada</param>
public void Delete(IndicacionesLLamada pIndicacionesLLamada)
{
if( pIndicacionesLLamada == null  ) throw new ArgumentNullException("pIndicacionesLLamada");
try 
{
BeginTransaction(false);
Session.Delete(pIndicacionesLLamada);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type IndicacionesLLamada inside one transaction.
/// </summary>
///<param name="pListIndicacionesLLamada">A List of IndicacionesLLamada</param>
public void Delete(IEnumerable<IndicacionesLLamada> pListIndicacionesLLamada)
{
if( pListIndicacionesLLamada == null  ) throw new ArgumentNullException("pListIndicacionesLLamada");
try 
{
...
foreach ( IndicacionesLLamada _IndicacionesLLamada in pListIndicacionesLLamada ) 
{
Session.Delete(_IndicacionesLLamada);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a IndicacionesLLamada object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdLLamadaSoporte , System.Int32 pCodIndicacion)
{
IndicacionesLLamada _indicacionesLLamada = Fetch(pIdLLamadaSoporte , pCodIndicacion);
if ( _indicacionesLLamada == null ) throw new Exception("Object not found , could not delete");
Delete(_indicacionesLLamada);
...
/// </summary>
///<param name="pIndicacionesLLamada">A BO of type IndicacionesLLamada</param>
public IndicacionesLLamada Dummy(IndicacionesLLamada pIndicacionesLLamada)
{
if( pIndicacionesLLamada == null  ) throw new ArgumentNullException("pIndicacionesLLamada");
return pIndicacionesLLamada;
