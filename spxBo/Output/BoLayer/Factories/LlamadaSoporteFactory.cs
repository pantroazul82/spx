...
namespace BOLayer{
[DataObject]
public partial class LlamadaSoporteFactory
 {
...
/// <summary>
/// Create a new LlamadaSoporte Factory .
/// </summary>
public  LlamadaSoporteFactory()
{
}

/// <summary>
/// Create a new LlamadaSoporte Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  LlamadaSoporteFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type LlamadaSoporte by using it's Primary Key values. This is the Primary method to retrieve a LlamadaSoporte.
/// </summary>
public LlamadaSoporte Fetch(System.Int32 pIdLlamadaSoporte)
{
LlamadaSoporte _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdLlamadaSoporte" ,pIdLlamadaSoporte ));
_bo = (LlamadaSoporte) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type LlamadaSoporteinto the current session by using it's Primary Key values.
/// </summary>
public LlamadaSoporte Get(System.Int32 pIdLlamadaSoporte)
{
LlamadaSoporte _bo = null ;
try 
{
_bo = Session.Get(typeof(LlamadaSoporte), pIdLlamadaSoporte) as LlamadaSoporte;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of LlamadaSoporteCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public LlamadaSoporteCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object LlamadaSoporte
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(LlamadaSoporte),"LlamadaSoporte"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for LlamadaSoporte");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of LlamadaSoporteCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public LlamadaSoporteCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 LlamadaSoporteCollection _list = new LlamadaSoporteCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of LlamadaSoporteCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public LlamadaSoporteCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of LlamadaSoporteCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public LlamadaSoporteCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public LlamadaSoporteCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of LlamadaSoporteCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public LlamadaSoporteCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pLlamadaSoporte">A BO of type LlamadaSoporte</param>
public void ReAttach(LlamadaSoporte pLlamadaSoporte)
{
if( pLlamadaSoporte == null  ) throw new ArgumentNullException("pLlamadaSoporte");
try 
{
Session.Lock(pLlamadaSoporte, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class LlamadaSoporte it saves it (insert) to the DataBase
/// </summary>
///<param name="pLlamadaSoporte">A BO of type LlamadaSoporte</param>
public void Insert(LlamadaSoporte pLlamadaSoporte)
{
if( pLlamadaSoporte == null  ) throw new ArgumentNullException("pLlamadaSoporte");
try 
{
BeginTransaction(false);
Session.Save(pLlamadaSoporte);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class LlamadaSoporte it Inserts them into the DataBase
/// </summary>
///<param name="pListLlamadaSoporte">A List of LlamadaSoporte</param>
public void Insert(IEnumerable<LlamadaSoporte> pListLlamadaSoporte)
{
if( pListLlamadaSoporte == null  ) throw new ArgumentNullException("pListLlamadaSoporte");
try 
{
BeginTransaction(false);
foreach ( LlamadaSoporte _LlamadaSoporte in pListLlamadaSoporte ) 
{
Session.Save(_LlamadaSoporte);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pLlamadaSoporte">A BO of type LlamadaSoporte</param>
public void Save(LlamadaSoporte pLlamadaSoporte)
{
if( pLlamadaSoporte == null  ) throw new ArgumentNullException("pLlamadaSoporte");
try 
{
BeginTransaction(false);
Session.Update(pLlamadaSoporte);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type LlamadaSoporte
/// </summary>
///<param name="pLlamadaSoporte">A BO of type LlamadaSoporte</param>
public void Delete(LlamadaSoporte pLlamadaSoporte)
{
if( pLlamadaSoporte == null  ) throw new ArgumentNullException("pLlamadaSoporte");
try 
{
BeginTransaction(false);
Session.Delete(pLlamadaSoporte);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type LlamadaSoporte inside one transaction.
/// </summary>
///<param name="pListLlamadaSoporte">A List of LlamadaSoporte</param>
public void Delete(IEnumerable<LlamadaSoporte> pListLlamadaSoporte)
{
if( pListLlamadaSoporte == null  ) throw new ArgumentNullException("pListLlamadaSoporte");
try 
{
...
foreach ( LlamadaSoporte _LlamadaSoporte in pListLlamadaSoporte ) 
{
Session.Delete(_LlamadaSoporte);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a LlamadaSoporte object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdLlamadaSoporte)
{
LlamadaSoporte _llamadaSoporte = Fetch(pIdLlamadaSoporte);
if ( _llamadaSoporte == null ) throw new Exception("Object not found , could not delete");
Delete(_llamadaSoporte);
...
/// </summary>
///<param name="pLlamadaSoporte">A BO of type LlamadaSoporte</param>
public LlamadaSoporte Dummy(LlamadaSoporte pLlamadaSoporte)
{
if( pLlamadaSoporte == null  ) throw new ArgumentNullException("pLlamadaSoporte");
return pLlamadaSoporte;
