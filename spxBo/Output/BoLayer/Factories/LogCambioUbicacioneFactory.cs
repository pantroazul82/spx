...
namespace BOLayer{
[DataObject]
public partial class LogCambioUbicacioneFactory
 {
...
/// <summary>
/// Create a new LogCambioUbicacione Factory .
/// </summary>
public  LogCambioUbicacioneFactory()
{
}

/// <summary>
/// Create a new LogCambioUbicacione Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  LogCambioUbicacioneFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type LogCambioUbicacione by using it's Primary Key values. This is the Primary method to retrieve a LogCambioUbicacione.
/// </summary>
public LogCambioUbicacione Fetch(System.Int32 pCodLog)
{
LogCambioUbicacione _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodLog" ,pCodLog ));
_bo = (LogCambioUbicacione) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type LogCambioUbicacioneinto the current session by using it's Primary Key values.
/// </summary>
public LogCambioUbicacione Get(System.Int32 pCodLog)
{
LogCambioUbicacione _bo = null ;
try 
{
_bo = Session.Get(typeof(LogCambioUbicacione), pCodLog) as LogCambioUbicacione;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of LogCambioUbicacioneCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public LogCambioUbicacioneCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object LogCambioUbicacione
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(LogCambioUbicacione),"LogCambioUbicacione"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for LogCambioUbicacione");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of LogCambioUbicacioneCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public LogCambioUbicacioneCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 LogCambioUbicacioneCollection _list = new LogCambioUbicacioneCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of LogCambioUbicacioneCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public LogCambioUbicacioneCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of LogCambioUbicacioneCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public LogCambioUbicacioneCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public LogCambioUbicacioneCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of LogCambioUbicacioneCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public LogCambioUbicacioneCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pLogCambioUbicacione">A BO of type LogCambioUbicacione</param>
public void ReAttach(LogCambioUbicacione pLogCambioUbicacione)
{
if( pLogCambioUbicacione == null  ) throw new ArgumentNullException("pLogCambioUbicacione");
try 
{
Session.Lock(pLogCambioUbicacione, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class LogCambioUbicacione it saves it (insert) to the DataBase
/// </summary>
///<param name="pLogCambioUbicacione">A BO of type LogCambioUbicacione</param>
public void Insert(LogCambioUbicacione pLogCambioUbicacione)
{
if( pLogCambioUbicacione == null  ) throw new ArgumentNullException("pLogCambioUbicacione");
try 
{
BeginTransaction(false);
Session.Save(pLogCambioUbicacione);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class LogCambioUbicacione it Inserts them into the DataBase
/// </summary>
///<param name="pListLogCambioUbicacione">A List of LogCambioUbicacione</param>
public void Insert(IEnumerable<LogCambioUbicacione> pListLogCambioUbicacione)
{
if( pListLogCambioUbicacione == null  ) throw new ArgumentNullException("pListLogCambioUbicacione");
try 
{
BeginTransaction(false);
foreach ( LogCambioUbicacione _LogCambioUbicacione in pListLogCambioUbicacione ) 
{
Session.Save(_LogCambioUbicacione);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pLogCambioUbicacione">A BO of type LogCambioUbicacione</param>
public void Save(LogCambioUbicacione pLogCambioUbicacione)
{
if( pLogCambioUbicacione == null  ) throw new ArgumentNullException("pLogCambioUbicacione");
try 
{
BeginTransaction(false);
Session.Update(pLogCambioUbicacione);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type LogCambioUbicacione
/// </summary>
///<param name="pLogCambioUbicacione">A BO of type LogCambioUbicacione</param>
public void Delete(LogCambioUbicacione pLogCambioUbicacione)
{
if( pLogCambioUbicacione == null  ) throw new ArgumentNullException("pLogCambioUbicacione");
try 
{
BeginTransaction(false);
Session.Delete(pLogCambioUbicacione);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type LogCambioUbicacione inside one transaction.
/// </summary>
///<param name="pListLogCambioUbicacione">A List of LogCambioUbicacione</param>
public void Delete(IEnumerable<LogCambioUbicacione> pListLogCambioUbicacione)
{
if( pListLogCambioUbicacione == null  ) throw new ArgumentNullException("pListLogCambioUbicacione");
try 
{
...
foreach ( LogCambioUbicacione _LogCambioUbicacione in pListLogCambioUbicacione ) 
{
Session.Delete(_LogCambioUbicacione);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a LogCambioUbicacione object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodLog)
{
LogCambioUbicacione _logCambioUbicacione = Fetch(pCodLog);
if ( _logCambioUbicacione == null ) throw new Exception("Object not found , could not delete");
Delete(_logCambioUbicacione);
...
/// </summary>
///<param name="pLogCambioUbicacione">A BO of type LogCambioUbicacione</param>
public LogCambioUbicacione Dummy(LogCambioUbicacione pLogCambioUbicacione)
{
if( pLogCambioUbicacione == null  ) throw new ArgumentNullException("pLogCambioUbicacione");
return pLogCambioUbicacione;
