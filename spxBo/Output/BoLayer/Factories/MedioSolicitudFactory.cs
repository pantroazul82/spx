...
namespace BOLayer{
[DataObject]
public partial class MedioSolicitudFactory
 {
...
/// <summary>
/// Create a new MedioSolicitud Factory .
/// </summary>
public  MedioSolicitudFactory()
{
}

/// <summary>
/// Create a new MedioSolicitud Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  MedioSolicitudFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type MedioSolicitud by using it's Primary Key values. This is the Primary method to retrieve a MedioSolicitud.
/// </summary>
public MedioSolicitud Fetch(System.Int32 pCodMedioSolicitud)
{
MedioSolicitud _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodMedioSolicitud" ,pCodMedioSolicitud ));
_bo = (MedioSolicitud) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type MedioSolicitudinto the current session by using it's Primary Key values.
/// </summary>
public MedioSolicitud Get(System.Int32 pCodMedioSolicitud)
{
MedioSolicitud _bo = null ;
try 
{
_bo = Session.Get(typeof(MedioSolicitud), pCodMedioSolicitud) as MedioSolicitud;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of MedioSolicitudCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public MedioSolicitudCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object MedioSolicitud
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(MedioSolicitud),"MedioSolicitud"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for MedioSolicitud");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of MedioSolicitudCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public MedioSolicitudCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 MedioSolicitudCollection _list = new MedioSolicitudCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of MedioSolicitudCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public MedioSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of MedioSolicitudCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public MedioSolicitudCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public MedioSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of MedioSolicitudCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public MedioSolicitudCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pMedioSolicitud">A BO of type MedioSolicitud</param>
public void ReAttach(MedioSolicitud pMedioSolicitud)
{
if( pMedioSolicitud == null  ) throw new ArgumentNullException("pMedioSolicitud");
try 
{
Session.Lock(pMedioSolicitud, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class MedioSolicitud it saves it (insert) to the DataBase
/// </summary>
///<param name="pMedioSolicitud">A BO of type MedioSolicitud</param>
public void Insert(MedioSolicitud pMedioSolicitud)
{
if( pMedioSolicitud == null  ) throw new ArgumentNullException("pMedioSolicitud");
try 
{
BeginTransaction(false);
Session.Save(pMedioSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class MedioSolicitud it Inserts them into the DataBase
/// </summary>
///<param name="pListMedioSolicitud">A List of MedioSolicitud</param>
public void Insert(IEnumerable<MedioSolicitud> pListMedioSolicitud)
{
if( pListMedioSolicitud == null  ) throw new ArgumentNullException("pListMedioSolicitud");
try 
{
BeginTransaction(false);
foreach ( MedioSolicitud _MedioSolicitud in pListMedioSolicitud ) 
{
Session.Save(_MedioSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pMedioSolicitud">A BO of type MedioSolicitud</param>
public void Save(MedioSolicitud pMedioSolicitud)
{
if( pMedioSolicitud == null  ) throw new ArgumentNullException("pMedioSolicitud");
try 
{
BeginTransaction(false);
Session.Update(pMedioSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type MedioSolicitud
/// </summary>
///<param name="pMedioSolicitud">A BO of type MedioSolicitud</param>
public void Delete(MedioSolicitud pMedioSolicitud)
{
if( pMedioSolicitud == null  ) throw new ArgumentNullException("pMedioSolicitud");
try 
{
BeginTransaction(false);
Session.Delete(pMedioSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type MedioSolicitud inside one transaction.
/// </summary>
///<param name="pListMedioSolicitud">A List of MedioSolicitud</param>
public void Delete(IEnumerable<MedioSolicitud> pListMedioSolicitud)
{
if( pListMedioSolicitud == null  ) throw new ArgumentNullException("pListMedioSolicitud");
try 
{
...
foreach ( MedioSolicitud _MedioSolicitud in pListMedioSolicitud ) 
{
Session.Delete(_MedioSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a MedioSolicitud object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodMedioSolicitud)
{
MedioSolicitud _medioSolicitud = Fetch(pCodMedioSolicitud);
if ( _medioSolicitud == null ) throw new Exception("Object not found , could not delete");
Delete(_medioSolicitud);
...
/// </summary>
///<param name="pMedioSolicitud">A BO of type MedioSolicitud</param>
public MedioSolicitud Dummy(MedioSolicitud pMedioSolicitud)
{
if( pMedioSolicitud == null  ) throw new ArgumentNullException("pMedioSolicitud");
return pMedioSolicitud;
