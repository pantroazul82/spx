...
namespace BOLayer{
[DataObject]
public partial class ModalidadContratoFactory
 {
...
/// <summary>
/// Create a new ModalidadContrato Factory .
/// </summary>
public  ModalidadContratoFactory()
{
}

/// <summary>
/// Create a new ModalidadContrato Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModalidadContratoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ModalidadContrato by using it's Primary Key values. This is the Primary method to retrieve a ModalidadContrato.
/// </summary>
public ModalidadContrato Fetch(System.String pCodModalidadContrato , System.String pCodTipoContrato)
{
if ( String.IsNullOrEmpty(pCodModalidadContrato)) throw new ArgumentException("Argument Name:pCodModalidadContrato. Primary Key Column must have a value (different from null or empty)");
pCodModalidadContrato = pCodModalidadContrato.PadRight(5,' ') ;
if ( String.IsNullOrEmpty(pCodTipoContrato)) throw new ArgumentException("Argument Name:pCodTipoContrato. Primary Key Column must have a value (different from null or empty)");
pCodTipoContrato = pCodTipoContrato.PadRight(5,' ') ;
ModalidadContrato _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodModalidadContrato" ,pCodModalidadContrato ));
_criteria.Add(Restrictions.Eq("CodTipoContrato" ,pCodTipoContrato ));
_bo = (ModalidadContrato) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type ModalidadContrato by using it's Primary Key values. This is the Primary method to retrieve a ModalidadContrato.
/// </summary>
public ModalidadContrato FetchVirtual(string pVirtualKey)
{
...
System.String _codModalidadContrato = _keys[0];
System.String _codTipoContrato = _keys[1];
return Fetch(_codModalidadContrato,_codTipoContrato);
...
/// <summary>
/// Get strongly typed collection of ModalidadContratoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModalidadContratoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ModalidadContrato
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ModalidadContrato),"ModalidadContrato"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ModalidadContrato");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModalidadContratoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModalidadContratoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModalidadContratoCollection _list = new ModalidadContratoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModalidadContratoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModalidadContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModalidadContratoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModalidadContratoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModalidadContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModalidadContratoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModalidadContratoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModalidadContrato">A BO of type ModalidadContrato</param>
public void ReAttach(ModalidadContrato pModalidadContrato)
{
if( pModalidadContrato == null  ) throw new ArgumentNullException("pModalidadContrato");
try 
{
Session.Lock(pModalidadContrato, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ModalidadContrato it saves it (insert) to the DataBase
/// </summary>
///<param name="pModalidadContrato">A BO of type ModalidadContrato</param>
public void Insert(ModalidadContrato pModalidadContrato)
{
if( pModalidadContrato == null  ) throw new ArgumentNullException("pModalidadContrato");
try 
{
BeginTransaction(false);
Session.Save(pModalidadContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ModalidadContrato it Inserts them into the DataBase
/// </summary>
///<param name="pListModalidadContrato">A List of ModalidadContrato</param>
public void Insert(IEnumerable<ModalidadContrato> pListModalidadContrato)
{
if( pListModalidadContrato == null  ) throw new ArgumentNullException("pListModalidadContrato");
try 
{
BeginTransaction(false);
foreach ( ModalidadContrato _ModalidadContrato in pListModalidadContrato ) 
{
Session.Save(_ModalidadContrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModalidadContrato">A BO of type ModalidadContrato</param>
public void Save(ModalidadContrato pModalidadContrato)
{
if( pModalidadContrato == null  ) throw new ArgumentNullException("pModalidadContrato");
try 
{
BeginTransaction(false);
Session.Update(pModalidadContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ModalidadContrato
/// </summary>
///<param name="pModalidadContrato">A BO of type ModalidadContrato</param>
public void Delete(ModalidadContrato pModalidadContrato)
{
if( pModalidadContrato == null  ) throw new ArgumentNullException("pModalidadContrato");
try 
{
BeginTransaction(false);
Session.Delete(pModalidadContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ModalidadContrato inside one transaction.
/// </summary>
///<param name="pListModalidadContrato">A List of ModalidadContrato</param>
public void Delete(IEnumerable<ModalidadContrato> pListModalidadContrato)
{
if( pListModalidadContrato == null  ) throw new ArgumentNullException("pListModalidadContrato");
try 
{
...
foreach ( ModalidadContrato _ModalidadContrato in pListModalidadContrato ) 
{
Session.Delete(_ModalidadContrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ModalidadContrato object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodModalidadContrato , System.String pCodTipoContrato)
{
ModalidadContrato _modalidadContrato = Fetch(pCodModalidadContrato , pCodTipoContrato);
if ( _modalidadContrato == null ) throw new Exception("Object not found , could not delete");
Delete(_modalidadContrato);
...
/// </summary>
///<param name="pModalidadContrato">A BO of type ModalidadContrato</param>
public ModalidadContrato Dummy(ModalidadContrato pModalidadContrato)
{
if( pModalidadContrato == null  ) throw new ArgumentNullException("pModalidadContrato");
return pModalidadContrato;
