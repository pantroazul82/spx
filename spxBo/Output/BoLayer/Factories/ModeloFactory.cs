...
namespace BOLayer{
[DataObject]
public partial class ModeloFactory
 {
...
/// <summary>
/// Create a new Modelo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModeloFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Modelo by using it's Primary Key values. This is the Primary method to retrieve a Modelo.
/// </summary>
public Modelo Fetch(System.String pCodFabricante , System.String pCodModelo)
{
...
_bo = (Modelo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type Modelo by using it's Primary Key values. This is the Primary method to retrieve a Modelo.
/// </summary>
public Modelo FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codFabricante,_codModelo);
...
/// <summary>
/// Get strongly typed collection of ModeloCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModeloCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Modelo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Modelo),"Modelo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Modelo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModeloCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModeloCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModeloCollection _list = new ModeloCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModeloCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModeloCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModeloCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModeloCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModeloCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModeloCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModeloCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModelo">A BO of type Modelo</param>
public void ReAttach(Modelo pModelo)
{
if( pModelo == null  ) throw new ArgumentNullException("pModelo");
try 
{
Session.Lock(pModelo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Modelo it saves it (insert) to the DataBase
/// </summary>
///<param name="pModelo">A BO of type Modelo</param>
public void Insert(Modelo pModelo)
{
if( pModelo == null  ) throw new ArgumentNullException("pModelo");
try 
{
BeginTransaction(false);
Session.Save(pModelo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Modelo it Inserts them into the DataBase
/// </summary>
///<param name="pListModelo">A List of Modelo</param>
public void Insert(IEnumerable<Modelo> pListModelo)
{
if( pListModelo == null  ) throw new ArgumentNullException("pListModelo");
try 
{
BeginTransaction(false);
foreach ( Modelo _Modelo in pListModelo ) 
{
Session.Save(_Modelo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModelo">A BO of type Modelo</param>
public void Save(Modelo pModelo)
{
if( pModelo == null  ) throw new ArgumentNullException("pModelo");
try 
{
BeginTransaction(false);
Session.Update(pModelo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Modelo
/// </summary>
///<param name="pModelo">A BO of type Modelo</param>
public void Delete(Modelo pModelo)
{
if( pModelo == null  ) throw new ArgumentNullException("pModelo");
try 
{
...
/// <summary>
/// Deletes multiple objects of Type Modelo inside one transaction.
/// </summary>
///<param name="pListModelo">A List of Modelo</param>
public void Delete(IEnumerable<Modelo> pListModelo)
{
if( pListModelo == null  ) throw new ArgumentNullException("pListModelo");
try 
{
...
/// <summary>
/// Delete a Modelo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodFabricante , System.String pCodModelo)
{
Modelo _modelo = Fetch(pCodFabricante , pCodModelo);
if ( _modelo == null ) throw new Exception("Object not found , could not delete");
Delete(_modelo);
...
/// </summary>
///<param name="pModelo">A BO of type Modelo</param>
public Modelo Dummy(Modelo pModelo)
{
if( pModelo == null  ) throw new ArgumentNullException("pModelo");
return pModelo;
