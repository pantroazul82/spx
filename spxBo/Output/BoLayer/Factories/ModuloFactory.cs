...
namespace BOLayer{
[DataObject]
public partial class ModuloFactory
 {
...
/// <summary>
/// Create a new Modulo Factory .
/// </summary>
public  ModuloFactory()
{
}

/// <summary>
/// Create a new Modulo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModuloFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Modulo by using it's Primary Key values. This is the Primary method to retrieve a Modulo.
/// </summary>
public Modulo Fetch(System.String pCodModulo)
{
...
_bo = (Modulo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Modulointo the current session by using it's Primary Key values.
/// </summary>
public Modulo Get(System.String pCodModulo)
{
if ( String.IsNullOrEmpty(pCodModulo)) throw new ArgumentException("Argument Name:pCodModulo. Primary Key Column must have a value (different from null or empty)");
pCodModulo = pCodModulo.PadRight(10,' ') ;
Modulo _bo = null ;
try 
{
_bo = Session.Get(typeof(Modulo), pCodModulo) as Modulo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ModuloCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModuloCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Modulo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Modulo),"Modulo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Modulo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModuloCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModuloCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModuloCollection _list = new ModuloCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModuloCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModuloCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModuloCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModuloCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModuloCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModulo">A BO of type Modulo</param>
public void ReAttach(Modulo pModulo)
{
if( pModulo == null  ) throw new ArgumentNullException("pModulo");
try 
{
Session.Lock(pModulo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Modulo it saves it (insert) to the DataBase
/// </summary>
///<param name="pModulo">A BO of type Modulo</param>
public void Insert(Modulo pModulo)
{
if( pModulo == null  ) throw new ArgumentNullException("pModulo");
try 
{
BeginTransaction(false);
Session.Save(pModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Modulo it Inserts them into the DataBase
/// </summary>
///<param name="pListModulo">A List of Modulo</param>
public void Insert(IEnumerable<Modulo> pListModulo)
{
if( pListModulo == null  ) throw new ArgumentNullException("pListModulo");
try 
{
BeginTransaction(false);
foreach ( Modulo _Modulo in pListModulo ) 
{
Session.Save(_Modulo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModulo">A BO of type Modulo</param>
public void Save(Modulo pModulo)
{
if( pModulo == null  ) throw new ArgumentNullException("pModulo");
try 
{
BeginTransaction(false);
Session.Update(pModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Modulo
/// </summary>
///<param name="pModulo">A BO of type Modulo</param>
public void Delete(Modulo pModulo)
{
if( pModulo == null  ) throw new ArgumentNullException("pModulo");
try 
{
BeginTransaction(false);
Session.Delete(pModulo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Modulo inside one transaction.
/// </summary>
///<param name="pListModulo">A List of Modulo</param>
public void Delete(IEnumerable<Modulo> pListModulo)
{
if( pListModulo == null  ) throw new ArgumentNullException("pListModulo");
try 
{
...
/// <summary>
/// Delete a Modulo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodModulo)
{
Modulo _modulo = Fetch(pCodModulo);
if ( _modulo == null ) throw new Exception("Object not found , could not delete");
Delete(_modulo);
...
/// </summary>
///<param name="pModulo">A BO of type Modulo</param>
public Modulo Dummy(Modulo pModulo)
{
if( pModulo == null  ) throw new ArgumentNullException("pModulo");
return pModulo;
