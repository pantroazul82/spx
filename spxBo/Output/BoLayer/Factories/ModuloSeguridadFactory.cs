...
namespace BOLayer{
[DataObject]
public partial class ModuloSeguridadFactory
 {
...
/// <summary>
/// Create a new ModuloSeguridad Factory .
/// </summary>
public  ModuloSeguridadFactory()
{
}

/// <summary>
/// Create a new ModuloSeguridad Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModuloSeguridadFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ModuloSeguridad by using it's Primary Key values. This is the Primary method to retrieve a ModuloSeguridad.
/// </summary>
public ModuloSeguridad Fetch(System.Int32 pCodModuloSeguridad)
{
ModuloSeguridad _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodModuloSeguridad" ,pCodModuloSeguridad ));
_bo = (ModuloSeguridad) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type ModuloSeguridadinto the current session by using it's Primary Key values.
/// </summary>
public ModuloSeguridad Get(System.Int32 pCodModuloSeguridad)
{
ModuloSeguridad _bo = null ;
try 
{
_bo = Session.Get(typeof(ModuloSeguridad), pCodModuloSeguridad) as ModuloSeguridad;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ModuloSeguridadCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModuloSeguridadCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ModuloSeguridad
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ModuloSeguridad),"ModuloSeguridad"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ModuloSeguridad");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModuloSeguridadCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModuloSeguridadCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModuloSeguridadCollection _list = new ModuloSeguridadCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModuloSeguridadCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModuloSeguridadCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModuloSeguridadCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModuloSeguridadCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloSeguridadCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModuloSeguridadCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloSeguridadCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModuloSeguridad">A BO of type ModuloSeguridad</param>
public void ReAttach(ModuloSeguridad pModuloSeguridad)
{
if( pModuloSeguridad == null  ) throw new ArgumentNullException("pModuloSeguridad");
try 
{
Session.Lock(pModuloSeguridad, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ModuloSeguridad it saves it (insert) to the DataBase
/// </summary>
///<param name="pModuloSeguridad">A BO of type ModuloSeguridad</param>
public void Insert(ModuloSeguridad pModuloSeguridad)
{
if( pModuloSeguridad == null  ) throw new ArgumentNullException("pModuloSeguridad");
try 
{
BeginTransaction(false);
Session.Save(pModuloSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ModuloSeguridad it Inserts them into the DataBase
/// </summary>
///<param name="pListModuloSeguridad">A List of ModuloSeguridad</param>
public void Insert(IEnumerable<ModuloSeguridad> pListModuloSeguridad)
{
if( pListModuloSeguridad == null  ) throw new ArgumentNullException("pListModuloSeguridad");
try 
{
BeginTransaction(false);
foreach ( ModuloSeguridad _ModuloSeguridad in pListModuloSeguridad ) 
{
Session.Save(_ModuloSeguridad);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModuloSeguridad">A BO of type ModuloSeguridad</param>
public void Save(ModuloSeguridad pModuloSeguridad)
{
if( pModuloSeguridad == null  ) throw new ArgumentNullException("pModuloSeguridad");
try 
{
BeginTransaction(false);
Session.Update(pModuloSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ModuloSeguridad
/// </summary>
///<param name="pModuloSeguridad">A BO of type ModuloSeguridad</param>
public void Delete(ModuloSeguridad pModuloSeguridad)
{
if( pModuloSeguridad == null  ) throw new ArgumentNullException("pModuloSeguridad");
try 
{
BeginTransaction(false);
Session.Delete(pModuloSeguridad);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ModuloSeguridad inside one transaction.
/// </summary>
///<param name="pListModuloSeguridad">A List of ModuloSeguridad</param>
public void Delete(IEnumerable<ModuloSeguridad> pListModuloSeguridad)
{
if( pListModuloSeguridad == null  ) throw new ArgumentNullException("pListModuloSeguridad");
try 
{
...
foreach ( ModuloSeguridad _ModuloSeguridad in pListModuloSeguridad ) 
{
Session.Delete(_ModuloSeguridad);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ModuloSeguridad object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodModuloSeguridad)
{
ModuloSeguridad _moduloSeguridad = Fetch(pCodModuloSeguridad);
if ( _moduloSeguridad == null ) throw new Exception("Object not found , could not delete");
Delete(_moduloSeguridad);
...
/// </summary>
///<param name="pModuloSeguridad">A BO of type ModuloSeguridad</param>
public ModuloSeguridad Dummy(ModuloSeguridad pModuloSeguridad)
{
if( pModuloSeguridad == null  ) throw new ArgumentNullException("pModuloSeguridad");
return pModuloSeguridad;
