...
namespace BOLayer{
[DataObject]
public partial class ModuloSeguridad_grupoUsuarioFactory
 {
...
/// <summary>
/// Create a new ModuloSeguridad_grupoUsuario Factory .
/// </summary>
public  ModuloSeguridad_grupoUsuarioFactory()
{
}

/// <summary>
/// Create a new ModuloSeguridad_grupoUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModuloSeguridad_grupoUsuarioFactory(SessionScope pSessionScope)
{
...
/// </summary>
~ModuloSeguridad_grupoUsuarioFactory()
{
...
/// <summary>
/// Fetch an object of type ModuloSeguridad_grupoUsuario by using it's Primary Key values. This is the Primary method to retrieve a ModuloSeguridad_grupoUsuario.
/// </summary>
public ModuloSeguridad_grupoUsuario Fetch(System.Int32 pCodModuloSeguridad_grupoUsuario)
{
ModuloSeguridad_grupoUsuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodModuloSeguridad_grupoUsuario" ,pCodModuloSeguridad_grupoUsuario ));
_bo = (ModuloSeguridad_grupoUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type ModuloSeguridad_grupoUsuariointo the current session by using it's Primary Key values.
/// </summary>
public ModuloSeguridad_grupoUsuario Get(System.Int32 pCodModuloSeguridad_grupoUsuario)
{
ModuloSeguridad_grupoUsuario _bo = null ;
try 
{
_bo = Session.Get(typeof(ModuloSeguridad_grupoUsuario), pCodModuloSeguridad_grupoUsuario) as ModuloSeguridad_grupoUsuario;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ModuloSeguridad_grupoUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModuloSeguridad_grupoUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ModuloSeguridad_grupoUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ModuloSeguridad_grupoUsuario),"ModuloSeguridad_grupoUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ModuloSeguridad_grupoUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModuloSeguridad_grupoUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModuloSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModuloSeguridad_grupoUsuarioCollection _list = new ModuloSeguridad_grupoUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModuloSeguridad_grupoUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModuloSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModuloSeguridad_grupoUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModuloSeguridad_grupoUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModuloSeguridad_grupoUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModuloSeguridad_grupoUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModuloSeguridad_grupoUsuario">A BO of type ModuloSeguridad_grupoUsuario</param>
public void ReAttach(ModuloSeguridad_grupoUsuario pModuloSeguridad_grupoUsuario)
{
if( pModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pModuloSeguridad_grupoUsuario");
try 
{
Session.Lock(pModuloSeguridad_grupoUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ModuloSeguridad_grupoUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pModuloSeguridad_grupoUsuario">A BO of type ModuloSeguridad_grupoUsuario</param>
public void Insert(ModuloSeguridad_grupoUsuario pModuloSeguridad_grupoUsuario)
{
if( pModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pModuloSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Save(pModuloSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ModuloSeguridad_grupoUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListModuloSeguridad_grupoUsuario">A List of ModuloSeguridad_grupoUsuario</param>
public void Insert(IEnumerable<ModuloSeguridad_grupoUsuario> pListModuloSeguridad_grupoUsuario)
{
if( pListModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pListModuloSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
foreach ( ModuloSeguridad_grupoUsuario _ModuloSeguridad_grupoUsuario in pListModuloSeguridad_grupoUsuario ) 
{
Session.Save(_ModuloSeguridad_grupoUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModuloSeguridad_grupoUsuario">A BO of type ModuloSeguridad_grupoUsuario</param>
public void Save(ModuloSeguridad_grupoUsuario pModuloSeguridad_grupoUsuario)
{
if( pModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pModuloSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Update(pModuloSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ModuloSeguridad_grupoUsuario
/// </summary>
///<param name="pModuloSeguridad_grupoUsuario">A BO of type ModuloSeguridad_grupoUsuario</param>
public void Delete(ModuloSeguridad_grupoUsuario pModuloSeguridad_grupoUsuario)
{
if( pModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pModuloSeguridad_grupoUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pModuloSeguridad_grupoUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ModuloSeguridad_grupoUsuario inside one transaction.
/// </summary>
///<param name="pListModuloSeguridad_grupoUsuario">A List of ModuloSeguridad_grupoUsuario</param>
public void Delete(IEnumerable<ModuloSeguridad_grupoUsuario> pListModuloSeguridad_grupoUsuario)
{
if( pListModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pListModuloSeguridad_grupoUsuario");
try 
{
...
foreach ( ModuloSeguridad_grupoUsuario _ModuloSeguridad_grupoUsuario in pListModuloSeguridad_grupoUsuario ) 
{
Session.Delete(_ModuloSeguridad_grupoUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ModuloSeguridad_grupoUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodModuloSeguridad_grupoUsuario)
{
ModuloSeguridad_grupoUsuario _moduloSeguridad_grupoUsuario = Fetch(pCodModuloSeguridad_grupoUsuario);
if ( _moduloSeguridad_grupoUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_moduloSeguridad_grupoUsuario);
...
/// </summary>
///<param name="pModuloSeguridad_grupoUsuario">A BO of type ModuloSeguridad_grupoUsuario</param>
public ModuloSeguridad_grupoUsuario Dummy(ModuloSeguridad_grupoUsuario pModuloSeguridad_grupoUsuario)
{
if( pModuloSeguridad_grupoUsuario == null  ) throw new ArgumentNullException("pModuloSeguridad_grupoUsuario");
return pModuloSeguridad_grupoUsuario;
