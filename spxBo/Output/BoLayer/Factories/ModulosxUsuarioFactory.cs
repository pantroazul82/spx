...
namespace BOLayer{
[DataObject]
public partial class ModulosxUsuarioFactory
 {
...
/// <summary>
/// Create a new ModulosxUsuario Factory .
/// </summary>
public  ModulosxUsuarioFactory()
{
}

/// <summary>
/// Create a new ModulosxUsuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ModulosxUsuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ModulosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a ModulosxUsuario.
/// </summary>
public ModulosxUsuario Fetch(System.String pCodModulo , System.String pLogin)
{
...
_bo = (ModulosxUsuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type ModulosxUsuario by using it's Primary Key values. This is the Primary method to retrieve a ModulosxUsuario.
/// </summary>
public ModulosxUsuario FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codModulo,_login);
...
/// <summary>
/// Get strongly typed collection of ModulosxUsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ModulosxUsuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ModulosxUsuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ModulosxUsuario),"ModulosxUsuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ModulosxUsuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ModulosxUsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ModulosxUsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ModulosxUsuarioCollection _list = new ModulosxUsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ModulosxUsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ModulosxUsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ModulosxUsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ModulosxUsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ModulosxUsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pModulosxUsuario">A BO of type ModulosxUsuario</param>
public void ReAttach(ModulosxUsuario pModulosxUsuario)
{
if( pModulosxUsuario == null  ) throw new ArgumentNullException("pModulosxUsuario");
try 
{
Session.Lock(pModulosxUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ModulosxUsuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pModulosxUsuario">A BO of type ModulosxUsuario</param>
public void Insert(ModulosxUsuario pModulosxUsuario)
{
if( pModulosxUsuario == null  ) throw new ArgumentNullException("pModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Save(pModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ModulosxUsuario it Inserts them into the DataBase
/// </summary>
///<param name="pListModulosxUsuario">A List of ModulosxUsuario</param>
public void Insert(IEnumerable<ModulosxUsuario> pListModulosxUsuario)
{
if( pListModulosxUsuario == null  ) throw new ArgumentNullException("pListModulosxUsuario");
try 
{
BeginTransaction(false);
foreach ( ModulosxUsuario _ModulosxUsuario in pListModulosxUsuario ) 
{
Session.Save(_ModulosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pModulosxUsuario">A BO of type ModulosxUsuario</param>
public void Save(ModulosxUsuario pModulosxUsuario)
{
if( pModulosxUsuario == null  ) throw new ArgumentNullException("pModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Update(pModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ModulosxUsuario
/// </summary>
///<param name="pModulosxUsuario">A BO of type ModulosxUsuario</param>
public void Delete(ModulosxUsuario pModulosxUsuario)
{
if( pModulosxUsuario == null  ) throw new ArgumentNullException("pModulosxUsuario");
try 
{
BeginTransaction(false);
Session.Delete(pModulosxUsuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ModulosxUsuario inside one transaction.
/// </summary>
///<param name="pListModulosxUsuario">A List of ModulosxUsuario</param>
public void Delete(IEnumerable<ModulosxUsuario> pListModulosxUsuario)
{
if( pListModulosxUsuario == null  ) throw new ArgumentNullException("pListModulosxUsuario");
try 
{
...
foreach ( ModulosxUsuario _ModulosxUsuario in pListModulosxUsuario ) 
{
Session.Delete(_ModulosxUsuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ModulosxUsuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodModulo , System.String pLogin)
{
ModulosxUsuario _modulosxUsuario = Fetch(pCodModulo , pLogin);
if ( _modulosxUsuario == null ) throw new Exception("Object not found , could not delete");
Delete(_modulosxUsuario);
...
/// </summary>
///<param name="pModulosxUsuario">A BO of type ModulosxUsuario</param>
public ModulosxUsuario Dummy(ModulosxUsuario pModulosxUsuario)
{
if( pModulosxUsuario == null  ) throw new ArgumentNullException("pModulosxUsuario");
return pModulosxUsuario;
