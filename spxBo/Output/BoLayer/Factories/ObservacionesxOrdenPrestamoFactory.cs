...
namespace BOLayer{
[DataObject]
public partial class ObservacionesxOrdenPrestamoFactory
 {
...
/// <summary>
/// Create a new ObservacionesxOrdenPrestamo Factory .
/// </summary>
public  ObservacionesxOrdenPrestamoFactory()
{
}

/// <summary>
/// Create a new ObservacionesxOrdenPrestamo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ObservacionesxOrdenPrestamoFactory(SessionScope pSessionScope)
{
...
/// </summary>
~ObservacionesxOrdenPrestamoFactory()
{
...
/// <summary>
/// Fetch an object of type ObservacionesxOrdenPrestamo by using it's Primary Key values. This is the Primary method to retrieve a ObservacionesxOrdenPrestamo.
/// </summary>
public ObservacionesxOrdenPrestamo Fetch(System.Int32 pCodOrdenPrestamo , System.Int32 pIdObservacion)
{
ObservacionesxOrdenPrestamo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodOrdenPrestamo" ,pCodOrdenPrestamo ));
_criteria.Add(Restrictions.Eq("IdObservacion" ,pIdObservacion ));
_bo = (ObservacionesxOrdenPrestamo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type ObservacionesxOrdenPrestamo by using it's Primary Key values. This is the Primary method to retrieve a ObservacionesxOrdenPrestamo.
/// </summary>
public ObservacionesxOrdenPrestamo FetchVirtual(string pVirtualKey)
{
...
System.Int32 _idObservacion = System.Int32.Parse(_keys[1]);
return Fetch(_codOrdenPrestamo,_idObservacion);
...
/// <summary>
/// Get strongly typed collection of ObservacionesxOrdenPrestamoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ObservacionesxOrdenPrestamoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ObservacionesxOrdenPrestamo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ObservacionesxOrdenPrestamo),"ObservacionesxOrdenPrestamo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ObservacionesxOrdenPrestamo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ObservacionesxOrdenPrestamoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ObservacionesxOrdenPrestamoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ObservacionesxOrdenPrestamoCollection _list = new ObservacionesxOrdenPrestamoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ObservacionesxOrdenPrestamoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ObservacionesxOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ObservacionesxOrdenPrestamoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ObservacionesxOrdenPrestamoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ObservacionesxOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ObservacionesxOrdenPrestamoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ObservacionesxOrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pObservacionesxOrdenPrestamo">A BO of type ObservacionesxOrdenPrestamo</param>
public void ReAttach(ObservacionesxOrdenPrestamo pObservacionesxOrdenPrestamo)
{
if( pObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pObservacionesxOrdenPrestamo");
try 
{
Session.Lock(pObservacionesxOrdenPrestamo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ObservacionesxOrdenPrestamo it saves it (insert) to the DataBase
/// </summary>
///<param name="pObservacionesxOrdenPrestamo">A BO of type ObservacionesxOrdenPrestamo</param>
public void Insert(ObservacionesxOrdenPrestamo pObservacionesxOrdenPrestamo)
{
if( pObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pObservacionesxOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Save(pObservacionesxOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ObservacionesxOrdenPrestamo it Inserts them into the DataBase
/// </summary>
///<param name="pListObservacionesxOrdenPrestamo">A List of ObservacionesxOrdenPrestamo</param>
public void Insert(IEnumerable<ObservacionesxOrdenPrestamo> pListObservacionesxOrdenPrestamo)
{
if( pListObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pListObservacionesxOrdenPrestamo");
try 
{
BeginTransaction(false);
foreach ( ObservacionesxOrdenPrestamo _ObservacionesxOrdenPrestamo in pListObservacionesxOrdenPrestamo ) 
{
Session.Save(_ObservacionesxOrdenPrestamo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pObservacionesxOrdenPrestamo">A BO of type ObservacionesxOrdenPrestamo</param>
public void Save(ObservacionesxOrdenPrestamo pObservacionesxOrdenPrestamo)
{
if( pObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pObservacionesxOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Update(pObservacionesxOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ObservacionesxOrdenPrestamo
/// </summary>
///<param name="pObservacionesxOrdenPrestamo">A BO of type ObservacionesxOrdenPrestamo</param>
public void Delete(ObservacionesxOrdenPrestamo pObservacionesxOrdenPrestamo)
{
if( pObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pObservacionesxOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Delete(pObservacionesxOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ObservacionesxOrdenPrestamo inside one transaction.
/// </summary>
///<param name="pListObservacionesxOrdenPrestamo">A List of ObservacionesxOrdenPrestamo</param>
public void Delete(IEnumerable<ObservacionesxOrdenPrestamo> pListObservacionesxOrdenPrestamo)
{
if( pListObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pListObservacionesxOrdenPrestamo");
try 
{
...
foreach ( ObservacionesxOrdenPrestamo _ObservacionesxOrdenPrestamo in pListObservacionesxOrdenPrestamo ) 
{
Session.Delete(_ObservacionesxOrdenPrestamo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ObservacionesxOrdenPrestamo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenPrestamo , System.Int32 pIdObservacion)
{
ObservacionesxOrdenPrestamo _observacionesxOrdenPrestamo = Fetch(pCodOrdenPrestamo , pIdObservacion);
if ( _observacionesxOrdenPrestamo == null ) throw new Exception("Object not found , could not delete");
Delete(_observacionesxOrdenPrestamo);
...
/// </summary>
///<param name="pObservacionesxOrdenPrestamo">A BO of type ObservacionesxOrdenPrestamo</param>
public ObservacionesxOrdenPrestamo Dummy(ObservacionesxOrdenPrestamo pObservacionesxOrdenPrestamo)
{
if( pObservacionesxOrdenPrestamo == null  ) throw new ArgumentNullException("pObservacionesxOrdenPrestamo");
return pObservacionesxOrdenPrestamo;
