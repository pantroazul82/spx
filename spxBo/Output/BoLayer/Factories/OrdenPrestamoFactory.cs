...
namespace BOLayer{
[DataObject]
public partial class OrdenPrestamoFactory
 {
...
/// <summary>
/// Create a new OrdenPrestamo Factory .
/// </summary>
public  OrdenPrestamoFactory()
{
}

/// <summary>
/// Create a new OrdenPrestamo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  OrdenPrestamoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type OrdenPrestamo by using it's Primary Key values. This is the Primary method to retrieve a OrdenPrestamo.
/// </summary>
public OrdenPrestamo Fetch(System.Int32 pCodOrdenPrestamo)
{
OrdenPrestamo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodOrdenPrestamo" ,pCodOrdenPrestamo ));
_bo = (OrdenPrestamo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type OrdenPrestamointo the current session by using it's Primary Key values.
/// </summary>
public OrdenPrestamo Get(System.Int32 pCodOrdenPrestamo)
{
OrdenPrestamo _bo = null ;
try 
{
_bo = Session.Get(typeof(OrdenPrestamo), pCodOrdenPrestamo) as OrdenPrestamo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of OrdenPrestamoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public OrdenPrestamoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object OrdenPrestamo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(OrdenPrestamo),"OrdenPrestamo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for OrdenPrestamo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of OrdenPrestamoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public OrdenPrestamoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 OrdenPrestamoCollection _list = new OrdenPrestamoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of OrdenPrestamoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public OrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of OrdenPrestamoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public OrdenPrestamoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public OrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of OrdenPrestamoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public OrdenPrestamoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pOrdenPrestamo">A BO of type OrdenPrestamo</param>
public void ReAttach(OrdenPrestamo pOrdenPrestamo)
{
if( pOrdenPrestamo == null  ) throw new ArgumentNullException("pOrdenPrestamo");
try 
{
Session.Lock(pOrdenPrestamo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class OrdenPrestamo it saves it (insert) to the DataBase
/// </summary>
///<param name="pOrdenPrestamo">A BO of type OrdenPrestamo</param>
public void Insert(OrdenPrestamo pOrdenPrestamo)
{
if( pOrdenPrestamo == null  ) throw new ArgumentNullException("pOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Save(pOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class OrdenPrestamo it Inserts them into the DataBase
/// </summary>
///<param name="pListOrdenPrestamo">A List of OrdenPrestamo</param>
public void Insert(IEnumerable<OrdenPrestamo> pListOrdenPrestamo)
{
if( pListOrdenPrestamo == null  ) throw new ArgumentNullException("pListOrdenPrestamo");
try 
{
BeginTransaction(false);
foreach ( OrdenPrestamo _OrdenPrestamo in pListOrdenPrestamo ) 
{
Session.Save(_OrdenPrestamo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pOrdenPrestamo">A BO of type OrdenPrestamo</param>
public void Save(OrdenPrestamo pOrdenPrestamo)
{
if( pOrdenPrestamo == null  ) throw new ArgumentNullException("pOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Update(pOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type OrdenPrestamo
/// </summary>
///<param name="pOrdenPrestamo">A BO of type OrdenPrestamo</param>
public void Delete(OrdenPrestamo pOrdenPrestamo)
{
if( pOrdenPrestamo == null  ) throw new ArgumentNullException("pOrdenPrestamo");
try 
{
BeginTransaction(false);
Session.Delete(pOrdenPrestamo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type OrdenPrestamo inside one transaction.
/// </summary>
///<param name="pListOrdenPrestamo">A List of OrdenPrestamo</param>
public void Delete(IEnumerable<OrdenPrestamo> pListOrdenPrestamo)
{
if( pListOrdenPrestamo == null  ) throw new ArgumentNullException("pListOrdenPrestamo");
try 
{
...
/// <summary>
/// Delete a OrdenPrestamo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenPrestamo)
{
OrdenPrestamo _ordenPrestamo = Fetch(pCodOrdenPrestamo);
if ( _ordenPrestamo == null ) throw new Exception("Object not found , could not delete");
Delete(_ordenPrestamo);
...
/// </summary>
///<param name="pOrdenPrestamo">A BO of type OrdenPrestamo</param>
public OrdenPrestamo Dummy(OrdenPrestamo pOrdenPrestamo)
{
if( pOrdenPrestamo == null  ) throw new ArgumentNullException("pOrdenPrestamo");
return pOrdenPrestamo;
