...
namespace BOLayer{
[DataObject]
public partial class OrdenServicioFactory
 {
...
/// <summary>
/// Create a new OrdenServicio Factory .
/// </summary>
public  OrdenServicioFactory()
{
}

/// <summary>
/// Create a new OrdenServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  OrdenServicioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type OrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a OrdenServicio.
/// </summary>
public OrdenServicio Fetch(System.Int32 pCodOrdenServicio)
{
OrdenServicio _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodOrdenServicio" ,pCodOrdenServicio ));
_bo = (OrdenServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type OrdenServiciointo the current session by using it's Primary Key values.
/// </summary>
public OrdenServicio Get(System.Int32 pCodOrdenServicio)
{
OrdenServicio _bo = null ;
try 
{
_bo = Session.Get(typeof(OrdenServicio), pCodOrdenServicio) as OrdenServicio;
if ( _bo == null ) 
{
return null;
}
...
//pCriteria.SetProjection( NotExpression);
return count;

}

/// <summary>
/// Get strongly typed collection of OrdenServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public OrdenServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object OrdenServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(OrdenServicio),"OrdenServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for OrdenServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of OrdenServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public OrdenServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 OrdenServicioCollection _list = new OrdenServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of OrdenServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public OrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of OrdenServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public OrdenServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public OrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of OrdenServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public OrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pOrdenServicio">A BO of type OrdenServicio</param>
public void ReAttach(OrdenServicio pOrdenServicio)
{
if( pOrdenServicio == null  ) throw new ArgumentNullException("pOrdenServicio");
try 
{
Session.Lock(pOrdenServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class OrdenServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pOrdenServicio">A BO of type OrdenServicio</param>
public void Insert(OrdenServicio pOrdenServicio)
{
if( pOrdenServicio == null  ) throw new ArgumentNullException("pOrdenServicio");
try 
{
BeginTransaction(false);
Session.Save(pOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class OrdenServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListOrdenServicio">A List of OrdenServicio</param>
public void Insert(IEnumerable<OrdenServicio> pListOrdenServicio)
{
if( pListOrdenServicio == null  ) throw new ArgumentNullException("pListOrdenServicio");
try 
{
BeginTransaction(false);
foreach ( OrdenServicio _OrdenServicio in pListOrdenServicio ) 
{
Session.Save(_OrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pOrdenServicio">A BO of type OrdenServicio</param>
public void Save(OrdenServicio pOrdenServicio)
{
if( pOrdenServicio == null  ) throw new ArgumentNullException("pOrdenServicio");
try 
{
BeginTransaction(false);
Session.Update(pOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type OrdenServicio
/// </summary>
///<param name="pOrdenServicio">A BO of type OrdenServicio</param>
public void Delete(OrdenServicio pOrdenServicio)
{
if( pOrdenServicio == null  ) throw new ArgumentNullException("pOrdenServicio");
try 
{
BeginTransaction(false);
Session.Delete(pOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type OrdenServicio inside one transaction.
/// </summary>
///<param name="pListOrdenServicio">A List of OrdenServicio</param>
public void Delete(IEnumerable<OrdenServicio> pListOrdenServicio)
{
if( pListOrdenServicio == null  ) throw new ArgumentNullException("pListOrdenServicio");
try 
{
...
/// <summary>
/// Delete a OrdenServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenServicio)
{
OrdenServicio _ordenServicio = Fetch(pCodOrdenServicio);
if ( _ordenServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_ordenServicio);
...
/// </summary>
///<param name="pOrdenServicio">A BO of type OrdenServicio</param>
public OrdenServicio Dummy(OrdenServicio pOrdenServicio)
{
if( pOrdenServicio == null  ) throw new ArgumentNullException("pOrdenServicio");
return pOrdenServicio;
