...
namespace BOLayer{
[DataObject]
public partial class PaiseFactory
 {
...
/// <summary>
/// Create a new Paise Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  PaiseFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Paise by using it's Primary Key values. This is the Primary method to retrieve a Paise.
/// </summary>
public Paise Fetch(System.String pCodPais)
{
...
_bo = (Paise) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Paiseinto the current session by using it's Primary Key values.
/// </summary>
public Paise Get(System.String pCodPais)
{
if ( String.IsNullOrEmpty(pCodPais)) throw new ArgumentException("Argument Name:pCodPais. Primary Key Column must have a value (different from null or empty)");
pCodPais = pCodPais.PadRight(5,' ') ;
Paise _bo = null ;
try 
{
_bo = Session.Get(typeof(Paise), pCodPais) as Paise;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of PaiseCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public PaiseCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Paise
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Paise),"Paise"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Paise");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of PaiseCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public PaiseCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 PaiseCollection _list = new PaiseCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of PaiseCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public PaiseCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of PaiseCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public PaiseCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PaiseCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of PaiseCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PaiseCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pPaise">A BO of type Paise</param>
public void ReAttach(Paise pPaise)
{
if( pPaise == null  ) throw new ArgumentNullException("pPaise");
try 
{
Session.Lock(pPaise, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Paise it saves it (insert) to the DataBase
/// </summary>
///<param name="pPaise">A BO of type Paise</param>
public void Insert(Paise pPaise)
{
if( pPaise == null  ) throw new ArgumentNullException("pPaise");
try 
{
...
/// <summary>
/// Given an List of BO of class Paise it Inserts them into the DataBase
/// </summary>
///<param name="pListPaise">A List of Paise</param>
public void Insert(IEnumerable<Paise> pListPaise)
{
if( pListPaise == null  ) throw new ArgumentNullException("pListPaise");
try 
{
BeginTransaction(false);
foreach ( Paise _Paise in pListPaise ) 
{
Session.Save(_Paise);
}
Commit(false);
...
/// </summary>
///<param name="pPaise">A BO of type Paise</param>
public void Save(Paise pPaise)
{
if( pPaise == null  ) throw new ArgumentNullException("pPaise");
try 
{
BeginTransaction(false);
Session.Update(pPaise);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Paise
/// </summary>
///<param name="pPaise">A BO of type Paise</param>
public void Delete(Paise pPaise)
{
if( pPaise == null  ) throw new ArgumentNullException("pPaise");
try 
{
BeginTransaction(false);
Session.Delete(pPaise);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Paise inside one transaction.
/// </summary>
///<param name="pListPaise">A List of Paise</param>
public void Delete(IEnumerable<Paise> pListPaise)
{
if( pListPaise == null  ) throw new ArgumentNullException("pListPaise");
try 
{
...
/// <summary>
/// Delete a Paise object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodPais)
{
Paise _paise = Fetch(pCodPais);
if ( _paise == null ) throw new Exception("Object not found , could not delete");
Delete(_paise);
...
/// </summary>
///<param name="pPaise">A BO of type Paise</param>
public Paise Dummy(Paise pPaise)
{
if( pPaise == null  ) throw new ArgumentNullException("pPaise");
return pPaise;
