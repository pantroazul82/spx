...
namespace BOLayer{
[DataObject]
public partial class PrioridadSolicitudFactory
 {
...
/// <summary>
/// Create a new PrioridadSolicitud Factory .
/// </summary>
public  PrioridadSolicitudFactory()
{
}

/// <summary>
/// Create a new PrioridadSolicitud Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  PrioridadSolicitudFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type PrioridadSolicitud by using it's Primary Key values. This is the Primary method to retrieve a PrioridadSolicitud.
/// </summary>
public PrioridadSolicitud Fetch(System.Int32 pCodPrioridadSolicitud)
{
PrioridadSolicitud _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodPrioridadSolicitud" ,pCodPrioridadSolicitud ));
_bo = (PrioridadSolicitud) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type PrioridadSolicitudinto the current session by using it's Primary Key values.
/// </summary>
public PrioridadSolicitud Get(System.Int32 pCodPrioridadSolicitud)
{
PrioridadSolicitud _bo = null ;
try 
{
_bo = Session.Get(typeof(PrioridadSolicitud), pCodPrioridadSolicitud) as PrioridadSolicitud;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of PrioridadSolicitudCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public PrioridadSolicitudCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object PrioridadSolicitud
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(PrioridadSolicitud),"PrioridadSolicitud"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for PrioridadSolicitud");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of PrioridadSolicitudCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public PrioridadSolicitudCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 PrioridadSolicitudCollection _list = new PrioridadSolicitudCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of PrioridadSolicitudCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public PrioridadSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of PrioridadSolicitudCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public PrioridadSolicitudCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PrioridadSolicitudCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of PrioridadSolicitudCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PrioridadSolicitudCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pPrioridadSolicitud">A BO of type PrioridadSolicitud</param>
public void ReAttach(PrioridadSolicitud pPrioridadSolicitud)
{
if( pPrioridadSolicitud == null  ) throw new ArgumentNullException("pPrioridadSolicitud");
try 
{
Session.Lock(pPrioridadSolicitud, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class PrioridadSolicitud it saves it (insert) to the DataBase
/// </summary>
///<param name="pPrioridadSolicitud">A BO of type PrioridadSolicitud</param>
public void Insert(PrioridadSolicitud pPrioridadSolicitud)
{
if( pPrioridadSolicitud == null  ) throw new ArgumentNullException("pPrioridadSolicitud");
try 
{
BeginTransaction(false);
Session.Save(pPrioridadSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class PrioridadSolicitud it Inserts them into the DataBase
/// </summary>
///<param name="pListPrioridadSolicitud">A List of PrioridadSolicitud</param>
public void Insert(IEnumerable<PrioridadSolicitud> pListPrioridadSolicitud)
{
if( pListPrioridadSolicitud == null  ) throw new ArgumentNullException("pListPrioridadSolicitud");
try 
{
BeginTransaction(false);
foreach ( PrioridadSolicitud _PrioridadSolicitud in pListPrioridadSolicitud ) 
{
Session.Save(_PrioridadSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pPrioridadSolicitud">A BO of type PrioridadSolicitud</param>
public void Save(PrioridadSolicitud pPrioridadSolicitud)
{
if( pPrioridadSolicitud == null  ) throw new ArgumentNullException("pPrioridadSolicitud");
try 
{
BeginTransaction(false);
Session.Update(pPrioridadSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type PrioridadSolicitud
/// </summary>
///<param name="pPrioridadSolicitud">A BO of type PrioridadSolicitud</param>
public void Delete(PrioridadSolicitud pPrioridadSolicitud)
{
if( pPrioridadSolicitud == null  ) throw new ArgumentNullException("pPrioridadSolicitud");
try 
{
BeginTransaction(false);
Session.Delete(pPrioridadSolicitud);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type PrioridadSolicitud inside one transaction.
/// </summary>
///<param name="pListPrioridadSolicitud">A List of PrioridadSolicitud</param>
public void Delete(IEnumerable<PrioridadSolicitud> pListPrioridadSolicitud)
{
if( pListPrioridadSolicitud == null  ) throw new ArgumentNullException("pListPrioridadSolicitud");
try 
{
...
foreach ( PrioridadSolicitud _PrioridadSolicitud in pListPrioridadSolicitud ) 
{
Session.Delete(_PrioridadSolicitud);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a PrioridadSolicitud object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodPrioridadSolicitud)
{
PrioridadSolicitud _prioridadSolicitud = Fetch(pCodPrioridadSolicitud);
if ( _prioridadSolicitud == null ) throw new Exception("Object not found , could not delete");
Delete(_prioridadSolicitud);
...
/// </summary>
///<param name="pPrioridadSolicitud">A BO of type PrioridadSolicitud</param>
public PrioridadSolicitud Dummy(PrioridadSolicitud pPrioridadSolicitud)
{
if( pPrioridadSolicitud == null  ) throw new ArgumentNullException("pPrioridadSolicitud");
return pPrioridadSolicitud;
