...
namespace BOLayer{
[DataObject]
public partial class PrioridadesOrdenServicioFactory
 {
...
/// <summary>
/// Create a new PrioridadesOrdenServicio Factory .
/// </summary>
public  PrioridadesOrdenServicioFactory()
{
}

/// <summary>
/// Create a new PrioridadesOrdenServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  PrioridadesOrdenServicioFactory(SessionScope pSessionScope)
{
...
/// </summary>
~PrioridadesOrdenServicioFactory()
{
...
/// <summary>
/// Fetch an object of type PrioridadesOrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a PrioridadesOrdenServicio.
/// </summary>
public PrioridadesOrdenServicio Fetch(System.Int32 pCodPrioridadOS)
{
PrioridadesOrdenServicio _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodPrioridadOS" ,pCodPrioridadOS ));
_bo = (PrioridadesOrdenServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type PrioridadesOrdenServiciointo the current session by using it's Primary Key values.
/// </summary>
public PrioridadesOrdenServicio Get(System.Int32 pCodPrioridadOS)
{
PrioridadesOrdenServicio _bo = null ;
try 
{
_bo = Session.Get(typeof(PrioridadesOrdenServicio), pCodPrioridadOS) as PrioridadesOrdenServicio;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of PrioridadesOrdenServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public PrioridadesOrdenServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object PrioridadesOrdenServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(PrioridadesOrdenServicio),"PrioridadesOrdenServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for PrioridadesOrdenServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of PrioridadesOrdenServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public PrioridadesOrdenServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 PrioridadesOrdenServicioCollection _list = new PrioridadesOrdenServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of PrioridadesOrdenServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public PrioridadesOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of PrioridadesOrdenServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public PrioridadesOrdenServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PrioridadesOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of PrioridadesOrdenServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public PrioridadesOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pPrioridadesOrdenServicio">A BO of type PrioridadesOrdenServicio</param>
public void ReAttach(PrioridadesOrdenServicio pPrioridadesOrdenServicio)
{
if( pPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pPrioridadesOrdenServicio");
try 
{
Session.Lock(pPrioridadesOrdenServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class PrioridadesOrdenServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pPrioridadesOrdenServicio">A BO of type PrioridadesOrdenServicio</param>
public void Insert(PrioridadesOrdenServicio pPrioridadesOrdenServicio)
{
if( pPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pPrioridadesOrdenServicio");
try 
{
BeginTransaction(false);
Session.Save(pPrioridadesOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class PrioridadesOrdenServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListPrioridadesOrdenServicio">A List of PrioridadesOrdenServicio</param>
public void Insert(IEnumerable<PrioridadesOrdenServicio> pListPrioridadesOrdenServicio)
{
if( pListPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pListPrioridadesOrdenServicio");
try 
{
BeginTransaction(false);
foreach ( PrioridadesOrdenServicio _PrioridadesOrdenServicio in pListPrioridadesOrdenServicio ) 
{
Session.Save(_PrioridadesOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pPrioridadesOrdenServicio">A BO of type PrioridadesOrdenServicio</param>
public void Save(PrioridadesOrdenServicio pPrioridadesOrdenServicio)
{
if( pPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pPrioridadesOrdenServicio");
try 
{
BeginTransaction(false);
Session.Update(pPrioridadesOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type PrioridadesOrdenServicio
/// </summary>
///<param name="pPrioridadesOrdenServicio">A BO of type PrioridadesOrdenServicio</param>
public void Delete(PrioridadesOrdenServicio pPrioridadesOrdenServicio)
{
if( pPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pPrioridadesOrdenServicio");
try 
{
BeginTransaction(false);
Session.Delete(pPrioridadesOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type PrioridadesOrdenServicio inside one transaction.
/// </summary>
///<param name="pListPrioridadesOrdenServicio">A List of PrioridadesOrdenServicio</param>
public void Delete(IEnumerable<PrioridadesOrdenServicio> pListPrioridadesOrdenServicio)
{
if( pListPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pListPrioridadesOrdenServicio");
try 
{
...
foreach ( PrioridadesOrdenServicio _PrioridadesOrdenServicio in pListPrioridadesOrdenServicio ) 
{
Session.Delete(_PrioridadesOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a PrioridadesOrdenServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodPrioridadOS)
{
PrioridadesOrdenServicio _prioridadesOrdenServicio = Fetch(pCodPrioridadOS);
if ( _prioridadesOrdenServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_prioridadesOrdenServicio);
...
/// </summary>
///<param name="pPrioridadesOrdenServicio">A BO of type PrioridadesOrdenServicio</param>
public PrioridadesOrdenServicio Dummy(PrioridadesOrdenServicio pPrioridadesOrdenServicio)
{
if( pPrioridadesOrdenServicio == null  ) throw new ArgumentNullException("pPrioridadesOrdenServicio");
return pPrioridadesOrdenServicio;
