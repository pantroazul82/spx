...
namespace BOLayer{
[DataObject]
public partial class ProgramacionViajeFactory
 {
...
/// <summary>
/// Create a new ProgramacionViaje Factory .
/// </summary>
public  ProgramacionViajeFactory()
{
}

/// <summary>
/// Create a new ProgramacionViaje Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  ProgramacionViajeFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type ProgramacionViaje by using it's Primary Key values. This is the Primary method to retrieve a ProgramacionViaje.
/// </summary>
public ProgramacionViaje Fetch(System.Int32 pCodProgramacionViajes)
{
ProgramacionViaje _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodProgramacionViajes" ,pCodProgramacionViajes ));
_bo = (ProgramacionViaje) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type ProgramacionViajeinto the current session by using it's Primary Key values.
/// </summary>
public ProgramacionViaje Get(System.Int32 pCodProgramacionViajes)
{
ProgramacionViaje _bo = null ;
try 
{
_bo = Session.Get(typeof(ProgramacionViaje), pCodProgramacionViajes) as ProgramacionViaje;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of ProgramacionViajeCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public ProgramacionViajeCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object ProgramacionViaje
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(ProgramacionViaje),"ProgramacionViaje"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for ProgramacionViaje");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of ProgramacionViajeCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public ProgramacionViajeCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 ProgramacionViajeCollection _list = new ProgramacionViajeCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of ProgramacionViajeCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public ProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of ProgramacionViajeCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public ProgramacionViajeCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of ProgramacionViajeCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public ProgramacionViajeCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pProgramacionViaje">A BO of type ProgramacionViaje</param>
public void ReAttach(ProgramacionViaje pProgramacionViaje)
{
if( pProgramacionViaje == null  ) throw new ArgumentNullException("pProgramacionViaje");
try 
{
Session.Lock(pProgramacionViaje, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class ProgramacionViaje it saves it (insert) to the DataBase
/// </summary>
///<param name="pProgramacionViaje">A BO of type ProgramacionViaje</param>
public void Insert(ProgramacionViaje pProgramacionViaje)
{
if( pProgramacionViaje == null  ) throw new ArgumentNullException("pProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Save(pProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class ProgramacionViaje it Inserts them into the DataBase
/// </summary>
///<param name="pListProgramacionViaje">A List of ProgramacionViaje</param>
public void Insert(IEnumerable<ProgramacionViaje> pListProgramacionViaje)
{
if( pListProgramacionViaje == null  ) throw new ArgumentNullException("pListProgramacionViaje");
try 
{
BeginTransaction(false);
foreach ( ProgramacionViaje _ProgramacionViaje in pListProgramacionViaje ) 
{
Session.Save(_ProgramacionViaje);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pProgramacionViaje">A BO of type ProgramacionViaje</param>
public void Save(ProgramacionViaje pProgramacionViaje)
{
if( pProgramacionViaje == null  ) throw new ArgumentNullException("pProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Update(pProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type ProgramacionViaje
/// </summary>
///<param name="pProgramacionViaje">A BO of type ProgramacionViaje</param>
public void Delete(ProgramacionViaje pProgramacionViaje)
{
if( pProgramacionViaje == null  ) throw new ArgumentNullException("pProgramacionViaje");
try 
{
BeginTransaction(false);
Session.Delete(pProgramacionViaje);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type ProgramacionViaje inside one transaction.
/// </summary>
///<param name="pListProgramacionViaje">A List of ProgramacionViaje</param>
public void Delete(IEnumerable<ProgramacionViaje> pListProgramacionViaje)
{
if( pListProgramacionViaje == null  ) throw new ArgumentNullException("pListProgramacionViaje");
try 
{
...
foreach ( ProgramacionViaje _ProgramacionViaje in pListProgramacionViaje ) 
{
Session.Delete(_ProgramacionViaje);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a ProgramacionViaje object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodProgramacionViajes)
{
ProgramacionViaje _programacionViaje = Fetch(pCodProgramacionViajes);
if ( _programacionViaje == null ) throw new Exception("Object not found , could not delete");
Delete(_programacionViaje);
...
/// </summary>
///<param name="pProgramacionViaje">A BO of type ProgramacionViaje</param>
public ProgramacionViaje Dummy(ProgramacionViaje pProgramacionViaje)
{
if( pProgramacionViaje == null  ) throw new ArgumentNullException("pProgramacionViaje");
return pProgramacionViaje;
