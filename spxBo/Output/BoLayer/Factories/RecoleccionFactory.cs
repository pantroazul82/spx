...
namespace BOLayer{
[DataObject]
public partial class RecoleccionFactory
 {
...
/// <summary>
/// Create a new Recoleccion Factory .
/// </summary>
public  RecoleccionFactory()
{
}

/// <summary>
/// Create a new Recoleccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  RecoleccionFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Recoleccion by using it's Primary Key values. This is the Primary method to retrieve a Recoleccion.
/// </summary>
public Recoleccion Fetch(System.Int32 pCodRecoleccion)
{
Recoleccion _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodRecoleccion" ,pCodRecoleccion ));
_bo = (Recoleccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Recoleccioninto the current session by using it's Primary Key values.
/// </summary>
public Recoleccion Get(System.Int32 pCodRecoleccion)
{
Recoleccion _bo = null ;
try 
{
_bo = Session.Get(typeof(Recoleccion), pCodRecoleccion) as Recoleccion;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of RecoleccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public RecoleccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Recoleccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Recoleccion),"Recoleccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Recoleccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of RecoleccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public RecoleccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 RecoleccionCollection _list = new RecoleccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of RecoleccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public RecoleccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of RecoleccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public RecoleccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RecoleccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of RecoleccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RecoleccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pRecoleccion">A BO of type Recoleccion</param>
public void ReAttach(Recoleccion pRecoleccion)
{
if( pRecoleccion == null  ) throw new ArgumentNullException("pRecoleccion");
try 
{
Session.Lock(pRecoleccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Recoleccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pRecoleccion">A BO of type Recoleccion</param>
public void Insert(Recoleccion pRecoleccion)
{
if( pRecoleccion == null  ) throw new ArgumentNullException("pRecoleccion");
try 
{
BeginTransaction(false);
Session.Save(pRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Recoleccion it Inserts them into the DataBase
/// </summary>
///<param name="pListRecoleccion">A List of Recoleccion</param>
public void Insert(IEnumerable<Recoleccion> pListRecoleccion)
{
if( pListRecoleccion == null  ) throw new ArgumentNullException("pListRecoleccion");
try 
{
BeginTransaction(false);
foreach ( Recoleccion _Recoleccion in pListRecoleccion ) 
{
Session.Save(_Recoleccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pRecoleccion">A BO of type Recoleccion</param>
public void Save(Recoleccion pRecoleccion)
{
if( pRecoleccion == null  ) throw new ArgumentNullException("pRecoleccion");
try 
{
BeginTransaction(false);
Session.Update(pRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Recoleccion
/// </summary>
///<param name="pRecoleccion">A BO of type Recoleccion</param>
public void Delete(Recoleccion pRecoleccion)
{
if( pRecoleccion == null  ) throw new ArgumentNullException("pRecoleccion");
try 
{
BeginTransaction(false);
Session.Delete(pRecoleccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Recoleccion inside one transaction.
/// </summary>
///<param name="pListRecoleccion">A List of Recoleccion</param>
public void Delete(IEnumerable<Recoleccion> pListRecoleccion)
{
if( pListRecoleccion == null  ) throw new ArgumentNullException("pListRecoleccion");
try 
{
...
/// <summary>
/// Delete a Recoleccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodRecoleccion)
{
Recoleccion _recoleccion = Fetch(pCodRecoleccion);
if ( _recoleccion == null ) throw new Exception("Object not found , could not delete");
Delete(_recoleccion);
...
/// </summary>
///<param name="pRecoleccion">A BO of type Recoleccion</param>
public Recoleccion Dummy(Recoleccion pRecoleccion)
{
if( pRecoleccion == null  ) throw new ArgumentNullException("pRecoleccion");
return pRecoleccion;
