...
namespace BOLayer{
[DataObject]
public partial class RepuestoFactory
 {
...
/// <summary>
/// Create a new Repuesto Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  RepuestoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Repuesto by using it's Primary Key values. This is the Primary method to retrieve a Repuesto.
/// </summary>
public Repuesto Fetch(System.String pCodRepuesto)
{
...
_bo = (Repuesto) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Repuestointo the current session by using it's Primary Key values.
/// </summary>
public Repuesto Get(System.String pCodRepuesto)
{
if ( String.IsNullOrEmpty(pCodRepuesto)) throw new ArgumentException("Argument Name:pCodRepuesto. Primary Key Column must have a value (different from null or empty)");
pCodRepuesto = pCodRepuesto.PadRight(20,' ') ;
Repuesto _bo = null ;
try 
{
_bo = Session.Get(typeof(Repuesto), pCodRepuesto) as Repuesto;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of RepuestoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public RepuestoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Repuesto
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Repuesto),"Repuesto"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Repuesto");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of RepuestoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public RepuestoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 RepuestoCollection _list = new RepuestoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of RepuestoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public RepuestoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of RepuestoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public RepuestoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RepuestoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of RepuestoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RepuestoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pRepuesto">A BO of type Repuesto</param>
public void ReAttach(Repuesto pRepuesto)
{
if( pRepuesto == null  ) throw new ArgumentNullException("pRepuesto");
try 
{
Session.Lock(pRepuesto, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Repuesto it saves it (insert) to the DataBase
/// </summary>
///<param name="pRepuesto">A BO of type Repuesto</param>
public void Insert(Repuesto pRepuesto)
{
if( pRepuesto == null  ) throw new ArgumentNullException("pRepuesto");
try 
{
BeginTransaction(false);
Session.Save(pRepuesto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Repuesto it Inserts them into the DataBase
/// </summary>
///<param name="pListRepuesto">A List of Repuesto</param>
public void Insert(IEnumerable<Repuesto> pListRepuesto)
{
if( pListRepuesto == null  ) throw new ArgumentNullException("pListRepuesto");
try 
{
BeginTransaction(false);
foreach ( Repuesto _Repuesto in pListRepuesto ) 
{
Session.Save(_Repuesto);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pRepuesto">A BO of type Repuesto</param>
public void Save(Repuesto pRepuesto)
{
if( pRepuesto == null  ) throw new ArgumentNullException("pRepuesto");
try 
{
BeginTransaction(false);
Session.Update(pRepuesto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Repuesto
/// </summary>
///<param name="pRepuesto">A BO of type Repuesto</param>
public void Delete(Repuesto pRepuesto)
{
if( pRepuesto == null  ) throw new ArgumentNullException("pRepuesto");
try 
{
BeginTransaction(false);
Session.Delete(pRepuesto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Repuesto inside one transaction.
/// </summary>
///<param name="pListRepuesto">A List of Repuesto</param>
public void Delete(IEnumerable<Repuesto> pListRepuesto)
{
if( pListRepuesto == null  ) throw new ArgumentNullException("pListRepuesto");
try 
{
...
/// <summary>
/// Delete a Repuesto object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodRepuesto)
{
Repuesto _repuesto = Fetch(pCodRepuesto);
if ( _repuesto == null ) throw new Exception("Object not found , could not delete");
Delete(_repuesto);
...
/// </summary>
///<param name="pRepuesto">A BO of type Repuesto</param>
public Repuesto Dummy(Repuesto pRepuesto)
{
if( pRepuesto == null  ) throw new ArgumentNullException("pRepuesto");
return pRepuesto;
