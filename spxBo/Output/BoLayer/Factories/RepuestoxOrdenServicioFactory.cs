...
namespace BOLayer{
[DataObject]
public partial class RepuestoxOrdenServicioFactory
 {
...
/// <summary>
/// Create a new RepuestoxOrdenServicio Factory .
/// </summary>
public  RepuestoxOrdenServicioFactory()
{
}

/// <summary>
/// Create a new RepuestoxOrdenServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  RepuestoxOrdenServicioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type RepuestoxOrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a RepuestoxOrdenServicio.
/// </summary>
public RepuestoxOrdenServicio Fetch(System.Int32 pCodOrdenServicio , System.String pCodRepuesto)
{
...
RepuestoxOrdenServicio _bo = null ;
try 
{
...
_bo = (RepuestoxOrdenServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type RepuestoxOrdenServicio by using it's Primary Key values. This is the Primary method to retrieve a RepuestoxOrdenServicio.
/// </summary>
public RepuestoxOrdenServicio FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codOrdenServicio,_codRepuesto);
...
/// <summary>
/// Get strongly typed collection of RepuestoxOrdenServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public RepuestoxOrdenServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object RepuestoxOrdenServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(RepuestoxOrdenServicio),"RepuestoxOrdenServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for RepuestoxOrdenServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of RepuestoxOrdenServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public RepuestoxOrdenServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 RepuestoxOrdenServicioCollection _list = new RepuestoxOrdenServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of RepuestoxOrdenServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public RepuestoxOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of RepuestoxOrdenServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public RepuestoxOrdenServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RepuestoxOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of RepuestoxOrdenServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public RepuestoxOrdenServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pRepuestoxOrdenServicio">A BO of type RepuestoxOrdenServicio</param>
public void ReAttach(RepuestoxOrdenServicio pRepuestoxOrdenServicio)
{
if( pRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pRepuestoxOrdenServicio");
try 
{
Session.Lock(pRepuestoxOrdenServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class RepuestoxOrdenServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pRepuestoxOrdenServicio">A BO of type RepuestoxOrdenServicio</param>
public void Insert(RepuestoxOrdenServicio pRepuestoxOrdenServicio)
{
if( pRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pRepuestoxOrdenServicio");
try 
{
BeginTransaction(false);
Session.Save(pRepuestoxOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class RepuestoxOrdenServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListRepuestoxOrdenServicio">A List of RepuestoxOrdenServicio</param>
public void Insert(IEnumerable<RepuestoxOrdenServicio> pListRepuestoxOrdenServicio)
{
if( pListRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pListRepuestoxOrdenServicio");
try 
{
BeginTransaction(false);
foreach ( RepuestoxOrdenServicio _RepuestoxOrdenServicio in pListRepuestoxOrdenServicio ) 
{
Session.Save(_RepuestoxOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pRepuestoxOrdenServicio">A BO of type RepuestoxOrdenServicio</param>
public void Save(RepuestoxOrdenServicio pRepuestoxOrdenServicio)
{
if( pRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pRepuestoxOrdenServicio");
try 
{
BeginTransaction(false);
Session.Update(pRepuestoxOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type RepuestoxOrdenServicio
/// </summary>
///<param name="pRepuestoxOrdenServicio">A BO of type RepuestoxOrdenServicio</param>
public void Delete(RepuestoxOrdenServicio pRepuestoxOrdenServicio)
{
if( pRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pRepuestoxOrdenServicio");
try 
{
BeginTransaction(false);
Session.Delete(pRepuestoxOrdenServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type RepuestoxOrdenServicio inside one transaction.
/// </summary>
///<param name="pListRepuestoxOrdenServicio">A List of RepuestoxOrdenServicio</param>
public void Delete(IEnumerable<RepuestoxOrdenServicio> pListRepuestoxOrdenServicio)
{
if( pListRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pListRepuestoxOrdenServicio");
try 
{
...
foreach ( RepuestoxOrdenServicio _RepuestoxOrdenServicio in pListRepuestoxOrdenServicio ) 
{
Session.Delete(_RepuestoxOrdenServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a RepuestoxOrdenServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenServicio , System.String pCodRepuesto)
{
RepuestoxOrdenServicio _repuestoxOrdenServicio = Fetch(pCodOrdenServicio , pCodRepuesto);
if ( _repuestoxOrdenServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_repuestoxOrdenServicio);
...
/// </summary>
///<param name="pRepuestoxOrdenServicio">A BO of type RepuestoxOrdenServicio</param>
public RepuestoxOrdenServicio Dummy(RepuestoxOrdenServicio pRepuestoxOrdenServicio)
{
if( pRepuestoxOrdenServicio == null  ) throw new ArgumentNullException("pRepuestoxOrdenServicio");
return pRepuestoxOrdenServicio;
