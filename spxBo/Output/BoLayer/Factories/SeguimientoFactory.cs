...
namespace BOLayer{
[DataObject]
public partial class SeguimientoFactory
 {
...
/// <summary>
/// Create a new Seguimiento Factory .
/// </summary>
public  SeguimientoFactory()
{
}

/// <summary>
/// Create a new Seguimiento Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  SeguimientoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Seguimiento by using it's Primary Key values. This is the Primary method to retrieve a Seguimiento.
/// </summary>
public Seguimiento Fetch(System.Int32 pIdSeguimiento)
{
Seguimiento _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("IdSeguimiento" ,pIdSeguimiento ));
_bo = (Seguimiento) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Seguimientointo the current session by using it's Primary Key values.
/// </summary>
public Seguimiento Get(System.Int32 pIdSeguimiento)
{
Seguimiento _bo = null ;
try 
{
_bo = Session.Get(typeof(Seguimiento), pIdSeguimiento) as Seguimiento;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of SeguimientoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public SeguimientoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Seguimiento
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Seguimiento),"Seguimiento"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Seguimiento");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of SeguimientoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public SeguimientoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 SeguimientoCollection _list = new SeguimientoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of SeguimientoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public SeguimientoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of SeguimientoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public SeguimientoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SeguimientoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of SeguimientoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SeguimientoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSeguimiento">A BO of type Seguimiento</param>
public void ReAttach(Seguimiento pSeguimiento)
{
if( pSeguimiento == null  ) throw new ArgumentNullException("pSeguimiento");
try 
{
Session.Lock(pSeguimiento, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Seguimiento it saves it (insert) to the DataBase
/// </summary>
///<param name="pSeguimiento">A BO of type Seguimiento</param>
public void Insert(Seguimiento pSeguimiento)
{
if( pSeguimiento == null  ) throw new ArgumentNullException("pSeguimiento");
try 
{
BeginTransaction(false);
Session.Save(pSeguimiento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Seguimiento it Inserts them into the DataBase
/// </summary>
///<param name="pListSeguimiento">A List of Seguimiento</param>
public void Insert(IEnumerable<Seguimiento> pListSeguimiento)
{
if( pListSeguimiento == null  ) throw new ArgumentNullException("pListSeguimiento");
try 
{
BeginTransaction(false);
foreach ( Seguimiento _Seguimiento in pListSeguimiento ) 
{
Session.Save(_Seguimiento);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSeguimiento">A BO of type Seguimiento</param>
public void Save(Seguimiento pSeguimiento)
{
if( pSeguimiento == null  ) throw new ArgumentNullException("pSeguimiento");
try 
{
BeginTransaction(false);
Session.Update(pSeguimiento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Seguimiento
/// </summary>
///<param name="pSeguimiento">A BO of type Seguimiento</param>
public void Delete(Seguimiento pSeguimiento)
{
if( pSeguimiento == null  ) throw new ArgumentNullException("pSeguimiento");
try 
{
BeginTransaction(false);
Session.Delete(pSeguimiento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Seguimiento inside one transaction.
/// </summary>
///<param name="pListSeguimiento">A List of Seguimiento</param>
public void Delete(IEnumerable<Seguimiento> pListSeguimiento)
{
if( pListSeguimiento == null  ) throw new ArgumentNullException("pListSeguimiento");
try 
{
...
/// <summary>
/// Delete a Seguimiento object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pIdSeguimiento)
{
Seguimiento _seguimiento = Fetch(pIdSeguimiento);
if ( _seguimiento == null ) throw new Exception("Object not found , could not delete");
Delete(_seguimiento);
...
/// </summary>
///<param name="pSeguimiento">A BO of type Seguimiento</param>
public Seguimiento Dummy(Seguimiento pSeguimiento)
{
if( pSeguimiento == null  ) throw new ArgumentNullException("pSeguimiento");
return pSeguimiento;
