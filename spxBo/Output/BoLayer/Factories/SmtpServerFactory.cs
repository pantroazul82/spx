...
namespace BOLayer{
[DataObject]
public partial class SmtpServerFactory
 {
...
/// <summary>
/// Create a new SmtpServer Factory .
/// </summary>
...
/// <summary>
/// Create a new SmtpServer Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  SmtpServerFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type SmtpServer by using it's Primary Key values. This is the Primary method to retrieve a SmtpServer.
/// </summary>
public SmtpServer Fetch(System.String pSmtpServer1)
{
if ( String.IsNullOrEmpty(pSmtpServer1)) throw new ArgumentException("Argument Name:pSmtpServer1. Primary Key Column must have a value (different from null or empty)");
SmtpServer _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("SmtpServer1" ,pSmtpServer1 ));
_bo = (SmtpServer) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type SmtpServerinto the current session by using it's Primary Key values.
/// </summary>
public SmtpServer Get(System.String pSmtpServer1)
{
if ( String.IsNullOrEmpty(pSmtpServer1)) throw new ArgumentException("Argument Name:pSmtpServer1. Primary Key Column must have a value (different from null or empty)");
SmtpServer _bo = null ;
try 
{
_bo = Session.Get(typeof(SmtpServer), pSmtpServer1) as SmtpServer;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of SmtpServerCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public SmtpServerCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object SmtpServer
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(SmtpServer),"SmtpServer"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for SmtpServer");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of SmtpServerCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public SmtpServerCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 SmtpServerCollection _list = new SmtpServerCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of SmtpServerCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public SmtpServerCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of SmtpServerCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public SmtpServerCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SmtpServerCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of SmtpServerCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SmtpServerCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSmtpServer">A BO of type SmtpServer</param>
public void ReAttach(SmtpServer pSmtpServer)
{
if( pSmtpServer == null  ) throw new ArgumentNullException("pSmtpServer");
try 
{
Session.Lock(pSmtpServer, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class SmtpServer it saves it (insert) to the DataBase
/// </summary>
///<param name="pSmtpServer">A BO of type SmtpServer</param>
public void Insert(SmtpServer pSmtpServer)
{
if( pSmtpServer == null  ) throw new ArgumentNullException("pSmtpServer");
try 
{
BeginTransaction(false);
Session.Save(pSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class SmtpServer it Inserts them into the DataBase
/// </summary>
///<param name="pListSmtpServer">A List of SmtpServer</param>
public void Insert(IEnumerable<SmtpServer> pListSmtpServer)
{
if( pListSmtpServer == null  ) throw new ArgumentNullException("pListSmtpServer");
try 
{
BeginTransaction(false);
foreach ( SmtpServer _SmtpServer in pListSmtpServer ) 
{
Session.Save(_SmtpServer);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSmtpServer">A BO of type SmtpServer</param>
public void Save(SmtpServer pSmtpServer)
{
if( pSmtpServer == null  ) throw new ArgumentNullException("pSmtpServer");
try 
{
BeginTransaction(false);
Session.Update(pSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type SmtpServer
/// </summary>
///<param name="pSmtpServer">A BO of type SmtpServer</param>
public void Delete(SmtpServer pSmtpServer)
{
if( pSmtpServer == null  ) throw new ArgumentNullException("pSmtpServer");
try 
{
BeginTransaction(false);
Session.Delete(pSmtpServer);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type SmtpServer inside one transaction.
/// </summary>
///<param name="pListSmtpServer">A List of SmtpServer</param>
public void Delete(IEnumerable<SmtpServer> pListSmtpServer)
{
if( pListSmtpServer == null  ) throw new ArgumentNullException("pListSmtpServer");
try 
{
...
/// <summary>
/// Delete a SmtpServer object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pSmtpServer1)
{
SmtpServer _smtpServer = Fetch(pSmtpServer1);
if ( _smtpServer == null ) throw new Exception("Object not found , could not delete");
Delete(_smtpServer);
...
/// </summary>
///<param name="pSmtpServer">A BO of type SmtpServer</param>
public SmtpServer Dummy(SmtpServer pSmtpServer)
{
if( pSmtpServer == null  ) throw new ArgumentNullException("pSmtpServer");
return pSmtpServer;
