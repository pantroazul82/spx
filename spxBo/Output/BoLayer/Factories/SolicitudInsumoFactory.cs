...
namespace BOLayer{
[DataObject]
public partial class SolicitudInsumoFactory
 {
...
/// <summary>
/// Create a new SolicitudInsumo Factory .
/// </summary>
public  SolicitudInsumoFactory()
{
}

/// <summary>
/// Create a new SolicitudInsumo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  SolicitudInsumoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type SolicitudInsumo by using it's Primary Key values. This is the Primary method to retrieve a SolicitudInsumo.
/// </summary>
public SolicitudInsumo Fetch(System.Int32 pCodOrdenServicio , System.Int32 pCodSolicitud)
{
SolicitudInsumo _bo = null ;
try 
{
...
_bo = (SolicitudInsumo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type SolicitudInsumo by using it's Primary Key values. This is the Primary method to retrieve a SolicitudInsumo.
/// </summary>
public SolicitudInsumo FetchVirtual(string pVirtualKey)
{
...
return Fetch(_codOrdenServicio,_codSolicitud);
...
/// <summary>
/// Get strongly typed collection of SolicitudInsumoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public SolicitudInsumoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object SolicitudInsumo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(SolicitudInsumo),"SolicitudInsumo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for SolicitudInsumo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of SolicitudInsumoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public SolicitudInsumoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 SolicitudInsumoCollection _list = new SolicitudInsumoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of SolicitudInsumoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public SolicitudInsumoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of SolicitudInsumoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public SolicitudInsumoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SolicitudInsumoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of SolicitudInsumoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SolicitudInsumoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSolicitudInsumo">A BO of type SolicitudInsumo</param>
public void ReAttach(SolicitudInsumo pSolicitudInsumo)
{
if( pSolicitudInsumo == null  ) throw new ArgumentNullException("pSolicitudInsumo");
try 
{
Session.Lock(pSolicitudInsumo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class SolicitudInsumo it saves it (insert) to the DataBase
/// </summary>
///<param name="pSolicitudInsumo">A BO of type SolicitudInsumo</param>
public void Insert(SolicitudInsumo pSolicitudInsumo)
{
if( pSolicitudInsumo == null  ) throw new ArgumentNullException("pSolicitudInsumo");
try 
{
BeginTransaction(false);
Session.Save(pSolicitudInsumo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class SolicitudInsumo it Inserts them into the DataBase
/// </summary>
///<param name="pListSolicitudInsumo">A List of SolicitudInsumo</param>
public void Insert(IEnumerable<SolicitudInsumo> pListSolicitudInsumo)
{
if( pListSolicitudInsumo == null  ) throw new ArgumentNullException("pListSolicitudInsumo");
try 
{
BeginTransaction(false);
foreach ( SolicitudInsumo _SolicitudInsumo in pListSolicitudInsumo ) 
{
Session.Save(_SolicitudInsumo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSolicitudInsumo">A BO of type SolicitudInsumo</param>
public void Save(SolicitudInsumo pSolicitudInsumo)
{
if( pSolicitudInsumo == null  ) throw new ArgumentNullException("pSolicitudInsumo");
try 
{
BeginTransaction(false);
Session.Update(pSolicitudInsumo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type SolicitudInsumo
/// </summary>
///<param name="pSolicitudInsumo">A BO of type SolicitudInsumo</param>
public void Delete(SolicitudInsumo pSolicitudInsumo)
{
if( pSolicitudInsumo == null  ) throw new ArgumentNullException("pSolicitudInsumo");
try 
{
BeginTransaction(false);
Session.Delete(pSolicitudInsumo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type SolicitudInsumo inside one transaction.
/// </summary>
///<param name="pListSolicitudInsumo">A List of SolicitudInsumo</param>
public void Delete(IEnumerable<SolicitudInsumo> pListSolicitudInsumo)
{
if( pListSolicitudInsumo == null  ) throw new ArgumentNullException("pListSolicitudInsumo");
try 
{
...
foreach ( SolicitudInsumo _SolicitudInsumo in pListSolicitudInsumo ) 
{
Session.Delete(_SolicitudInsumo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a SolicitudInsumo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodOrdenServicio , System.Int32 pCodSolicitud)
{
SolicitudInsumo _solicitudInsumo = Fetch(pCodOrdenServicio , pCodSolicitud);
if ( _solicitudInsumo == null ) throw new Exception("Object not found , could not delete");
Delete(_solicitudInsumo);
...
/// </summary>
///<param name="pSolicitudInsumo">A BO of type SolicitudInsumo</param>
public SolicitudInsumo Dummy(SolicitudInsumo pSolicitudInsumo)
{
if( pSolicitudInsumo == null  ) throw new ArgumentNullException("pSolicitudInsumo");
return pSolicitudInsumo;
