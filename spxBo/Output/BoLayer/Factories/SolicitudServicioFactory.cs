...
namespace BOLayer{
[DataObject]
public partial class SolicitudServicioFactory
 {
...
/// <summary>
/// Create a new SolicitudServicio Factory .
/// </summary>
public  SolicitudServicioFactory()
{
}

/// <summary>
/// Create a new SolicitudServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  SolicitudServicioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type SolicitudServicio by using it's Primary Key values. This is the Primary method to retrieve a SolicitudServicio.
/// </summary>
public SolicitudServicio Fetch(System.Int32 pCodSolicitudServicio)
{
SolicitudServicio _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodSolicitudServicio" ,pCodSolicitudServicio ));
_bo = (SolicitudServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type SolicitudServiciointo the current session by using it's Primary Key values.
/// </summary>
public SolicitudServicio Get(System.Int32 pCodSolicitudServicio)
{
SolicitudServicio _bo = null ;
try 
{
_bo = Session.Get(typeof(SolicitudServicio), pCodSolicitudServicio) as SolicitudServicio;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of SolicitudServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public SolicitudServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object SolicitudServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(SolicitudServicio),"SolicitudServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for SolicitudServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of SolicitudServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public SolicitudServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 SolicitudServicioCollection _list = new SolicitudServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of SolicitudServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public SolicitudServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of SolicitudServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public SolicitudServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SolicitudServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of SolicitudServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SolicitudServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSolicitudServicio">A BO of type SolicitudServicio</param>
public void ReAttach(SolicitudServicio pSolicitudServicio)
{
if( pSolicitudServicio == null  ) throw new ArgumentNullException("pSolicitudServicio");
try 
{
Session.Lock(pSolicitudServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class SolicitudServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pSolicitudServicio">A BO of type SolicitudServicio</param>
public void Insert(SolicitudServicio pSolicitudServicio)
{
if( pSolicitudServicio == null  ) throw new ArgumentNullException("pSolicitudServicio");
try 
{
BeginTransaction(false);
Session.Save(pSolicitudServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class SolicitudServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListSolicitudServicio">A List of SolicitudServicio</param>
public void Insert(IEnumerable<SolicitudServicio> pListSolicitudServicio)
{
if( pListSolicitudServicio == null  ) throw new ArgumentNullException("pListSolicitudServicio");
try 
{
BeginTransaction(false);
foreach ( SolicitudServicio _SolicitudServicio in pListSolicitudServicio ) 
{
Session.Save(_SolicitudServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSolicitudServicio">A BO of type SolicitudServicio</param>
public void Save(SolicitudServicio pSolicitudServicio)
{
if( pSolicitudServicio == null  ) throw new ArgumentNullException("pSolicitudServicio");
try 
{
BeginTransaction(false);
Session.Update(pSolicitudServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type SolicitudServicio
/// </summary>
///<param name="pSolicitudServicio">A BO of type SolicitudServicio</param>
public void Delete(SolicitudServicio pSolicitudServicio)
{
if( pSolicitudServicio == null  ) throw new ArgumentNullException("pSolicitudServicio");
try 
{
BeginTransaction(false);
Session.Delete(pSolicitudServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type SolicitudServicio inside one transaction.
/// </summary>
///<param name="pListSolicitudServicio">A List of SolicitudServicio</param>
public void Delete(IEnumerable<SolicitudServicio> pListSolicitudServicio)
{
if( pListSolicitudServicio == null  ) throw new ArgumentNullException("pListSolicitudServicio");
try 
{
...
foreach ( SolicitudServicio _SolicitudServicio in pListSolicitudServicio ) 
{
Session.Delete(_SolicitudServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a SolicitudServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodSolicitudServicio)
{
SolicitudServicio _solicitudServicio = Fetch(pCodSolicitudServicio);
if ( _solicitudServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_solicitudServicio);
...
/// </summary>
///<param name="pSolicitudServicio">A BO of type SolicitudServicio</param>
public SolicitudServicio Dummy(SolicitudServicio pSolicitudServicio)
{
if( pSolicitudServicio == null  ) throw new ArgumentNullException("pSolicitudServicio");
return pSolicitudServicio;
