...
namespace BOLayer{
[DataObject]
public partial class Soluciones_problemaFactory
 {
...
/// <summary>
/// Create a new Soluciones_problema Factory .
/// </summary>
public  Soluciones_problemaFactory()
{
}

/// <summary>
/// Create a new Soluciones_problema Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  Soluciones_problemaFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Soluciones_problema by using it's Primary Key values. This is the Primary method to retrieve a Soluciones_problema.
/// </summary>
public Soluciones_problema Fetch(System.Int32 pCod_soluciones_problemas)
{
Soluciones_problema _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("Cod_soluciones_problemas" ,pCod_soluciones_problemas ));
_bo = (Soluciones_problema) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Soluciones_problemainto the current session by using it's Primary Key values.
/// </summary>
public Soluciones_problema Get(System.Int32 pCod_soluciones_problemas)
{
Soluciones_problema _bo = null ;
try 
{
_bo = Session.Get(typeof(Soluciones_problema), pCod_soluciones_problemas) as Soluciones_problema;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of Soluciones_problemaCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public Soluciones_problemaCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Soluciones_problema
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Soluciones_problema),"Soluciones_problema"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Soluciones_problema");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of Soluciones_problemaCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public Soluciones_problemaCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 Soluciones_problemaCollection _list = new Soluciones_problemaCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of Soluciones_problemaCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public Soluciones_problemaCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of Soluciones_problemaCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public Soluciones_problemaCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public Soluciones_problemaCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of Soluciones_problemaCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public Soluciones_problemaCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSoluciones_problema">A BO of type Soluciones_problema</param>
public void ReAttach(Soluciones_problema pSoluciones_problema)
{
if( pSoluciones_problema == null  ) throw new ArgumentNullException("pSoluciones_problema");
try 
{
Session.Lock(pSoluciones_problema, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Soluciones_problema it saves it (insert) to the DataBase
/// </summary>
///<param name="pSoluciones_problema">A BO of type Soluciones_problema</param>
public void Insert(Soluciones_problema pSoluciones_problema)
{
if( pSoluciones_problema == null  ) throw new ArgumentNullException("pSoluciones_problema");
try 
{
BeginTransaction(false);
Session.Save(pSoluciones_problema);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Soluciones_problema it Inserts them into the DataBase
/// </summary>
///<param name="pListSoluciones_problema">A List of Soluciones_problema</param>
public void Insert(IEnumerable<Soluciones_problema> pListSoluciones_problema)
{
if( pListSoluciones_problema == null  ) throw new ArgumentNullException("pListSoluciones_problema");
try 
{
BeginTransaction(false);
foreach ( Soluciones_problema _Soluciones_problema in pListSoluciones_problema ) 
{
Session.Save(_Soluciones_problema);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSoluciones_problema">A BO of type Soluciones_problema</param>
public void Save(Soluciones_problema pSoluciones_problema)
{
if( pSoluciones_problema == null  ) throw new ArgumentNullException("pSoluciones_problema");
try 
{
BeginTransaction(false);
Session.Update(pSoluciones_problema);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Soluciones_problema
/// </summary>
///<param name="pSoluciones_problema">A BO of type Soluciones_problema</param>
public void Delete(Soluciones_problema pSoluciones_problema)
{
if( pSoluciones_problema == null  ) throw new ArgumentNullException("pSoluciones_problema");
try 
{
BeginTransaction(false);
Session.Delete(pSoluciones_problema);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Soluciones_problema inside one transaction.
/// </summary>
///<param name="pListSoluciones_problema">A List of Soluciones_problema</param>
public void Delete(IEnumerable<Soluciones_problema> pListSoluciones_problema)
{
if( pListSoluciones_problema == null  ) throw new ArgumentNullException("pListSoluciones_problema");
try 
{
...
foreach ( Soluciones_problema _Soluciones_problema in pListSoluciones_problema ) 
{
Session.Delete(_Soluciones_problema);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a Soluciones_problema object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCod_soluciones_problemas)
{
Soluciones_problema _soluciones_problema = Fetch(pCod_soluciones_problemas);
if ( _soluciones_problema == null ) throw new Exception("Object not found , could not delete");
Delete(_soluciones_problema);
...
/// </summary>
///<param name="pSoluciones_problema">A BO of type Soluciones_problema</param>
public Soluciones_problema Dummy(Soluciones_problema pSoluciones_problema)
{
if( pSoluciones_problema == null  ) throw new ArgumentNullException("pSoluciones_problema");
return pSoluciones_problema;
