...
namespace BOLayer{
[DataObject]
public partial class SucursalClienteFactory
 {
...
/// <summary>
/// Create a new SucursalCliente Factory .
/// </summary>
public  SucursalClienteFactory()
{
}

/// <summary>
/// Create a new SucursalCliente Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  SucursalClienteFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type SucursalCliente by using it's Primary Key values. This is the Primary method to retrieve a SucursalCliente.
/// </summary>
public SucursalCliente Fetch(System.String pNitCliente , System.String pCodSucursal)
{
...
if ( String.IsNullOrEmpty(pCodSucursal)) throw new ArgumentException("Argument Name:pCodSucursal. Primary Key Column must have a value (different from null or empty)");
pCodSucursal = pCodSucursal.PadRight(5,' ') ;
SucursalCliente _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("NitCliente" ,pNitCliente ));
_criteria.Add(Restrictions.Eq("CodSucursal" ,pCodSucursal ));
_bo = (SucursalCliente) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type SucursalCliente by using it's Primary Key values. This is the Primary method to retrieve a SucursalCliente.
/// </summary>
public SucursalCliente FetchVirtual(string pVirtualKey)
{
...
System.String _codSucursal = _keys[1];
return Fetch(_nitCliente,_codSucursal);
...
/// <summary>
/// Get strongly typed collection of SucursalClienteCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public SucursalClienteCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object SucursalCliente
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(SucursalCliente),"SucursalCliente"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for SucursalCliente");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of SucursalClienteCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public SucursalClienteCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 SucursalClienteCollection _list = new SucursalClienteCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of SucursalClienteCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public SucursalClienteCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of SucursalClienteCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public SucursalClienteCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SucursalClienteCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of SucursalClienteCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public SucursalClienteCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pSucursalCliente">A BO of type SucursalCliente</param>
public void ReAttach(SucursalCliente pSucursalCliente)
{
if( pSucursalCliente == null  ) throw new ArgumentNullException("pSucursalCliente");
try 
{
Session.Lock(pSucursalCliente, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class SucursalCliente it saves it (insert) to the DataBase
/// </summary>
///<param name="pSucursalCliente">A BO of type SucursalCliente</param>
public void Insert(SucursalCliente pSucursalCliente)
{
if( pSucursalCliente == null  ) throw new ArgumentNullException("pSucursalCliente");
try 
{
BeginTransaction(false);
Session.Save(pSucursalCliente);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class SucursalCliente it Inserts them into the DataBase
/// </summary>
///<param name="pListSucursalCliente">A List of SucursalCliente</param>
public void Insert(IEnumerable<SucursalCliente> pListSucursalCliente)
{
if( pListSucursalCliente == null  ) throw new ArgumentNullException("pListSucursalCliente");
try 
{
BeginTransaction(false);
foreach ( SucursalCliente _SucursalCliente in pListSucursalCliente ) 
{
Session.Save(_SucursalCliente);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pSucursalCliente">A BO of type SucursalCliente</param>
public void Save(SucursalCliente pSucursalCliente)
{
if( pSucursalCliente == null  ) throw new ArgumentNullException("pSucursalCliente");
try 
{
BeginTransaction(false);
Session.Update(pSucursalCliente);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type SucursalCliente
/// </summary>
///<param name="pSucursalCliente">A BO of type SucursalCliente</param>
public void Delete(SucursalCliente pSucursalCliente)
{
if( pSucursalCliente == null  ) throw new ArgumentNullException("pSucursalCliente");
try 
{
BeginTransaction(false);
Session.Delete(pSucursalCliente);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type SucursalCliente inside one transaction.
/// </summary>
///<param name="pListSucursalCliente">A List of SucursalCliente</param>
public void Delete(IEnumerable<SucursalCliente> pListSucursalCliente)
{
if( pListSucursalCliente == null  ) throw new ArgumentNullException("pListSucursalCliente");
try 
{
...
foreach ( SucursalCliente _SucursalCliente in pListSucursalCliente ) 
{
Session.Delete(_SucursalCliente);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a SucursalCliente object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pNitCliente , System.String pCodSucursal)
{
SucursalCliente _sucursalCliente = Fetch(pNitCliente , pCodSucursal);
if ( _sucursalCliente == null ) throw new Exception("Object not found , could not delete");
Delete(_sucursalCliente);
...
/// </summary>
///<param name="pSucursalCliente">A BO of type SucursalCliente</param>
public SucursalCliente Dummy(SucursalCliente pSucursalCliente)
{
if( pSucursalCliente == null  ) throw new ArgumentNullException("pSucursalCliente");
return pSucursalCliente;
