...
namespace BOLayer{
[DataObject]
public partial class TaskAdjuntoFactory
 {
...
/// <summary>
/// Create a new TaskAdjunto Factory .
/// </summary>
public  TaskAdjuntoFactory()
{
}

/// <summary>
/// Create a new TaskAdjunto Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TaskAdjuntoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TaskAdjunto by using it's Primary Key values. This is the Primary method to retrieve a TaskAdjunto.
/// </summary>
public TaskAdjunto Fetch(System.Int32 pCodTarea , System.Int32 pCodAdjunto)
{
TaskAdjunto _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTarea" ,pCodTarea ));
_criteria.Add(Restrictions.Eq("CodAdjunto" ,pCodAdjunto ));
_bo = (TaskAdjunto) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type TaskAdjunto by using it's Primary Key values. This is the Primary method to retrieve a TaskAdjunto.
/// </summary>
public TaskAdjunto FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codAdjunto = System.Int32.Parse(_keys[1]);
return Fetch(_codTarea,_codAdjunto);
...
/// <summary>
/// Get strongly typed collection of TaskAdjuntoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TaskAdjuntoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TaskAdjunto
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TaskAdjunto),"TaskAdjunto"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TaskAdjunto");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TaskAdjuntoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TaskAdjuntoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TaskAdjuntoCollection _list = new TaskAdjuntoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TaskAdjuntoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TaskAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TaskAdjuntoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TaskAdjuntoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TaskAdjuntoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskAdjuntoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTaskAdjunto">A BO of type TaskAdjunto</param>
public void ReAttach(TaskAdjunto pTaskAdjunto)
{
if( pTaskAdjunto == null  ) throw new ArgumentNullException("pTaskAdjunto");
try 
{
Session.Lock(pTaskAdjunto, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TaskAdjunto it saves it (insert) to the DataBase
/// </summary>
///<param name="pTaskAdjunto">A BO of type TaskAdjunto</param>
public void Insert(TaskAdjunto pTaskAdjunto)
{
if( pTaskAdjunto == null  ) throw new ArgumentNullException("pTaskAdjunto");
try 
{
BeginTransaction(false);
Session.Save(pTaskAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TaskAdjunto it Inserts them into the DataBase
/// </summary>
///<param name="pListTaskAdjunto">A List of TaskAdjunto</param>
public void Insert(IEnumerable<TaskAdjunto> pListTaskAdjunto)
{
if( pListTaskAdjunto == null  ) throw new ArgumentNullException("pListTaskAdjunto");
try 
{
BeginTransaction(false);
foreach ( TaskAdjunto _TaskAdjunto in pListTaskAdjunto ) 
{
Session.Save(_TaskAdjunto);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTaskAdjunto">A BO of type TaskAdjunto</param>
public void Save(TaskAdjunto pTaskAdjunto)
{
if( pTaskAdjunto == null  ) throw new ArgumentNullException("pTaskAdjunto");
try 
{
BeginTransaction(false);
Session.Update(pTaskAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TaskAdjunto
/// </summary>
///<param name="pTaskAdjunto">A BO of type TaskAdjunto</param>
public void Delete(TaskAdjunto pTaskAdjunto)
{
if( pTaskAdjunto == null  ) throw new ArgumentNullException("pTaskAdjunto");
try 
{
BeginTransaction(false);
Session.Delete(pTaskAdjunto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TaskAdjunto inside one transaction.
/// </summary>
///<param name="pListTaskAdjunto">A List of TaskAdjunto</param>
public void Delete(IEnumerable<TaskAdjunto> pListTaskAdjunto)
{
if( pListTaskAdjunto == null  ) throw new ArgumentNullException("pListTaskAdjunto");
try 
{
...
/// <summary>
/// Delete a TaskAdjunto object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTarea , System.Int32 pCodAdjunto)
{
TaskAdjunto _taskAdjunto = Fetch(pCodTarea , pCodAdjunto);
if ( _taskAdjunto == null ) throw new Exception("Object not found , could not delete");
Delete(_taskAdjunto);
...
/// </summary>
///<param name="pTaskAdjunto">A BO of type TaskAdjunto</param>
public TaskAdjunto Dummy(TaskAdjunto pTaskAdjunto)
{
if( pTaskAdjunto == null  ) throw new ArgumentNullException("pTaskAdjunto");
return pTaskAdjunto;
