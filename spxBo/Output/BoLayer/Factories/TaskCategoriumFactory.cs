...
namespace BOLayer{
[DataObject]
public partial class TaskCategoriumFactory
 {
...
/// <summary>
/// Create a new TaskCategorium Factory .
/// </summary>
public  TaskCategoriumFactory()
{
}

/// <summary>
/// Create a new TaskCategorium Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TaskCategoriumFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TaskCategorium by using it's Primary Key values. This is the Primary method to retrieve a TaskCategorium.
/// </summary>
public TaskCategorium Fetch(System.String pCodCategoria)
{
if ( String.IsNullOrEmpty(pCodCategoria)) throw new ArgumentException("Argument Name:pCodCategoria. Primary Key Column must have a value (different from null or empty)");
pCodCategoria = pCodCategoria.PadRight(10,' ') ;
TaskCategorium _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodCategoria" ,pCodCategoria ));
_bo = (TaskCategorium) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type TaskCategoriuminto the current session by using it's Primary Key values.
/// </summary>
public TaskCategorium Get(System.String pCodCategoria)
{
if ( String.IsNullOrEmpty(pCodCategoria)) throw new ArgumentException("Argument Name:pCodCategoria. Primary Key Column must have a value (different from null or empty)");
pCodCategoria = pCodCategoria.PadRight(10,' ') ;
TaskCategorium _bo = null ;
try 
{
_bo = Session.Get(typeof(TaskCategorium), pCodCategoria) as TaskCategorium;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TaskCategoriumCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TaskCategoriumCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TaskCategorium
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TaskCategorium),"TaskCategorium"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TaskCategorium");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TaskCategoriumCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TaskCategoriumCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TaskCategoriumCollection _list = new TaskCategoriumCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TaskCategoriumCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TaskCategoriumCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TaskCategoriumCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TaskCategoriumCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskCategoriumCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TaskCategoriumCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskCategoriumCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTaskCategorium">A BO of type TaskCategorium</param>
public void ReAttach(TaskCategorium pTaskCategorium)
{
if( pTaskCategorium == null  ) throw new ArgumentNullException("pTaskCategorium");
try 
{
Session.Lock(pTaskCategorium, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TaskCategorium it saves it (insert) to the DataBase
/// </summary>
///<param name="pTaskCategorium">A BO of type TaskCategorium</param>
public void Insert(TaskCategorium pTaskCategorium)
{
if( pTaskCategorium == null  ) throw new ArgumentNullException("pTaskCategorium");
try 
{
BeginTransaction(false);
Session.Save(pTaskCategorium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TaskCategorium it Inserts them into the DataBase
/// </summary>
///<param name="pListTaskCategorium">A List of TaskCategorium</param>
public void Insert(IEnumerable<TaskCategorium> pListTaskCategorium)
{
if( pListTaskCategorium == null  ) throw new ArgumentNullException("pListTaskCategorium");
try 
{
BeginTransaction(false);
foreach ( TaskCategorium _TaskCategorium in pListTaskCategorium ) 
{
Session.Save(_TaskCategorium);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTaskCategorium">A BO of type TaskCategorium</param>
public void Save(TaskCategorium pTaskCategorium)
{
if( pTaskCategorium == null  ) throw new ArgumentNullException("pTaskCategorium");
try 
{
BeginTransaction(false);
Session.Update(pTaskCategorium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TaskCategorium
/// </summary>
///<param name="pTaskCategorium">A BO of type TaskCategorium</param>
public void Delete(TaskCategorium pTaskCategorium)
{
if( pTaskCategorium == null  ) throw new ArgumentNullException("pTaskCategorium");
try 
{
BeginTransaction(false);
Session.Delete(pTaskCategorium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TaskCategorium inside one transaction.
/// </summary>
///<param name="pListTaskCategorium">A List of TaskCategorium</param>
public void Delete(IEnumerable<TaskCategorium> pListTaskCategorium)
{
if( pListTaskCategorium == null  ) throw new ArgumentNullException("pListTaskCategorium");
try 
{
...
foreach ( TaskCategorium _TaskCategorium in pListTaskCategorium ) 
{
Session.Delete(_TaskCategorium);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a TaskCategorium object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodCategoria)
{
TaskCategorium _taskCategorium = Fetch(pCodCategoria);
if ( _taskCategorium == null ) throw new Exception("Object not found , could not delete");
Delete(_taskCategorium);
...
/// </summary>
///<param name="pTaskCategorium">A BO of type TaskCategorium</param>
public TaskCategorium Dummy(TaskCategorium pTaskCategorium)
{
if( pTaskCategorium == null  ) throw new ArgumentNullException("pTaskCategorium");
return pTaskCategorium;
