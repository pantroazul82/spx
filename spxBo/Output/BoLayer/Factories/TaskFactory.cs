...
/// <summary>
/// Create a new Task Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TaskFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Task by using it's Primary Key values. This is the Primary method to retrieve a Task.
/// </summary>
public Task Fetch(System.Int32 pCodTarea)
{
Task _bo = null ;
try 
{
...
_bo = (Task) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Taskinto the current session by using it's Primary Key values.
/// </summary>
public Task Get(System.Int32 pCodTarea)
{
Task _bo = null ;
try 
{
_bo = Session.Get(typeof(Task), pCodTarea) as Task;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TaskCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Task
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Task),"Task"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Task");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TaskCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TaskCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TaskCollection _list = new TaskCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TaskCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TaskCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TaskCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TaskCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TaskCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTask">A BO of type Task</param>
public void ReAttach(Task pTask)
{
if( pTask == null  ) throw new ArgumentNullException("pTask");
try 
{
Session.Lock(pTask, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Task it saves it (insert) to the DataBase
/// </summary>
///<param name="pTask">A BO of type Task</param>
public void Insert(Task pTask)
{
if( pTask == null  ) throw new ArgumentNullException("pTask");
try 
{
...
/// <summary>
/// Given an List of BO of class Task it Inserts them into the DataBase
/// </summary>
///<param name="pListTask">A List of Task</param>
public void Insert(IEnumerable<Task> pListTask)
{
if( pListTask == null  ) throw new ArgumentNullException("pListTask");
try 
{
BeginTransaction(false);
foreach ( Task _Task in pListTask ) 
{
Session.Save(_Task);
}
Commit(false);
...
/// <summary>
/// Deletes an object of Type Task
/// </summary>
///<param name="pTask">A BO of type Task</param>
public void Delete(Task pTask)
{
if( pTask == null  ) throw new ArgumentNullException("pTask");
try 
{
...
/// <summary>
/// Deletes multiple objects of Type Task inside one transaction.
/// </summary>
///<param name="pListTask">A List of Task</param>
public void Delete(IEnumerable<Task> pListTask)
{
if( pListTask == null  ) throw new ArgumentNullException("pListTask");
try 
{
...
/// <summary>
/// Delete a Task object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTarea)
{
Task _task = Fetch(pCodTarea);
if ( _task == null ) throw new Exception("Object not found , could not delete");
Delete(_task);
