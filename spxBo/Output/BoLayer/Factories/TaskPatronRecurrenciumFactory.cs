...
namespace BOLayer{
[DataObject]
public partial class TaskPatronRecurrenciumFactory
 {
...
/// <summary>
/// Create a new TaskPatronRecurrencium Factory .
/// </summary>
public  TaskPatronRecurrenciumFactory()
{
}

/// <summary>
/// Create a new TaskPatronRecurrencium Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TaskPatronRecurrenciumFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TaskPatronRecurrencium by using it's Primary Key values. This is the Primary method to retrieve a TaskPatronRecurrencium.
/// </summary>
public TaskPatronRecurrencium Fetch(System.Int32 pCodTarea , System.Int32 pCodPatron)
{
TaskPatronRecurrencium _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTarea" ,pCodTarea ));
_criteria.Add(Restrictions.Eq("CodPatron" ,pCodPatron ));
_bo = (TaskPatronRecurrencium) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type TaskPatronRecurrencium by using it's Primary Key values. This is the Primary method to retrieve a TaskPatronRecurrencium.
/// </summary>
public TaskPatronRecurrencium FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codTarea = System.Int32.Parse(_keys[0]);
System.Int32 _codPatron = System.Int32.Parse(_keys[1]);
return Fetch(_codTarea,_codPatron);
...
/// <summary>
/// Get strongly typed collection of TaskPatronRecurrenciumCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TaskPatronRecurrenciumCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TaskPatronRecurrencium
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TaskPatronRecurrencium),"TaskPatronRecurrencium"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TaskPatronRecurrencium");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TaskPatronRecurrenciumCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TaskPatronRecurrenciumCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TaskPatronRecurrenciumCollection _list = new TaskPatronRecurrenciumCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TaskPatronRecurrenciumCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TaskPatronRecurrenciumCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TaskPatronRecurrenciumCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TaskPatronRecurrenciumCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskPatronRecurrenciumCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TaskPatronRecurrenciumCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskPatronRecurrenciumCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTaskPatronRecurrencium">A BO of type TaskPatronRecurrencium</param>
public void ReAttach(TaskPatronRecurrencium pTaskPatronRecurrencium)
{
if( pTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pTaskPatronRecurrencium");
try 
{
Session.Lock(pTaskPatronRecurrencium, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TaskPatronRecurrencium it saves it (insert) to the DataBase
/// </summary>
///<param name="pTaskPatronRecurrencium">A BO of type TaskPatronRecurrencium</param>
public void Insert(TaskPatronRecurrencium pTaskPatronRecurrencium)
{
if( pTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pTaskPatronRecurrencium");
try 
{
BeginTransaction(false);
Session.Save(pTaskPatronRecurrencium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TaskPatronRecurrencium it Inserts them into the DataBase
/// </summary>
///<param name="pListTaskPatronRecurrencium">A List of TaskPatronRecurrencium</param>
public void Insert(IEnumerable<TaskPatronRecurrencium> pListTaskPatronRecurrencium)
{
if( pListTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pListTaskPatronRecurrencium");
try 
{
BeginTransaction(false);
foreach ( TaskPatronRecurrencium _TaskPatronRecurrencium in pListTaskPatronRecurrencium ) 
{
Session.Save(_TaskPatronRecurrencium);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTaskPatronRecurrencium">A BO of type TaskPatronRecurrencium</param>
public void Save(TaskPatronRecurrencium pTaskPatronRecurrencium)
{
if( pTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pTaskPatronRecurrencium");
try 
{
BeginTransaction(false);
Session.Update(pTaskPatronRecurrencium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TaskPatronRecurrencium
/// </summary>
///<param name="pTaskPatronRecurrencium">A BO of type TaskPatronRecurrencium</param>
public void Delete(TaskPatronRecurrencium pTaskPatronRecurrencium)
{
if( pTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pTaskPatronRecurrencium");
try 
{
BeginTransaction(false);
Session.Delete(pTaskPatronRecurrencium);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TaskPatronRecurrencium inside one transaction.
/// </summary>
///<param name="pListTaskPatronRecurrencium">A List of TaskPatronRecurrencium</param>
public void Delete(IEnumerable<TaskPatronRecurrencium> pListTaskPatronRecurrencium)
{
if( pListTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pListTaskPatronRecurrencium");
try 
{
...
foreach ( TaskPatronRecurrencium _TaskPatronRecurrencium in pListTaskPatronRecurrencium ) 
{
Session.Delete(_TaskPatronRecurrencium);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a TaskPatronRecurrencium object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTarea , System.Int32 pCodPatron)
{
TaskPatronRecurrencium _taskPatronRecurrencium = Fetch(pCodTarea , pCodPatron);
if ( _taskPatronRecurrencium == null ) throw new Exception("Object not found , could not delete");
Delete(_taskPatronRecurrencium);
...
/// </summary>
///<param name="pTaskPatronRecurrencium">A BO of type TaskPatronRecurrencium</param>
public TaskPatronRecurrencium Dummy(TaskPatronRecurrencium pTaskPatronRecurrencium)
{
if( pTaskPatronRecurrencium == null  ) throw new ArgumentNullException("pTaskPatronRecurrencium");
return pTaskPatronRecurrencium;
