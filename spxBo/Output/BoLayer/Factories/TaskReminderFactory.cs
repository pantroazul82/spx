...
namespace BOLayer{
[DataObject]
public partial class TaskReminderFactory
 {
...
/// <summary>
/// Create a new TaskReminder Factory .
/// </summary>
...
/// <summary>
/// Create a new TaskReminder Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TaskReminderFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TaskReminder by using it's Primary Key values. This is the Primary method to retrieve a TaskReminder.
/// </summary>
public TaskReminder Fetch(System.Int32 pCodReminder , System.Int32 pCodTarea)
{
TaskReminder _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodReminder" ,pCodReminder ));
_criteria.Add(Restrictions.Eq("CodTarea" ,pCodTarea ));
_bo = (TaskReminder) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type TaskReminder by using it's Primary Key values. This is the Primary method to retrieve a TaskReminder.
/// </summary>
public TaskReminder FetchVirtual(string pVirtualKey)
{
...
System.Int32 _codReminder = System.Int32.Parse(_keys[0]);
System.Int32 _codTarea = System.Int32.Parse(_keys[1]);
return Fetch(_codReminder,_codTarea);
...
/// <summary>
/// Get strongly typed collection of TaskReminderCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TaskReminderCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TaskReminder
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TaskReminder),"TaskReminder"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TaskReminder");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TaskReminderCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TaskReminderCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TaskReminderCollection _list = new TaskReminderCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TaskReminderCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TaskReminderCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TaskReminderCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TaskReminderCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskReminderCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TaskReminderCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TaskReminderCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTaskReminder">A BO of type TaskReminder</param>
public void ReAttach(TaskReminder pTaskReminder)
{
if( pTaskReminder == null  ) throw new ArgumentNullException("pTaskReminder");
try 
{
Session.Lock(pTaskReminder, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TaskReminder it saves it (insert) to the DataBase
/// </summary>
///<param name="pTaskReminder">A BO of type TaskReminder</param>
public void Insert(TaskReminder pTaskReminder)
{
if( pTaskReminder == null  ) throw new ArgumentNullException("pTaskReminder");
try 
{
BeginTransaction(false);
Session.Save(pTaskReminder);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TaskReminder it Inserts them into the DataBase
/// </summary>
///<param name="pListTaskReminder">A List of TaskReminder</param>
public void Insert(IEnumerable<TaskReminder> pListTaskReminder)
{
if( pListTaskReminder == null  ) throw new ArgumentNullException("pListTaskReminder");
try 
{
BeginTransaction(false);
foreach ( TaskReminder _TaskReminder in pListTaskReminder ) 
{
Session.Save(_TaskReminder);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTaskReminder">A BO of type TaskReminder</param>
public void Save(TaskReminder pTaskReminder)
{
if( pTaskReminder == null  ) throw new ArgumentNullException("pTaskReminder");
try 
{
BeginTransaction(false);
Session.Update(pTaskReminder);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TaskReminder
/// </summary>
///<param name="pTaskReminder">A BO of type TaskReminder</param>
public void Delete(TaskReminder pTaskReminder)
{
if( pTaskReminder == null  ) throw new ArgumentNullException("pTaskReminder");
try 
{
BeginTransaction(false);
Session.Delete(pTaskReminder);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TaskReminder inside one transaction.
/// </summary>
///<param name="pListTaskReminder">A List of TaskReminder</param>
public void Delete(IEnumerable<TaskReminder> pListTaskReminder)
{
if( pListTaskReminder == null  ) throw new ArgumentNullException("pListTaskReminder");
try 
{
...
/// <summary>
/// Delete a TaskReminder object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodReminder , System.Int32 pCodTarea)
{
TaskReminder _taskReminder = Fetch(pCodReminder , pCodTarea);
if ( _taskReminder == null ) throw new Exception("Object not found , could not delete");
Delete(_taskReminder);
...
/// </summary>
///<param name="pTaskReminder">A BO of type TaskReminder</param>
public TaskReminder Dummy(TaskReminder pTaskReminder)
{
if( pTaskReminder == null  ) throw new ArgumentNullException("pTaskReminder");
return pTaskReminder;
