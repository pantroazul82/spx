...
namespace BOLayer{
[DataObject]
public partial class TipoContratoFactory
 {
...
/// <summary>
/// Create a new TipoContrato Factory .
/// </summary>
public  TipoContratoFactory()
{
}

/// <summary>
/// Create a new TipoContrato Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TipoContratoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TipoContrato by using it's Primary Key values. This is the Primary method to retrieve a TipoContrato.
/// </summary>
public TipoContrato Fetch(System.String pCodTipoContrato)
{
...
/// <summary>
/// Load an object of type TipoContratointo the current session by using it's Primary Key values.
/// </summary>
public TipoContrato Get(System.String pCodTipoContrato)
{
if ( String.IsNullOrEmpty(pCodTipoContrato)) throw new ArgumentException("Argument Name:pCodTipoContrato. Primary Key Column must have a value (different from null or empty)");
pCodTipoContrato = pCodTipoContrato.PadRight(5,' ') ;
TipoContrato _bo = null ;
try 
{
_bo = Session.Get(typeof(TipoContrato), pCodTipoContrato) as TipoContrato;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TipoContratoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TipoContratoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TipoContrato
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TipoContrato),"TipoContrato"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TipoContrato");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TipoContratoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TipoContratoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TipoContratoCollection _list = new TipoContratoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TipoContratoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TipoContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TipoContratoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TipoContratoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoContratoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TipoContratoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoContratoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTipoContrato">A BO of type TipoContrato</param>
public void ReAttach(TipoContrato pTipoContrato)
{
if( pTipoContrato == null  ) throw new ArgumentNullException("pTipoContrato");
try 
{
Session.Lock(pTipoContrato, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TipoContrato it saves it (insert) to the DataBase
/// </summary>
///<param name="pTipoContrato">A BO of type TipoContrato</param>
public void Insert(TipoContrato pTipoContrato)
{
if( pTipoContrato == null  ) throw new ArgumentNullException("pTipoContrato");
try 
{
BeginTransaction(false);
Session.Save(pTipoContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TipoContrato it Inserts them into the DataBase
/// </summary>
///<param name="pListTipoContrato">A List of TipoContrato</param>
public void Insert(IEnumerable<TipoContrato> pListTipoContrato)
{
if( pListTipoContrato == null  ) throw new ArgumentNullException("pListTipoContrato");
try 
{
BeginTransaction(false);
foreach ( TipoContrato _TipoContrato in pListTipoContrato ) 
{
Session.Save(_TipoContrato);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTipoContrato">A BO of type TipoContrato</param>
public void Save(TipoContrato pTipoContrato)
{
if( pTipoContrato == null  ) throw new ArgumentNullException("pTipoContrato");
try 
{
BeginTransaction(false);
Session.Update(pTipoContrato);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TipoContrato
/// </summary>
///<param name="pTipoContrato">A BO of type TipoContrato</param>
...
/// <summary>
/// Deletes multiple objects of Type TipoContrato inside one transaction.
/// </summary>
///<param name="pListTipoContrato">A List of TipoContrato</param>
public void Delete(IEnumerable<TipoContrato> pListTipoContrato)
{
if( pListTipoContrato == null  ) throw new ArgumentNullException("pListTipoContrato");
try 
{
...
/// <summary>
/// Delete a TipoContrato object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodTipoContrato)
{
TipoContrato _tipoContrato = Fetch(pCodTipoContrato);
if ( _tipoContrato == null ) throw new Exception("Object not found , could not delete");
Delete(_tipoContrato);
...
/// </summary>
///<param name="pTipoContrato">A BO of type TipoContrato</param>
public TipoContrato Dummy(TipoContrato pTipoContrato)
{
if( pTipoContrato == null  ) throw new ArgumentNullException("pTipoContrato");
