...
namespace BOLayer{
[DataObject]
public partial class TipoDocumentoFactory
 {
...
/// <summary>
/// Create a new TipoDocumento Factory .
/// </summary>
public  TipoDocumentoFactory()
{
}

/// <summary>
/// Create a new TipoDocumento Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TipoDocumentoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TipoDocumento by using it's Primary Key values. This is the Primary method to retrieve a TipoDocumento.
/// </summary>
public TipoDocumento Fetch(System.String pCodTipoDoc)
{
if ( String.IsNullOrEmpty(pCodTipoDoc)) throw new ArgumentException("Argument Name:pCodTipoDoc. Primary Key Column must have a value (different from null or empty)");
pCodTipoDoc = pCodTipoDoc.PadRight(5,' ') ;
TipoDocumento _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTipoDoc" ,pCodTipoDoc ));
_bo = (TipoDocumento) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type TipoDocumentointo the current session by using it's Primary Key values.
/// </summary>
public TipoDocumento Get(System.String pCodTipoDoc)
{
if ( String.IsNullOrEmpty(pCodTipoDoc)) throw new ArgumentException("Argument Name:pCodTipoDoc. Primary Key Column must have a value (different from null or empty)");
pCodTipoDoc = pCodTipoDoc.PadRight(5,' ') ;
TipoDocumento _bo = null ;
try 
{
_bo = Session.Get(typeof(TipoDocumento), pCodTipoDoc) as TipoDocumento;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TipoDocumentoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TipoDocumentoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TipoDocumento
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TipoDocumento),"TipoDocumento"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TipoDocumento");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TipoDocumentoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TipoDocumentoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TipoDocumentoCollection _list = new TipoDocumentoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TipoDocumentoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TipoDocumentoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TipoDocumentoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TipoDocumentoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoDocumentoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TipoDocumentoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoDocumentoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTipoDocumento">A BO of type TipoDocumento</param>
public void ReAttach(TipoDocumento pTipoDocumento)
{
if( pTipoDocumento == null  ) throw new ArgumentNullException("pTipoDocumento");
try 
{
Session.Lock(pTipoDocumento, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TipoDocumento it saves it (insert) to the DataBase
/// </summary>
///<param name="pTipoDocumento">A BO of type TipoDocumento</param>
public void Insert(TipoDocumento pTipoDocumento)
{
if( pTipoDocumento == null  ) throw new ArgumentNullException("pTipoDocumento");
try 
{
BeginTransaction(false);
Session.Save(pTipoDocumento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TipoDocumento it Inserts them into the DataBase
/// </summary>
///<param name="pListTipoDocumento">A List of TipoDocumento</param>
public void Insert(IEnumerable<TipoDocumento> pListTipoDocumento)
{
if( pListTipoDocumento == null  ) throw new ArgumentNullException("pListTipoDocumento");
try 
{
BeginTransaction(false);
foreach ( TipoDocumento _TipoDocumento in pListTipoDocumento ) 
{
Session.Save(_TipoDocumento);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTipoDocumento">A BO of type TipoDocumento</param>
public void Save(TipoDocumento pTipoDocumento)
{
if( pTipoDocumento == null  ) throw new ArgumentNullException("pTipoDocumento");
try 
{
BeginTransaction(false);
Session.Update(pTipoDocumento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TipoDocumento
/// </summary>
///<param name="pTipoDocumento">A BO of type TipoDocumento</param>
public void Delete(TipoDocumento pTipoDocumento)
{
if( pTipoDocumento == null  ) throw new ArgumentNullException("pTipoDocumento");
try 
{
BeginTransaction(false);
Session.Delete(pTipoDocumento);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TipoDocumento inside one transaction.
/// </summary>
///<param name="pListTipoDocumento">A List of TipoDocumento</param>
public void Delete(IEnumerable<TipoDocumento> pListTipoDocumento)
{
if( pListTipoDocumento == null  ) throw new ArgumentNullException("pListTipoDocumento");
try 
{
...
/// <summary>
/// Delete a TipoDocumento object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodTipoDoc)
{
TipoDocumento _tipoDocumento = Fetch(pCodTipoDoc);
if ( _tipoDocumento == null ) throw new Exception("Object not found , could not delete");
Delete(_tipoDocumento);
...
/// </summary>
///<param name="pTipoDocumento">A BO of type TipoDocumento</param>
public TipoDocumento Dummy(TipoDocumento pTipoDocumento)
{
if( pTipoDocumento == null  ) throw new ArgumentNullException("pTipoDocumento");
