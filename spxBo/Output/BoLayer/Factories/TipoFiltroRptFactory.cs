...
namespace BOLayer{
[DataObject]
public partial class TipoFiltroRptFactory
 {
...
/// <summary>
/// Create a new TipoFiltroRpt Factory .
/// </summary>
public  TipoFiltroRptFactory()
{
}

/// <summary>
/// Create a new TipoFiltroRpt Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TipoFiltroRptFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TipoFiltroRpt by using it's Primary Key values. This is the Primary method to retrieve a TipoFiltroRpt.
/// </summary>
public TipoFiltroRpt Fetch(System.Int32 pCodTipoFiltroRpt)
{
TipoFiltroRpt _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTipoFiltroRpt" ,pCodTipoFiltroRpt ));
_bo = (TipoFiltroRpt) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type TipoFiltroRptinto the current session by using it's Primary Key values.
/// </summary>
public TipoFiltroRpt Get(System.Int32 pCodTipoFiltroRpt)
{
TipoFiltroRpt _bo = null ;
try 
{
_bo = Session.Get(typeof(TipoFiltroRpt), pCodTipoFiltroRpt) as TipoFiltroRpt;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TipoFiltroRptCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TipoFiltroRptCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TipoFiltroRpt
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TipoFiltroRpt),"TipoFiltroRpt"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TipoFiltroRpt");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TipoFiltroRptCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TipoFiltroRptCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TipoFiltroRptCollection _list = new TipoFiltroRptCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TipoFiltroRptCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TipoFiltroRptCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TipoFiltroRptCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TipoFiltroRptCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoFiltroRptCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TipoFiltroRptCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoFiltroRptCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTipoFiltroRpt">A BO of type TipoFiltroRpt</param>
public void ReAttach(TipoFiltroRpt pTipoFiltroRpt)
{
if( pTipoFiltroRpt == null  ) throw new ArgumentNullException("pTipoFiltroRpt");
try 
{
Session.Lock(pTipoFiltroRpt, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TipoFiltroRpt it saves it (insert) to the DataBase
/// </summary>
///<param name="pTipoFiltroRpt">A BO of type TipoFiltroRpt</param>
public void Insert(TipoFiltroRpt pTipoFiltroRpt)
{
if( pTipoFiltroRpt == null  ) throw new ArgumentNullException("pTipoFiltroRpt");
try 
{
BeginTransaction(false);
Session.Save(pTipoFiltroRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TipoFiltroRpt it Inserts them into the DataBase
/// </summary>
///<param name="pListTipoFiltroRpt">A List of TipoFiltroRpt</param>
public void Insert(IEnumerable<TipoFiltroRpt> pListTipoFiltroRpt)
{
if( pListTipoFiltroRpt == null  ) throw new ArgumentNullException("pListTipoFiltroRpt");
try 
{
BeginTransaction(false);
foreach ( TipoFiltroRpt _TipoFiltroRpt in pListTipoFiltroRpt ) 
{
Session.Save(_TipoFiltroRpt);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTipoFiltroRpt">A BO of type TipoFiltroRpt</param>
public void Save(TipoFiltroRpt pTipoFiltroRpt)
{
if( pTipoFiltroRpt == null  ) throw new ArgumentNullException("pTipoFiltroRpt");
try 
{
BeginTransaction(false);
Session.Update(pTipoFiltroRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TipoFiltroRpt
/// </summary>
///<param name="pTipoFiltroRpt">A BO of type TipoFiltroRpt</param>
public void Delete(TipoFiltroRpt pTipoFiltroRpt)
{
if( pTipoFiltroRpt == null  ) throw new ArgumentNullException("pTipoFiltroRpt");
try 
{
BeginTransaction(false);
Session.Delete(pTipoFiltroRpt);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TipoFiltroRpt inside one transaction.
/// </summary>
///<param name="pListTipoFiltroRpt">A List of TipoFiltroRpt</param>
public void Delete(IEnumerable<TipoFiltroRpt> pListTipoFiltroRpt)
{
if( pListTipoFiltroRpt == null  ) throw new ArgumentNullException("pListTipoFiltroRpt");
try 
{
...
/// <summary>
/// Delete a TipoFiltroRpt object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTipoFiltroRpt)
{
TipoFiltroRpt _tipoFiltroRpt = Fetch(pCodTipoFiltroRpt);
if ( _tipoFiltroRpt == null ) throw new Exception("Object not found , could not delete");
Delete(_tipoFiltroRpt);
...
/// </summary>
///<param name="pTipoFiltroRpt">A BO of type TipoFiltroRpt</param>
public TipoFiltroRpt Dummy(TipoFiltroRpt pTipoFiltroRpt)
{
if( pTipoFiltroRpt == null  ) throw new ArgumentNullException("pTipoFiltroRpt");
return pTipoFiltroRpt;
