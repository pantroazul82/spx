...
namespace BOLayer{
[DataObject]
public partial class TipoServicioFactory
 {
...
/// <summary>
/// Create a new TipoServicio Factory .
/// </summary>
public  TipoServicioFactory()
{
}

/// <summary>
/// Create a new TipoServicio Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TipoServicioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TipoServicio by using it's Primary Key values. This is the Primary method to retrieve a TipoServicio.
/// </summary>
public TipoServicio Fetch(System.String pCodTipoServicio)
{
if ( String.IsNullOrEmpty(pCodTipoServicio)) throw new ArgumentException("Argument Name:pCodTipoServicio. Primary Key Column must have a value (different from null or empty)");
pCodTipoServicio = pCodTipoServicio.PadRight(5,' ') ;
TipoServicio _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTipoServicio" ,pCodTipoServicio ));
_bo = (TipoServicio) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type TipoServiciointo the current session by using it's Primary Key values.
/// </summary>
public TipoServicio Get(System.String pCodTipoServicio)
{
if ( String.IsNullOrEmpty(pCodTipoServicio)) throw new ArgumentException("Argument Name:pCodTipoServicio. Primary Key Column must have a value (different from null or empty)");
pCodTipoServicio = pCodTipoServicio.PadRight(5,' ') ;
TipoServicio _bo = null ;
try 
{
_bo = Session.Get(typeof(TipoServicio), pCodTipoServicio) as TipoServicio;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TipoServicioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TipoServicioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TipoServicio
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TipoServicio),"TipoServicio"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TipoServicio");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TipoServicioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TipoServicioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TipoServicioCollection _list = new TipoServicioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TipoServicioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TipoServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TipoServicioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TipoServicioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoServicioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TipoServicioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TipoServicioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTipoServicio">A BO of type TipoServicio</param>
public void ReAttach(TipoServicio pTipoServicio)
{
if( pTipoServicio == null  ) throw new ArgumentNullException("pTipoServicio");
try 
{
Session.Lock(pTipoServicio, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TipoServicio it saves it (insert) to the DataBase
/// </summary>
///<param name="pTipoServicio">A BO of type TipoServicio</param>
public void Insert(TipoServicio pTipoServicio)
{
if( pTipoServicio == null  ) throw new ArgumentNullException("pTipoServicio");
try 
{
BeginTransaction(false);
Session.Save(pTipoServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TipoServicio it Inserts them into the DataBase
/// </summary>
///<param name="pListTipoServicio">A List of TipoServicio</param>
public void Insert(IEnumerable<TipoServicio> pListTipoServicio)
{
if( pListTipoServicio == null  ) throw new ArgumentNullException("pListTipoServicio");
try 
{
BeginTransaction(false);
foreach ( TipoServicio _TipoServicio in pListTipoServicio ) 
{
Session.Save(_TipoServicio);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTipoServicio">A BO of type TipoServicio</param>
public void Save(TipoServicio pTipoServicio)
{
if( pTipoServicio == null  ) throw new ArgumentNullException("pTipoServicio");
try 
{
BeginTransaction(false);
Session.Update(pTipoServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TipoServicio
/// </summary>
///<param name="pTipoServicio">A BO of type TipoServicio</param>
public void Delete(TipoServicio pTipoServicio)
{
if( pTipoServicio == null  ) throw new ArgumentNullException("pTipoServicio");
try 
{
BeginTransaction(false);
Session.Delete(pTipoServicio);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TipoServicio inside one transaction.
/// </summary>
///<param name="pListTipoServicio">A List of TipoServicio</param>
public void Delete(IEnumerable<TipoServicio> pListTipoServicio)
{
if( pListTipoServicio == null  ) throw new ArgumentNullException("pListTipoServicio");
try 
{
...
/// <summary>
/// Delete a TipoServicio object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodTipoServicio)
{
TipoServicio _tipoServicio = Fetch(pCodTipoServicio);
if ( _tipoServicio == null ) throw new Exception("Object not found , could not delete");
Delete(_tipoServicio);
...
/// </summary>
///<param name="pTipoServicio">A BO of type TipoServicio</param>
public TipoServicio Dummy(TipoServicio pTipoServicio)
{
if( pTipoServicio == null  ) throw new ArgumentNullException("pTipoServicio");
