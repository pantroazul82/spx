...
namespace BOLayer{
[DataObject]
public partial class TituloContactoFactory
 {
...
/// <summary>
/// Create a new TituloContacto Factory .
/// </summary>
public  TituloContactoFactory()
{
}

/// <summary>
/// Create a new TituloContacto Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TituloContactoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type TituloContacto by using it's Primary Key values. This is the Primary method to retrieve a TituloContacto.
/// </summary>
public TituloContacto Fetch(System.String pCodTituloContacto)
{
if ( String.IsNullOrEmpty(pCodTituloContacto)) throw new ArgumentException("Argument Name:pCodTituloContacto. Primary Key Column must have a value (different from null or empty)");
pCodTituloContacto = pCodTituloContacto.PadRight(5,' ') ;
TituloContacto _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTituloContacto" ,pCodTituloContacto ));
_bo = (TituloContacto) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type TituloContactointo the current session by using it's Primary Key values.
/// </summary>
public TituloContacto Get(System.String pCodTituloContacto)
{
if ( String.IsNullOrEmpty(pCodTituloContacto)) throw new ArgumentException("Argument Name:pCodTituloContacto. Primary Key Column must have a value (different from null or empty)");
pCodTituloContacto = pCodTituloContacto.PadRight(5,' ') ;
TituloContacto _bo = null ;
try 
{
_bo = Session.Get(typeof(TituloContacto), pCodTituloContacto) as TituloContacto;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TituloContactoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public TituloContactoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object TituloContacto
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(TituloContacto),"TituloContacto"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for TituloContacto");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TituloContactoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TituloContactoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TituloContactoCollection _list = new TituloContactoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TituloContactoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TituloContactoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TituloContactoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TituloContactoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TituloContactoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TituloContactoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TituloContactoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTituloContacto">A BO of type TituloContacto</param>
public void ReAttach(TituloContacto pTituloContacto)
{
if( pTituloContacto == null  ) throw new ArgumentNullException("pTituloContacto");
try 
{
Session.Lock(pTituloContacto, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class TituloContacto it saves it (insert) to the DataBase
/// </summary>
///<param name="pTituloContacto">A BO of type TituloContacto</param>
public void Insert(TituloContacto pTituloContacto)
{
if( pTituloContacto == null  ) throw new ArgumentNullException("pTituloContacto");
try 
{
BeginTransaction(false);
Session.Save(pTituloContacto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class TituloContacto it Inserts them into the DataBase
/// </summary>
///<param name="pListTituloContacto">A List of TituloContacto</param>
public void Insert(IEnumerable<TituloContacto> pListTituloContacto)
{
if( pListTituloContacto == null  ) throw new ArgumentNullException("pListTituloContacto");
try 
{
BeginTransaction(false);
foreach ( TituloContacto _TituloContacto in pListTituloContacto ) 
{
Session.Save(_TituloContacto);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTituloContacto">A BO of type TituloContacto</param>
public void Save(TituloContacto pTituloContacto)
{
if( pTituloContacto == null  ) throw new ArgumentNullException("pTituloContacto");
try 
{
BeginTransaction(false);
Session.Update(pTituloContacto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type TituloContacto
/// </summary>
///<param name="pTituloContacto">A BO of type TituloContacto</param>
public void Delete(TituloContacto pTituloContacto)
{
if( pTituloContacto == null  ) throw new ArgumentNullException("pTituloContacto");
try 
{
BeginTransaction(false);
Session.Delete(pTituloContacto);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type TituloContacto inside one transaction.
/// </summary>
///<param name="pListTituloContacto">A List of TituloContacto</param>
public void Delete(IEnumerable<TituloContacto> pListTituloContacto)
{
if( pListTituloContacto == null  ) throw new ArgumentNullException("pListTituloContacto");
try 
{
...
foreach ( TituloContacto _TituloContacto in pListTituloContacto ) 
{
Session.Delete(_TituloContacto);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a TituloContacto object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pCodTituloContacto)
{
TituloContacto _tituloContacto = Fetch(pCodTituloContacto);
if ( _tituloContacto == null ) throw new Exception("Object not found , could not delete");
Delete(_tituloContacto);
...
/// </summary>
///<param name="pTituloContacto">A BO of type TituloContacto</param>
public TituloContacto Dummy(TituloContacto pTituloContacto)
{
if( pTituloContacto == null  ) throw new ArgumentNullException("pTituloContacto");
return pTituloContacto;
