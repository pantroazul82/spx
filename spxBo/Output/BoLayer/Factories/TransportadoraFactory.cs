...
namespace BOLayer{
[DataObject]
public partial class TransportadoraFactory
 {
...
/// <summary>
/// Create a new Transportadora Factory .
/// </summary>
...
/// <summary>
/// Create a new Transportadora Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  TransportadoraFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Transportadora by using it's Primary Key values. This is the Primary method to retrieve a Transportadora.
/// </summary>
public Transportadora Fetch(System.Int32 pCodTransportadora)
{
Transportadora _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodTransportadora" ,pCodTransportadora ));
_bo = (Transportadora) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Transportadorainto the current session by using it's Primary Key values.
/// </summary>
public Transportadora Get(System.Int32 pCodTransportadora)
{
Transportadora _bo = null ;
try 
{
_bo = Session.Get(typeof(Transportadora), pCodTransportadora) as Transportadora;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of TransportadoraCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Transportadora
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Transportadora),"Transportadora"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Transportadora");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of TransportadoraCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public TransportadoraCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 TransportadoraCollection _list = new TransportadoraCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of TransportadoraCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public TransportadoraCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of TransportadoraCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public TransportadoraCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TransportadoraCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of TransportadoraCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public TransportadoraCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pTransportadora">A BO of type Transportadora</param>
public void ReAttach(Transportadora pTransportadora)
{
if( pTransportadora == null  ) throw new ArgumentNullException("pTransportadora");
try 
{
Session.Lock(pTransportadora, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Transportadora it saves it (insert) to the DataBase
/// </summary>
///<param name="pTransportadora">A BO of type Transportadora</param>
public void Insert(Transportadora pTransportadora)
{
if( pTransportadora == null  ) throw new ArgumentNullException("pTransportadora");
try 
{
BeginTransaction(false);
Session.Save(pTransportadora);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class Transportadora it Inserts them into the DataBase
/// </summary>
///<param name="pListTransportadora">A List of Transportadora</param>
public void Insert(IEnumerable<Transportadora> pListTransportadora)
{
if( pListTransportadora == null  ) throw new ArgumentNullException("pListTransportadora");
try 
{
BeginTransaction(false);
foreach ( Transportadora _Transportadora in pListTransportadora ) 
{
Session.Save(_Transportadora);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pTransportadora">A BO of type Transportadora</param>
public void Save(Transportadora pTransportadora)
{
if( pTransportadora == null  ) throw new ArgumentNullException("pTransportadora");
try 
{
BeginTransaction(false);
Session.Update(pTransportadora);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type Transportadora
/// </summary>
///<param name="pTransportadora">A BO of type Transportadora</param>
public void Delete(Transportadora pTransportadora)
{
if( pTransportadora == null  ) throw new ArgumentNullException("pTransportadora");
try 
{
BeginTransaction(false);
Session.Delete(pTransportadora);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type Transportadora inside one transaction.
/// </summary>
///<param name="pListTransportadora">A List of Transportadora</param>
public void Delete(IEnumerable<Transportadora> pListTransportadora)
{
if( pListTransportadora == null  ) throw new ArgumentNullException("pListTransportadora");
try 
{
...
foreach ( Transportadora _Transportadora in pListTransportadora ) 
{
Session.Delete(_Transportadora);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a Transportadora object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodTransportadora)
{
Transportadora _transportadora = Fetch(pCodTransportadora);
if ( _transportadora == null ) throw new Exception("Object not found , could not delete");
Delete(_transportadora);
...
/// </summary>
///<param name="pTransportadora">A BO of type Transportadora</param>
public Transportadora Dummy(Transportadora pTransportadora)
{
if( pTransportadora == null  ) throw new ArgumentNullException("pTransportadora");
return pTransportadora;
