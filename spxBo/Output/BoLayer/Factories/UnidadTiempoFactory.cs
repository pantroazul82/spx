...
namespace BOLayer{
[DataObject]
public partial class UnidadTiempoFactory
 {
...
/// <summary>
/// Create a new UnidadTiempo Factory .
/// </summary>
public  UnidadTiempoFactory()
{
}

/// <summary>
/// Create a new UnidadTiempo Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  UnidadTiempoFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type UnidadTiempo by using it's Primary Key values. This is the Primary method to retrieve a UnidadTiempo.
/// </summary>
public UnidadTiempo Fetch(System.Int32 pCodUnidadTiempo)
{
UnidadTiempo _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodUnidadTiempo" ,pCodUnidadTiempo ));
_bo = (UnidadTiempo) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type UnidadTiempointo the current session by using it's Primary Key values.
/// </summary>
public UnidadTiempo Get(System.Int32 pCodUnidadTiempo)
{
UnidadTiempo _bo = null ;
try 
{
_bo = Session.Get(typeof(UnidadTiempo), pCodUnidadTiempo) as UnidadTiempo;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of UnidadTiempoCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public UnidadTiempoCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object UnidadTiempo
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(UnidadTiempo),"UnidadTiempo"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for UnidadTiempo");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of UnidadTiempoCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public UnidadTiempoCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 UnidadTiempoCollection _list = new UnidadTiempoCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of UnidadTiempoCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public UnidadTiempoCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of UnidadTiempoCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public UnidadTiempoCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UnidadTiempoCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of UnidadTiempoCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UnidadTiempoCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pUnidadTiempo">A BO of type UnidadTiempo</param>
public void ReAttach(UnidadTiempo pUnidadTiempo)
{
if( pUnidadTiempo == null  ) throw new ArgumentNullException("pUnidadTiempo");
try 
{
Session.Lock(pUnidadTiempo, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class UnidadTiempo it saves it (insert) to the DataBase
/// </summary>
///<param name="pUnidadTiempo">A BO of type UnidadTiempo</param>
public void Insert(UnidadTiempo pUnidadTiempo)
{
if( pUnidadTiempo == null  ) throw new ArgumentNullException("pUnidadTiempo");
try 
{
BeginTransaction(false);
Session.Save(pUnidadTiempo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class UnidadTiempo it Inserts them into the DataBase
/// </summary>
///<param name="pListUnidadTiempo">A List of UnidadTiempo</param>
public void Insert(IEnumerable<UnidadTiempo> pListUnidadTiempo)
{
if( pListUnidadTiempo == null  ) throw new ArgumentNullException("pListUnidadTiempo");
try 
{
BeginTransaction(false);
foreach ( UnidadTiempo _UnidadTiempo in pListUnidadTiempo ) 
{
Session.Save(_UnidadTiempo);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pUnidadTiempo">A BO of type UnidadTiempo</param>
public void Save(UnidadTiempo pUnidadTiempo)
{
if( pUnidadTiempo == null  ) throw new ArgumentNullException("pUnidadTiempo");
try 
{
BeginTransaction(false);
Session.Update(pUnidadTiempo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type UnidadTiempo
/// </summary>
///<param name="pUnidadTiempo">A BO of type UnidadTiempo</param>
public void Delete(UnidadTiempo pUnidadTiempo)
{
if( pUnidadTiempo == null  ) throw new ArgumentNullException("pUnidadTiempo");
try 
{
BeginTransaction(false);
Session.Delete(pUnidadTiempo);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type UnidadTiempo inside one transaction.
/// </summary>
///<param name="pListUnidadTiempo">A List of UnidadTiempo</param>
public void Delete(IEnumerable<UnidadTiempo> pListUnidadTiempo)
{
if( pListUnidadTiempo == null  ) throw new ArgumentNullException("pListUnidadTiempo");
try 
{
...
/// <summary>
/// Delete a UnidadTiempo object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodUnidadTiempo)
{
UnidadTiempo _unidadTiempo = Fetch(pCodUnidadTiempo);
if ( _unidadTiempo == null ) throw new Exception("Object not found , could not delete");
Delete(_unidadTiempo);
...
/// </summary>
///<param name="pUnidadTiempo">A BO of type UnidadTiempo</param>
public UnidadTiempo Dummy(UnidadTiempo pUnidadTiempo)
{
if( pUnidadTiempo == null  ) throw new ArgumentNullException("pUnidadTiempo");
return pUnidadTiempo;
