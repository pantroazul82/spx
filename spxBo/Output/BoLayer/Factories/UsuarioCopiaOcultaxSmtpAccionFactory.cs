...
namespace BOLayer{
[DataObject]
public partial class UsuarioCopiaOcultaxSmtpAccionFactory
 {
...
/// <summary>
/// Create a new UsuarioCopiaOcultaxSmtpAccion Factory .
/// </summary>
public  UsuarioCopiaOcultaxSmtpAccionFactory()
{
}

/// <summary>
/// Create a new UsuarioCopiaOcultaxSmtpAccion Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  UsuarioCopiaOcultaxSmtpAccionFactory(SessionScope pSessionScope)
{
...
/// </summary>
~UsuarioCopiaOcultaxSmtpAccionFactory()
{
...
/// <summary>
/// Fetch an object of type UsuarioCopiaOcultaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a UsuarioCopiaOcultaxSmtpAccion.
/// </summary>
public UsuarioCopiaOcultaxSmtpAccion Fetch(System.String pLogin , System.Int32 pIdCgSmtpAccion)
{
...
UsuarioCopiaOcultaxSmtpAccion _bo = null ;
try 
{
...
_bo = (UsuarioCopiaOcultaxSmtpAccion) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type UsuarioCopiaOcultaxSmtpAccion by using it's Primary Key values. This is the Primary method to retrieve a UsuarioCopiaOcultaxSmtpAccion.
/// </summary>
public UsuarioCopiaOcultaxSmtpAccion FetchVirtual(string pVirtualKey)
{
...
/// <summary>
/// Get strongly typed collection of UsuarioCopiaOcultaxSmtpAccionCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object UsuarioCopiaOcultaxSmtpAccion
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(UsuarioCopiaOcultaxSmtpAccion),"UsuarioCopiaOcultaxSmtpAccion"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for UsuarioCopiaOcultaxSmtpAccion");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of UsuarioCopiaOcultaxSmtpAccionCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 UsuarioCopiaOcultaxSmtpAccionCollection _list = new UsuarioCopiaOcultaxSmtpAccionCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of UsuarioCopiaOcultaxSmtpAccionCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of UsuarioCopiaOcultaxSmtpAccionCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of UsuarioCopiaOcultaxSmtpAccionCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuarioCopiaOcultaxSmtpAccionCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pUsuarioCopiaOcultaxSmtpAccion">A BO of type UsuarioCopiaOcultaxSmtpAccion</param>
public void ReAttach(UsuarioCopiaOcultaxSmtpAccion pUsuarioCopiaOcultaxSmtpAccion)
{
if( pUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pUsuarioCopiaOcultaxSmtpAccion");
try 
{
Session.Lock(pUsuarioCopiaOcultaxSmtpAccion, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class UsuarioCopiaOcultaxSmtpAccion it saves it (insert) to the DataBase
/// </summary>
///<param name="pUsuarioCopiaOcultaxSmtpAccion">A BO of type UsuarioCopiaOcultaxSmtpAccion</param>
public void Insert(UsuarioCopiaOcultaxSmtpAccion pUsuarioCopiaOcultaxSmtpAccion)
{
if( pUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pUsuarioCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Save(pUsuarioCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class UsuarioCopiaOcultaxSmtpAccion it Inserts them into the DataBase
/// </summary>
///<param name="pListUsuarioCopiaOcultaxSmtpAccion">A List of UsuarioCopiaOcultaxSmtpAccion</param>
public void Insert(IEnumerable<UsuarioCopiaOcultaxSmtpAccion> pListUsuarioCopiaOcultaxSmtpAccion)
{
if( pListUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pListUsuarioCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
foreach ( UsuarioCopiaOcultaxSmtpAccion _UsuarioCopiaOcultaxSmtpAccion in pListUsuarioCopiaOcultaxSmtpAccion ) 
{
Session.Save(_UsuarioCopiaOcultaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pUsuarioCopiaOcultaxSmtpAccion">A BO of type UsuarioCopiaOcultaxSmtpAccion</param>
public void Save(UsuarioCopiaOcultaxSmtpAccion pUsuarioCopiaOcultaxSmtpAccion)
{
if( pUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pUsuarioCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Update(pUsuarioCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type UsuarioCopiaOcultaxSmtpAccion
/// </summary>
///<param name="pUsuarioCopiaOcultaxSmtpAccion">A BO of type UsuarioCopiaOcultaxSmtpAccion</param>
public void Delete(UsuarioCopiaOcultaxSmtpAccion pUsuarioCopiaOcultaxSmtpAccion)
{
if( pUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pUsuarioCopiaOcultaxSmtpAccion");
try 
{
BeginTransaction(false);
Session.Delete(pUsuarioCopiaOcultaxSmtpAccion);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type UsuarioCopiaOcultaxSmtpAccion inside one transaction.
/// </summary>
///<param name="pListUsuarioCopiaOcultaxSmtpAccion">A List of UsuarioCopiaOcultaxSmtpAccion</param>
public void Delete(IEnumerable<UsuarioCopiaOcultaxSmtpAccion> pListUsuarioCopiaOcultaxSmtpAccion)
{
if( pListUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pListUsuarioCopiaOcultaxSmtpAccion");
try 
{
...
foreach ( UsuarioCopiaOcultaxSmtpAccion _UsuarioCopiaOcultaxSmtpAccion in pListUsuarioCopiaOcultaxSmtpAccion ) 
{
Session.Delete(_UsuarioCopiaOcultaxSmtpAccion);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a UsuarioCopiaOcultaxSmtpAccion object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
{
UsuarioCopiaOcultaxSmtpAccion _usuarioCopiaOcultaxSmtpAccion = Fetch(pLogin , pIdCgSmtpAccion);
if ( _usuarioCopiaOcultaxSmtpAccion == null ) throw new Exception("Object not found , could not delete");
Delete(_usuarioCopiaOcultaxSmtpAccion);
...
/// </summary>
///<param name="pUsuarioCopiaOcultaxSmtpAccion">A BO of type UsuarioCopiaOcultaxSmtpAccion</param>
public UsuarioCopiaOcultaxSmtpAccion Dummy(UsuarioCopiaOcultaxSmtpAccion pUsuarioCopiaOcultaxSmtpAccion)
{
if( pUsuarioCopiaOcultaxSmtpAccion == null  ) throw new ArgumentNullException("pUsuarioCopiaOcultaxSmtpAccion");
return pUsuarioCopiaOcultaxSmtpAccion;
