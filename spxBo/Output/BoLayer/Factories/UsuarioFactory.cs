...
namespace BOLayer{
[DataObject]
public partial class UsuarioFactory
 {
...
/// <summary>
/// Create a new Usuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  UsuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type Usuario by using it's Primary Key values. This is the Primary method to retrieve a Usuario.
/// </summary>
public Usuario Fetch(System.Int32 pCodUsuario)
{
Usuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("CodUsuario" ,pCodUsuario ));
_bo = (Usuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Load an object of type Usuariointo the current session by using it's Primary Key values.
/// </summary>
public Usuario Get(System.Int32 pCodUsuario)
{
Usuario _bo = null ;
try 
{
_bo = Session.Get(typeof(Usuario), pCodUsuario) as Usuario;
if ( _bo == null ) 
{
return null;
}
...
/// <summary>
/// Get strongly typed collection of UsuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
...
/// <summary>
/// Method that returns a common/simple Criteria for the object Usuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(Usuario),"Usuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for Usuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of UsuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public UsuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 UsuarioCollection _list = new UsuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of UsuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public UsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of UsuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public UsuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of UsuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pUsuario">A BO of type Usuario</param>
public void ReAttach(Usuario pUsuario)
{
if( pUsuario == null  ) throw new ArgumentNullException("pUsuario");
try 
{
Session.Lock(pUsuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class Usuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pUsuario">A BO of type Usuario</param>
...
/// <summary>
/// Given an List of BO of class Usuario it Inserts them into the DataBase
/// </summary>
///<param name="pListUsuario">A List of Usuario</param>
public void Insert(IEnumerable<Usuario> pListUsuario)
{
if( pListUsuario == null  ) throw new ArgumentNullException("pListUsuario");
try 
{
BeginTransaction(false);
foreach ( Usuario _Usuario in pListUsuario ) 
{
Session.Save(_Usuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Deletes an object of Type Usuario
/// </summary>
///<param name="pUsuario">A BO of type Usuario</param>
...
/// <summary>
/// Deletes multiple objects of Type Usuario inside one transaction.
/// </summary>
///<param name="pListUsuario">A List of Usuario</param>
public void Delete(IEnumerable<Usuario> pListUsuario)
{
if( pListUsuario == null  ) throw new ArgumentNullException("pListUsuario");
try 
{
...
/// <summary>
/// Delete a Usuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.Int32 pCodUsuario)
{
Usuario _usuario = Fetch(pCodUsuario);
if ( _usuario == null ) throw new Exception("Object not found , could not delete");
Delete(_usuario);
...
/// </summary>
///<param name="pUsuario">A BO of type Usuario</param>
public Usuario Dummy(Usuario pUsuario)
{
if( pUsuario == null  ) throw new ArgumentNullException("pUsuario");
return pUsuario;
