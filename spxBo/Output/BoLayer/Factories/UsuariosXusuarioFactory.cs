...
namespace BOLayer{
[DataObject]
public partial class UsuariosXusuarioFactory
 {
...
/// <summary>
/// Create a new UsuariosXusuario Factory .
/// </summary>
public  UsuariosXusuarioFactory()
{
}

/// <summary>
/// Create a new UsuariosXusuario Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  UsuariosXusuarioFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Fetch an object of type UsuariosXusuario by using it's Primary Key values. This is the Primary method to retrieve a UsuariosXusuario.
/// </summary>
public UsuariosXusuario Fetch(System.String pLogin , System.String pSubordinadoDe)
{
...
if ( String.IsNullOrEmpty(pSubordinadoDe)) throw new ArgumentException("Argument Name:pSubordinadoDe. Primary Key Column must have a value (different from null or empty)");
pSubordinadoDe = pSubordinadoDe.PadRight(10,' ') ;
UsuariosXusuario _bo = null ;
try 
{
ICriteria _criteria = GetBasicCriteria();
_criteria.Add(Restrictions.Eq("Login" ,pLogin ));
_criteria.Add(Restrictions.Eq("SubordinadoDe" ,pSubordinadoDe ));
_bo = (UsuariosXusuario) _criteria.UniqueResult();
if ( _bo == null ) 
{
return null;
}
...
/// Fetch an object of type UsuariosXusuario by using it's Primary Key values. This is the Primary method to retrieve a UsuariosXusuario.
/// </summary>
public UsuariosXusuario FetchVirtual(string pVirtualKey)
{
...
System.String _subordinadoDe = _keys[1];
return Fetch(_login,_subordinadoDe);
...
/// <summary>
/// Get strongly typed collection of UsuariosXusuarioCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public UsuariosXusuarioCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object UsuariosXusuario
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(UsuariosXusuario),"UsuariosXusuario"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for UsuariosXusuario");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of UsuariosXusuarioCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public UsuariosXusuarioCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 UsuariosXusuarioCollection _list = new UsuariosXusuarioCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of UsuariosXusuarioCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public UsuariosXusuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of UsuariosXusuarioCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public UsuariosXusuarioCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuariosXusuarioCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of UsuariosXusuarioCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public UsuariosXusuarioCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pUsuariosXusuario">A BO of type UsuariosXusuario</param>
public void ReAttach(UsuariosXusuario pUsuariosXusuario)
{
if( pUsuariosXusuario == null  ) throw new ArgumentNullException("pUsuariosXusuario");
try 
{
Session.Lock(pUsuariosXusuario, NHibernate.LockMode.None);;
}
catch ( Exception ex ) 
{
string _msg = ex.Message; 
...
/// <summary>
/// Given an object/instance of class UsuariosXusuario it saves it (insert) to the DataBase
/// </summary>
///<param name="pUsuariosXusuario">A BO of type UsuariosXusuario</param>
public void Insert(UsuariosXusuario pUsuariosXusuario)
{
if( pUsuariosXusuario == null  ) throw new ArgumentNullException("pUsuariosXusuario");
try 
{
BeginTransaction(false);
Session.Save(pUsuariosXusuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Given an List of BO of class UsuariosXusuario it Inserts them into the DataBase
/// </summary>
///<param name="pListUsuariosXusuario">A List of UsuariosXusuario</param>
public void Insert(IEnumerable<UsuariosXusuario> pListUsuariosXusuario)
{
if( pListUsuariosXusuario == null  ) throw new ArgumentNullException("pListUsuariosXusuario");
try 
{
BeginTransaction(false);
foreach ( UsuariosXusuario _UsuariosXusuario in pListUsuariosXusuario ) 
{
Session.Save(_UsuariosXusuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// </summary>
///<param name="pUsuariosXusuario">A BO of type UsuariosXusuario</param>
public void Save(UsuariosXusuario pUsuariosXusuario)
{
if( pUsuariosXusuario == null  ) throw new ArgumentNullException("pUsuariosXusuario");
try 
{
BeginTransaction(false);
Session.Update(pUsuariosXusuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes an object of Type UsuariosXusuario
/// </summary>
///<param name="pUsuariosXusuario">A BO of type UsuariosXusuario</param>
public void Delete(UsuariosXusuario pUsuariosXusuario)
{
if( pUsuariosXusuario == null  ) throw new ArgumentNullException("pUsuariosXusuario");
try 
{
BeginTransaction(false);
Session.Delete(pUsuariosXusuario);
Commit(false);
}
catch ( Exception ex ) 
{
...
/// <summary>
/// Deletes multiple objects of Type UsuariosXusuario inside one transaction.
/// </summary>
///<param name="pListUsuariosXusuario">A List of UsuariosXusuario</param>
public void Delete(IEnumerable<UsuariosXusuario> pListUsuariosXusuario)
{
if( pListUsuariosXusuario == null  ) throw new ArgumentNullException("pListUsuariosXusuario");
try 
{
...
foreach ( UsuariosXusuario _UsuariosXusuario in pListUsuariosXusuario ) 
{
Session.Delete(_UsuariosXusuario);
}
Commit(false);
}
catch ( Exception ex ) 
...
/// <summary>
/// Delete a UsuariosXusuario object by using it's primary key.Use this method whenever you have the PK values instead of having the object reference.
/// </summary>
/// <remarks>
...
/// </remarks>
public void Delete(System.String pLogin , System.String pSubordinadoDe)
{
UsuariosXusuario _usuariosXusuario = Fetch(pLogin , pSubordinadoDe);
if ( _usuariosXusuario == null ) throw new Exception("Object not found , could not delete");
Delete(_usuariosXusuario);
...
/// </summary>
///<param name="pUsuariosXusuario">A BO of type UsuariosXusuario</param>
public UsuariosXusuario Dummy(UsuariosXusuario pUsuariosXusuario)
{
if( pUsuariosXusuario == null  ) throw new ArgumentNullException("pUsuariosXusuario");
return pUsuariosXusuario;
