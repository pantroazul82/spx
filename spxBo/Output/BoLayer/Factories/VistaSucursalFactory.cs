...
namespace BOLayer{
[DataObject]
public partial class VistaSucursalFactory
 {
...
/// <summary>
/// Create a new VistaSucursal Factory .
/// </summary>
public  VistaSucursalFactory()
{
}

/// <summary>
/// Create a new VistaSucursal Factory allowing to configure the Scope (life) of a Session.
/// </summary>
public  VistaSucursalFactory(SessionScope pSessionScope)
{
...
/// <summary>
/// Get strongly typed collection of VistaSucursalCollection contain ALL objects. Please use the overloads of this method for more efficient retrievals
/// </summary>
public VistaSucursalCollection GetAll()
{
...
/// <summary>
/// Method that returns a common/simple Criteria for the object VistaSucursal
/// </summary>
public ICriteria GetBasicCriteria()
{
ICriteria _criteria = Session.CreateCriteria(typeof(VistaSucursal),"VistaSucursal"); 
 if (_criteria == null) throw new Exception("Failed to create criteria for VistaSucursal");
 return _criteria;
}

/// <summary>
/// Get a strongly typed collection of VistaSucursalCollection objects given a pre-defined Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
public VistaSucursalCollection GetAll(ICriteria pCriteria)
{
if( pCriteria == null  ) throw new ArgumentNullException("pCriteria");
 VistaSucursalCollection _list = new VistaSucursalCollection(this);
pCriteria.List(_list);
return _list;
}

/// <summary>
/// Get a strongly typed collection of VistaSucursalCollection objects given a Criteria.
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
public VistaSucursalCollection GetAll(ICriteria pCriteria , System.String pSortExpression)
{
...
/// <summary>
/// Get a strongly typed collection of VistaSucursalCollection objects given a SortExpression + Paging Information.
/// </summary>
///<param name="pSortExpression">(Optional) Specify a Sorting Expression. (Note: This method expects a Property Name.)</param>
...
public VistaSucursalCollection GetAll(System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public VistaSucursalCollection GetAll(ICriteria pCriteria , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// <summary>
/// Use this method to Get a strongly typed collection of VistaSucursalCollection contain objects that match the parameters. 
/// </summary>
///<param name="pCriteria">Define the Criteria that will limit/filter the result.</param>
...
///<param name="pFirstResult">(Optional) If present it determines a starting row index from the complete DataSource. Notice that 0 should be used for the first row.</param>
///<param name="pMaxResult">(Optional) How many object should be retrieved? (Also know as Page Size)</param>
public VistaSucursalCollection GetAll(ICriteria pCriteria , System.String pSQLExpression , System.String pSortExpression , System.Int32? pFirstResult , System.Int32? pMaxResult)
{
...
/// </summary>
///<param name="pVistaSucursal">A BO of type VistaSucursal</param>
public VistaSucursal Dummy(VistaSucursal pVistaSucursal)
{
if( pVistaSucursal == null  ) throw new ArgumentNullException("pVistaSucursal");
return pVistaSucursal;
