...
namespace spxreactlab
{
    public class cnn
    {
        ...
        public static List<SPXUtilidades.Misc.menuInterface.Interface> cargarOpcionesWindows(out string nombreModulo)
        {
            ...
            obj.asignar("Salida Repuestos", 0, 0, "", "spProcesos.inventarioRepuestos.frmSalidaRepuestos",
            ...
            obj2.asignar("Entrada Repuestos", 0, 0, "", "spProcesos.inventarioRepuestos.frmEntradaRepuestos",
                spxInicio.Properties.Resources.Crystal_Clear_app_desktop_enhancements
                ,
                null, true, false, true, "Inventario Repuestos", "Procesos", false, false);
            list.Add(obj2);
            ...
            obj3.asignar("Consulta Repuestos", 0, 0, "", "spProcesos.inventarioRepuestos.frmConsultarRepuestos",
                spxInicio.Properties.Resources.Crystal_Clear_app_desktop_enhancements
                ,
                null, true, false, true, "Inventario Repuestos", "Procesos", false, false);
            list.Add(obj3);
            SPXUtilidades.Misc.menuInterface.Interface obj4a = new SPXUtilidades.Misc.menuInterface.Interface();
            obj4a.asignar("Edicion de Ubicaciones", 0, 0, "", "spProcesos.inventarioRepuestos.frmEdicionUbicaciones",
                spxInicio.Properties.Resources.Crystal_Clear_app_desktop_enhancements
                ,
                null, true, false, true, "Inventario Repuestos", "Procesos", false, false);
            list.Add(obj4a);
            ...
            obj4.asignar("Traslado de Repuestos", 0, 0, "", "spProcesos.inventarioRepuestos.frmSalidaRepuestos",
                spxInicio.Properties.Resources.Crystal_Clear_app_desktop_enhancements
                ,
                null, true, false, true, "Inventario Repuestos", "Procesos", false, false);
            list.Add(obj4);
