        ...
        for (int k = 0; k < ds.campos_template_revision.Count; k++)
        {
            ...
            else
            {
                ...
                {   
                    ...
                    bool imagen_existe=false;
                    //validamos si la imagen ya fue ingresada
                    //creamos el anchor cell
                    var anchor=new GemBox.Spreadsheet.AnchorCell(l2.Worksheets[0].Columns[ds.campos_template_revision[k].columna - 1],
    l2.Worksheets[0].Rows[ds.campos_template_revision[k].fila], true);

                    for (int contador = 0; contador < l2.Worksheets[0].Pictures.Count; contador++)
                    {
                        l2.Worksheets[0].Pictures[contador].Position.Mode = GemBox.Spreadsheet.PositioningMode.MoveAndSize;
                    var imgFila= l2.Worksheets[0].Pictures[contador];
                        if(
                            anchor.Column.Index == 
                            l2.Worksheets[0].Pictures[contador].Position.From.Column.Index

                            &&
                            anchor.Row.Index ==
                            l2.Worksheets[0].Pictures[contador].Position.From.Row.Index
                            //l2.Worksheets[0].Pictures[contador].Position.To
