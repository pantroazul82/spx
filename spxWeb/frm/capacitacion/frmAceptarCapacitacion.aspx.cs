...
where cod_capacitacion = "+Request.Params["cod"]+" and cod_usuario = "+Session["ss_cod_usuario"];
    ...
    public void btnAceptar_Click(object sender, EventArgs e)
    {
       ...
       objemail.enviarCalendario("Clase Aceptada del curso " + txtNombre.Text, "", "Clase Aceptada del curso " + txtNombre.Text, ds.session_capacitacion[0].fecha_inicio,
           ds.session_capacitacion[0].fecha_fin, Server.MapPath("~/temp/"), dsSeguridad.usuario[0].correo);
    ...
    public void btnCambiar_Click(object sender, EventArgs e)
    {
        ...
        if(aceptar)
        objemail.enviarCalendario("Clase Aceptada del curso " + txtNombre.Text, "", "Clase Aceptada del curso " + txtNombre.Text,
            ds.session_capacitacion[0].fecha_inicio, ds.session_capacitacion[0].fecha_fin, Server.MapPath("~/temp/"), dsSeguridad.usuario[0].correo);
    ...
    protected void btnAceptarTodos_Click(object sender, EventArgs e)
    {
        ...
        for(int k=0;k<ds.session_capacitacion.Count;k++)
        {
            ...
            objemail.enviarCalendario("Clase " + (k + 1) + " del curso " + txtNombre.Text, "",  "Clase " + (k + 1) + " del curso " + txtNombre.Text,
                ds.session_capacitacion[k].fecha_inicio, ds.session_capacitacion[k].fecha_fin, Server.MapPath("~/temp/"), dsSeguridad.usuario[0].correo);
        }
        grdClases.DataBind();
    }
