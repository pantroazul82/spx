<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.master" AutoEventWireup="true" CodeFile="frmNewControlCalidad.aspx.cs" Inherits="frm_controlcalidad_frmNewControlCalidad" %>
...
<td class="style3">
    <asp:RadioButton ID="rdRealizadoAnnar" runat="server" GroupName="realizado" 
        Text="Realizado en Annar" Width="250px" />
    </td>
<td colspan="2">
    <asp:RadioButton ID="rdRealizadoCliente" runat="server" GroupName="realizado" 
        Text="Realizado en instalaciones de cliente" Width="500px"/>
    </td>
<td class="style2">
    &nbsp;</td>
</tr>
...
<telerik:RadMultiPage ID="RadMultiPage2" Runat="server" SelectedIndex="0">
        <telerik:RadPageView ID="RadPageView1" runat="server">
           ...
           <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="pnlLLamada">
           <ContentTemplate>
...
<td class="style2">
    &nbsp;</td>
        ...
        Cliente Interno :
            <asp:TextBox ID="txtClienteInterno" runat="server" Width="200px"></asp:TextBox>
        </telerik:RadPageView>
...
<td colspan="6">
 ...
 <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="pnlLlamada2">
           <ContentTemplate>
<table>
<tr>
<td>&nbsp;</td>
...
<table>
<tr>
<td colspan="5" >Entregado a servicio Técnico por:</td>
</tr>
<tr>
<td colspan="5" >
...
<tr>
<td colspan="5" ><br />Motivo de la solicitud</td>
</tr>
...
<tr>
<td colspan="5" ><br />Observaciones Iniciales:
</td>
</tr>
<tr>
<td colspan="5" >
<asp:TextBox ID="txtObservaciones" runat="server" Height="68px" Width="424px" 
        TextMode="MultiLine" MaxLength="500"></asp:TextBox><br />
</td>
</tr>
...
<td>
<telerik:RadDatePicker ID="calfechaFactura" Runat="server">
...
<td>
    <telerik:RadDatePicker ID="calFechaLlegadaProducto" Runat="server">
...
<td>
    &nbsp;</td>
<td colspan="2">
    <asp:Button ID="btnCrearYCrearOtra" runat="server"  
        Text="Crear Control y Crear Otro" onclick="btnCrearYCrearOtra_Click" OnClientClick="return clickOnce(this, 'Procesando...');" />
    <asp:Button ID="btnAceptar" runat="server" onclick="btnAceptar_Click"    OnClientClick="return clickOnce(this, 'Procesando...');"
        Text="Crear Control"  />
