<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.master" AutoEventWireup="true" CodeFile="frmOrdenesxAprobar.aspx.cs" Inherits="frm_controlcalidad_frmOrdenesxAprobar" %>
...
<br />
<div class="tab">Listado Control Calidad&nbsp;por aprobar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <br />
    Desde
  ...
  <telerik:radgrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" 
        ...
        <MasterTableView datasourceid="odsTareas">
            ...
            <Columns>
                ...
                <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Eval("cod_control_calidad") %>'
    ...
    <asp:ObjectDataSource ID="odsTareas" runat="server" 
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="calFin" Name="fechaFin" PropertyName="SelectedDate" 
                Type="DateTime" />
            <asp:Parameter DefaultValue="3" Name="codManual" Type="Int32" />
        </SelectParameters>
