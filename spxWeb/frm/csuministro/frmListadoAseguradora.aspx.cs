...
public partial class frm_csuministro_frmListadoAseguradora : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmDetalleAseguradora.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmDetalleAseguradora.aspx?cod=" + im.ValidationGroup.ToString());
    }
