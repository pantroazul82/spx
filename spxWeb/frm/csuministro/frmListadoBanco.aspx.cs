...
public partial class frm_csuministro_frmListadoBanco : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmDetalleBanco.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmDetalleBanco.aspx?cod=" + im.ValidationGroup.ToString());
    }
