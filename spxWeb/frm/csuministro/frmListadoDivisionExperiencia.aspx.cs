...
public partial class frm_csuministro_frmListadoDivisionExperiencia : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmDivisionExperienciaDetalle.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmDivisionExperienciaDetalle.aspx?cod=" + im.ValidationGroup.ToString());
    }
