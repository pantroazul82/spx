...
public partial class frm_csuministro_frmListadoMotivosAnulacion : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmDetalleMotivosAnulacion.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmDetalleMotivosAnulacion.aspx?cod=" + im.ValidationGroup.ToString());
    }
