...
public partial class frm_csuministro_frmListadoRiesgoPolizas : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmDetalleRiesgoPolizas.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmDetalleRiesgoPolizas.aspx?cod=" + im.ValidationGroup.ToString());
    }
