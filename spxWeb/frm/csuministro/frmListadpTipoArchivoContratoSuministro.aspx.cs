...
public partial class frm_csuministro_frmListadpTipoArchivoContratoSuministro : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("frmTipoArchivoContratoSuministro.aspx");
    }

    protected void btnEditar_Click(object sender, ImageClickEventArgs e)
    {
        ImageButton im = (ImageButton)sender;
        Response.Redirect("frmTipoArchivoContratoSuministro.aspx?cod=" + im.ValidationGroup.ToString());
    }
