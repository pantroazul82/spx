...
public partial class frm_logica_frmLogin : System.Web.UI.Page
{
    ...
    private string construirMenu()
    {
        ...
        {
            string a = "Unidades de Negocio|~/frm/csuministro/frmListadoDivisionExperiencia.aspx";
            ...
            a = "Riesgos poliza|~/frm/csuministro/frmListadoRiesgoPolizas.aspx";
            parametrizacion =  a + "-" + parametrizacion + "";
            ...
            a = "Destinacion|~/frm/csuministro/frmListadoDestinacion.aspx";
            parametrizacion = a + "-" + parametrizacion + "";


            a = "Tipos otro si|~/frm/csuministro/frmListadoTipoOtroSi.aspx";
            parametrizacion = a + "-" + parametrizacion + "";


            a = "Aseguradora|~/frm/csuministro/frmListadoAseguradora.aspx";
            parametrizacion = a + "-" + parametrizacion + "";

            a = "Bancos|~/frm/csuministro/frmListadoBanco.aspx";
            parametrizacion = a + "-" + parametrizacion + "";


            a = "Tipo cuenta banco|~/frm/csuministro/frmListadoTipoCuentaBanco.aspx";
