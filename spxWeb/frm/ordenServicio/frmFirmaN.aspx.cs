...
public partial class frm_ordenServicio_frmFirmaN : System.Web.UI.Page
{
 ...
 or variables_medicionxorden_servicio.resultado_variable > variables_medicionxmodelo.rango_final)";
    ...
    public void cerrarOrden(string codOrdenServicio)
    {
        ...
        ordenServicioTableAdapter1.UpdateCerrada(f, Session["ss_login"].ToString(), "CERRA", int.Parse(txtcantidadDeHoras.Text), calFechaDeSalida.SelectedDate.ToString(), calFechaLLegada.SelectedDate.ToString(), int.Parse(codOrdenServicio));
