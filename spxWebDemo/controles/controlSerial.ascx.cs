...
public partial class controles_controlSerial : System.Web.UI.UserControl
{
    ...
    {
        set { txtNitcliente.Text = value; txtNitcliente.ReadOnly = true; }
    ...
    string filtro = "";
    if (lblNitcliente.Text.Trim() != string.Empty)
    {
        filtro = " nitcliente = '"+lblNitcliente.Text+"'";
    }
