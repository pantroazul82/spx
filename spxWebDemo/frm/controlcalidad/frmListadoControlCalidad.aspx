...
<div class="tab">Listado Control Calidad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <br />
    Desde
    <telerik:raddatepicker ID="calInicio" Runat="server" Culture="es-CO">
  ...
  <telerik:radgrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" 
        ...
        <MasterTableView datasourceid="odsTareas">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="creado_por"  visible="false"
                    FilterControlAltText="Filter creado_por column" HeaderText="Creado por" 
                    SortExpression="creado_por" UniqueName="creado_por">
                </telerik:GridBoundColumn>

                   <telerik:GridBoundColumn DataField="asignado_a"  
                    FilterControlAltText="Filter asignado_a column" HeaderText="Realizado Por" 
                    SortExpression="asignado_a" UniqueName="asignado_a">
                </telerik:GridBoundColumn>
                ...
                <telerik:GridBoundColumn DataField="entregado_por" visible="false"
                    FilterControlAltText="Filter entregado_por column" HeaderText="Entregado por" 
                    SortExpression="entregado_por" UniqueName="entregado_por">
                </telerik:GridBoundColumn>

                   <telerik:GridBoundColumn DataField="responsable_aprobacion" 
                    FilterControlAltText="Filter responsable_aprobacion column" HeaderText="Aprobado por" 
                    SortExpression="responsable_aprobacion" UniqueName="responsable_aprobacion">
                </telerik:GridBoundColumn>
      ...
      <telerik:GridTemplateColumn HeaderText="Adecuado" DataField="performance_adecuado" SortExpression="performance_adecuado" >
      <ItemTemplate >
      <asp:Label runat="server" ID="txtAdecuado" 
      Text='<%# (Eval("performance_adecuado") != null && Eval("performance_adecuado") != System.DBNull.Value  )?(((bool)Eval("performance_adecuado"))?"Adecuado":"No Adecuado"):("")  %>'></asp:label>
      </ItemTemplate>
      </telerik:GridTemplateColumn>
