...
namespace WebSignatureCapture
{
    ...
    public partial class SignatureControl_ascx : UserControl
	{
		...
		{
            string clientScript = "<script language='javascript'>function SaveSignature(){document.getElementById('frmSign').contentWindow.save();alert('Se guardo la imagen');}	function ClearSignature(){document.getElementById('frmSign').src = '" + Page.ResolveUrl(SignatureCodePath + "Sign.aspx") + SignURL + "';} </script>";
