...
<div class="Formulario">
 ...
 <telerik:RadTabStrip ID="RadTabStrip2" runat="server" 
    ...
    <telerik:RadPageView ID="RadPageView1"  runat="server" ><table><tr><td>&nbsp;</td><td colspan="2"><asp:RadioButton ID="rdRealizadoAnnar" runat="server"  Enabled="false" GroupName="realizado" 
        Text="Realizado en Annar" /></td>
        <td>
            &nbsp;</td>
        <td colspan="2"><asp:RadioButton ID="rdRealizadoCliente" runat="server" Enabled="false"  GroupName="realizado" 
        Text="Realizado en instalaciones de cliente" Width="450px" /></td><td >&nbsp;</td></tr><tr><td>&nbsp;</td><td>Consecutivo</td><td ><asp:Label ID="Label1" runat="server"></asp:Label></td>
        <td>
            &nbsp;</td>
        <td colspan="2">Asignado a&nbsp; <asp:DropDownList ID="cmbAsignadoA" runat="server"  Enabled="false" 
        DataSourceID="ObjectDataSource1" DataTextField="nombre" 
        DataValueField="cod_usuario"></asp:DropDownList></td><td >&nbsp;</td></tr><tr>
        <td colspan="7"/><hr /></tr><tr><td colspan="7"><telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
        ...
        Width="52px"><telerik:RadPageView ID="RadPageView2" runat="server">Llamada: <uc2:controlLlamadas ID="controlLlamadas1" runat="server" /><table><tr><td>&nbsp;</td><td>Cliente</td><td class="style3"><asp:TextBox ID="txtClienteLlamada" runat="server" ReadOnly="true"   
        Width="200px"></asp:TextBox></td><td>Socio de Negocio</td><td class="style1"><asp:TextBox ID="txtSocioNegocioLlamada" runat="server"   
        Width="200px" ReadOnly="True"></asp:TextBox></td><td class="style2">&#160;</td></tr><tr><td>&nbsp;</td><td><asp:Label ID="Label2" runat="server" Text="Sucursal"  ></asp:Label></td><td class="style3"><asp:DropDownList ID="cmbSucursalLlamada" runat="server" Enabled="false" ></asp:DropDownList></td><td><asp:Label ID="Label3" runat="server" Text="Contacto"  ></asp:Label></td><td class="style1"><asp:DropDownList ID="cmbContactoLlamada" runat="server" Enabled="false"  ></asp:DropDownList></td><td class="style2">&#160;</td></tr></table></telerik:RadPageView><telerik:RadPageView ID="RadPageView3" runat="server"><asp:panel runat="server" Width="500px"><asp:Label runat="server" ID="lblclienteInterno" Text="Cliente Interno :" Width="200px"></asp:Label><asp:TextBox ID="txtClienteInterno" runat="server" ReadOnly="true"></asp:TextBox></asp:panel></telerik:RadPageView><telerik:RadPageView ID="RadPageView4" runat="server"><table><tr><td>&nbsp;</td><td>Cliente</td><td class="style3"><asp:TextBox ID="txtCliente" runat="server"   
        Width="200px"></asp:TextBox></td><td>Socio de Negocio</td><td class="style1"><asp:TextBox ID="txtSocioNegocio" runat="server"   
        Width="200px" ReadOnly="True"></asp:TextBox></td><td class="style2">&#160;</td></tr><tr><td>&nbsp;</td><td><asp:Label ID="lblSucursal" runat="server" Text="Sucursal"  ></asp:Label></td><td class="style3"><asp:DropDownList ID="cmbSucursal" runat="server" Enabled="false"   ></asp:DropDownList></td><td><asp:Label ID="lblContacto" runat="server" Text="Contacto"  ></asp:Label></td><td class="style1"><asp:DropDownList ID="cmbContacto" runat="server"  Enabled="false"  ></asp:DropDownList></td><td class="style2">&#160;</td></tr></table></telerik:RadPageView></telerik:RadMultiPage><hr /></td></tr><tr><td>&nbsp;</td><td>Casa Comercial</td><td ><asp:DropDownList ID="cmbFabricante" runat="server" Enabled="false"  AutoPostBack="True" 
        DataSourceID="SqlDataSourceFabricante" DataTextField="nombre_fabricante" 
        DataValueField="codFabricante" ></asp:DropDownList></td>
        <td>
            &nbsp;</td>
        <td>Producto</td><td colspan="2" ><asp:DropDownList ID="cmbReactivo" runat="server"  Enabled="false" 
        DataSourceID="SqlDataSourceReactivo" DataTextField="nombre_referencia_reactivo" 
        DataValueField="cod_referencia_reactivo"></asp:DropDownList></td></tr><tr><td>&nbsp;</td><td>Fecha De Vencimiento</td><td >
        ...
        TodayButtonCaption="Hoy"></FastNavigationSettings></Calendar></telerik:RadDatePicker></td>
            <td>
                &nbsp;</td>
            <td>Lote</td><td ><asp:TextBox ID="txtNumeroLote" runat="server"  Enabled="false" ></asp:TextBox></td><td >&nbsp;</td></tr><tr><td>&nbsp;</td><td>Cantidad Recibido</td>
        <td colspan="4" ><asp:TextBox ID="txtCantidadRecibido" runat="server"  Enabled="false" Width="150px" ></asp:TextBox></td><td >&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td>
        <td  colspan="4">&nbsp;</td><td >&nbsp;</td></tr><tr><td colspan="7"><hr />&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td>
        <td  colspan="5">&nbsp;</td></tr><tr><td>&nbsp;</td><td>No de Factura</td>
        <td  colspan="3">
        
        <asp:TextBox ID="txtFactura" runat="server"></asp:TextBox></td><td>Fecha de 
            Factura&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<telerik:RadDatePicker ID="calFactura" Runat="server" 
                Enabled="false">
            ...
            &nbsp;&nbsp; </td></tr><tr><td>&nbsp;</td><td>&nbsp; <asp:Label runat="server" ID="Label5" Text="Fecha Llegada del producto" Width="200px"></asp:Label></td>
            <td  colspan="3">
    ...
    <FastNavigationSettings EnableTodayButtonSelection="True" TodayButtonCaption="Hoy">
                ...
                </telerik:RadDatePicker></td><td >Fecha Apertura del Producto 
            ...
            </td><td class="style2">&nbsp;</td></tr><tr><td>&nbsp;</td><td>Fecha Inconveniente </td>
        <td  colspan="3">
                <telerik:RadDatePicker ID="calIncoveniente" Runat="server" Enabled="false" ><Calendar ID="Calendar4" runat="server"><FastNavigationSettings EnableTodayButtonSelection="True" 
                TodayButtonCaption="Hoy"></FastNavigationSettings></Calendar></telerik:RadDatePicker></td><td class="style1">&nbsp;</td><td class="style2">&nbsp;</td></tr><tr><td>&nbsp;</td><td>Motivo de la solicitud</td>
        <td  colspan="5"><asp:TextBox ID="txtMotivo" runat="server"  Enabled="false" Height="80px" MaxLength="500" 
        TextMode="MultiLine" Width="552px"></asp:TextBox></td></tr><tr><td>&nbsp;</td><td>Resultados Previos del cliente</td>
            <td  colspan="5"><telerik:RadEditor ID="EditorResultadosPrevios" Runat="server"  Enabled="false" Height="269px" 
        Skin="Web20" EditModes="Design" ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Name="RadEditorHtmlInspector" Enabled="false"  Visible="false" /><telerik:EditorModule Name="RadEditorNodeInspector" Enabled="false" Visible="false" /><telerik:EditorModule Name="RadEditorDomInspector" Enabled="false" Visible="false" /><telerik:EditorModule Name="RadEditorStatistics" Enabled="false"  Visible="false" /></Modules><Tools><telerik:EditorToolGroup><telerik:EditorTool Name="InsertTable" /><telerik:EditorTool Name="InsertDate" /><telerik:EditorTool Name="InsertTime" /><telerik:EditorTool Name="InsertHorizontalRule" /><telerik:EditorTool Name="InsertUnorderedList" /><telerik:EditorTool Name="InsertSymbol" /><telerik:EditorTool Name="Undo" /><telerik:EditorTool Name="Redo" /><telerik:EditorTool Name="Cut" /><telerik:EditorTool Name="FindAndReplace" /><telerik:EditorTool Name="ToggleScreenMode" /><telerik:EditorTool Name="Zoom" /><telerik:EditorTool Name="FontName" /><telerik:EditorTool Name="FontSize" /><telerik:EditorTool Name="Italic" /><telerik:EditorTool Name="Bold" /><telerik:EditorTool Name="StrikeThrough" /><telerik:EditorTool Name="Underline" /><telerik:EditorTool Name="ForeColor" /><telerik:EditorTool Name="BackColor" /><telerik:EditorTool Name="InsertParagraph" /><telerik:EditorTool Name="Outdent" /><telerik:EditorTool Name="JustifyCenter" /><telerik:EditorTool Name="JustifyFull" /><telerik:EditorTool Name="JustifyRight" /><telerik:EditorTool Name="PasteFromWord" /><telerik:EditorTool Name="PasteFromWordNoFontsNoSizes" /><telerik:EditorTool Name="PastePlainText" /></telerik:EditorToolGroup></Tools></telerik:RadEditor></td></tr><tr>
        <td colspan="7"><hr /></td></tr></table></telerik:RadPageView>

    <telerik:RadPageView ID="RadPageView5"  runat="server"><table><tr><td>&nbsp;</td><td colspan="5"><strong>Procedimientos Realizados por asesoria cientifica</strong></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td><asp:Label ID="Label4" runat="server"  Enabled="false" 
        Text="Revisión estado físico del producto" Width="180px"></asp:Label></td><td><asp:TextBox ID="txtRevisionEstadoProducto" TextMode="MultiLine" runat="server"  Enabled="false" 
         Width="300px"></asp:TextBox></td><td>&nbsp;</td><td>Calibracion</td><td><asp:DropDownList ID="cmbCalibracion" runat="server"  Enabled="false" 
        DataSourceID="SqlCalibracionCalidad" DataTextField="calibracion_calidad" 
        DataValueField="cod_calibracion_calidad"  AppendDataBoundItems="true"><asp:ListItem Text="--Seleccione--" Value="" /></asp:DropDownList></td></tr><tr><td>&nbsp;</td><td>Procesamiento de muestras</td><td><asp:RadioButton ID="rdProcesamientoMuestrasSi" runat="server" Text="Si" Enabled="false" /><asp:RadioButton ID="rdProcesamientoMuestrasNo" runat="server" Text="No" Enabled="false"  /></td><td>&nbsp;</td><td>Numero de Muestras</td><td><asp:TextBox 
                        ID="txtNumeroMuestras" runat="server" Enabled="false" Width="283px"></asp:TextBox></td></tr><tr><td>&nbsp;</td><td>Controles utilizados</td><td><asp:TextBox ID="txtControles" runat="server" Enabled="false"   TextMode="MultiLine" Width="300px"></asp:TextBox></td><td>&nbsp;</td><td>Dispositivo Medico Utilizado</td><td><telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" height="40px" 
                    width="465px"><asp:DropDownList ID="cmbFabricanteModeloutilizado" runat="server" 
                        AppendDataBoundItems="true" AutoPostBack="True" 
                        DataSourceID="SqlFabricanteusado" DataTextField="nombre_fabricante" 
                        DataValueField="codFabricante" Enabled="false" Width="150px"><asp:ListItem Text="--Seleccione--" Value="" /></asp:DropDownList><asp:DropDownList ID="cmbModeloUtilizado" runat="server" 
                        DataSourceID="SqlModeloUtilizado" DataTextField="NombreModelo" 
                        DataValueField="codModelo" Enabled="false" Width="180px"></asp:DropDownList></telerik:RadAjaxPanel></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><asp:Label 
                        ID="lblComp" runat="server" Text="Serial del Dispositivo Médico" Width="150px"></asp:Label></td><td><asp:TextBox 
                            ID="txtComparacionResultados" runat="server" ReadOnly="true"></asp:TextBox></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td 
                        colspan="4">&nbsp;</td></tr><tr><td>&nbsp;</td><td colspan="5"><strong>Resultados del control de calidad </strong><br /><telerik:RadEditor 
                        ID="EditorResultados" Runat="server" EditModes="Design" 
                    Enabled="false" Height="269px" Skin="Web20" ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Enabled="false" Name="RadEditorHtmlInspector" 
                            ...
                            Visible="false" /></Modules><Tools><telerik:EditorToolGroup><telerik:EditorTool Name="InsertTable" /><telerik:EditorTool Name="InsertDate" /><telerik:EditorTool Name="InsertTime" /><telerik:EditorTool Name="InsertHorizontalRule" /><telerik:EditorTool Name="InsertUnorderedList" /><telerik:EditorTool Name="InsertSymbol" /><telerik:EditorTool Name="Undo" /><telerik:EditorTool Name="Redo" /><telerik:EditorTool Name="Cut" /><telerik:EditorTool Name="FindAndReplace" /><telerik:EditorTool Name="ToggleScreenMode" /><telerik:EditorTool Name="Zoom" /><telerik:EditorTool Name="FontName" /><telerik:EditorTool Name="FontSize" /><telerik:EditorTool Name="Italic" /><telerik:EditorTool Name="Bold" /><telerik:EditorTool Name="StrikeThrough" /><telerik:EditorTool Name="Underline" /><telerik:EditorTool Name="ForeColor" /><telerik:EditorTool Name="BackColor" /><telerik:EditorTool Name="InsertParagraph" /><telerik:EditorTool Name="Outdent" /><telerik:EditorTool Name="JustifyCenter" /><telerik:EditorTool Name="JustifyFull" /><telerik:EditorTool Name="JustifyRight" /><telerik:EditorTool Name="PasteFromWord" /><telerik:EditorTool Name="PasteFromWordNoFontsNoSizes" /><telerik:EditorTool Name="PastePlainText" /></telerik:EditorToolGroup></Tools></telerik:RadEditor></td></tr><tr><td>&nbsp;</td><td colspan="5"><strong>Analisis de posibles Fallas detectadas&nbsp; </strong><asp:CheckBox 
                        ID="chkAnalisisDeFallasConfidencial" runat="server" Enabled="false" 
                        Text="Confidencial" /><br /><telerik:RadEditor ID="EditorPosiblesFallas" 
                        Runat="server" EditModes="Design" Enabled="false" Height="269px" Skin="Web20" 
                        ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Enabled="false" 
                                ...
                                Name="PastePlainText" /></telerik:EditorToolGroup></Tools></telerik:RadEditor><br /><strong>Antecedentes de situaciones Similares que involucran al producto</strong></td></tr><tr><td>&nbsp;</td><td colspan="5"><telerik:RadEditor 
                        ID="EditorAntecedentes" Runat="server"  Enabled="false" EditModes="Design" 
                    Height="269px" Skin="Web20" ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Enabled="false" Name="RadEditorHtmlInspector" 
                            Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorNodeInspector" 
                            Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorDomInspector" 
                            Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorStatistics" 
                            Visible="false" /></Modules><Tools><telerik:EditorToolGroup><telerik:EditorTool Name="InsertTable" /><telerik:EditorTool Name="InsertDate" /><telerik:EditorTool Name="InsertTime" /><telerik:EditorTool Name="InsertHorizontalRule" /><telerik:EditorTool Name="InsertUnorderedList" /><telerik:EditorTool Name="InsertSymbol" /><telerik:EditorTool Name="Undo" /><telerik:EditorTool Name="Redo" /><telerik:EditorTool Name="Cut" /><telerik:EditorTool Name="FindAndReplace" /><telerik:EditorTool Name="ToggleScreenMode" /><telerik:EditorTool Name="Zoom" /><telerik:EditorTool Name="FontName" /><telerik:EditorTool Name="FontSize" /><telerik:EditorTool Name="Italic" /><telerik:EditorTool Name="Bold" /><telerik:EditorTool Name="StrikeThrough" /><telerik:EditorTool Name="Underline" /><telerik:EditorTool Name="ForeColor" /><telerik:EditorTool Name="BackColor" /><telerik:EditorTool Name="InsertParagraph" /><telerik:EditorTool Name="Outdent" /><telerik:EditorTool Name="JustifyCenter" /><telerik:EditorTool Name="JustifyFull" /><telerik:EditorTool Name="JustifyRight" /><telerik:EditorTool Name="PasteFromWord" /><telerik:EditorTool Name="PasteFromWordNoFontsNoSizes" /><telerik:EditorTool Name="PastePlainText" /></telerik:EditorToolGroup></Tools></telerik:RadEditor><br /><strong>Acciones Implementadas</strong></td></tr><tr><td>&nbsp;</td><td 
                        colspan="5"><telerik:RadEditor ID="EditorAcciones" Runat="server" 
                        EditModes="Design" Enabled="false" Height="269px" Skin="Web20" 
                        ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Enabled="false" 
                                Name="RadEditorHtmlInspector" Visible="false" /><telerik:EditorModule 
                                Enabled="false" Name="RadEditorNodeInspector" Visible="false" /><telerik:EditorModule 
                                Enabled="false" Name="RadEditorDomInspector" Visible="false" /><telerik:EditorModule 
    ...
    <telerik:RadPageView ID="RadPageView6"  runat="server"><table><tr><td colspan="4">Conclusiones<br /> <telerik:RadEditor ID="EditorConclusiones" Runat="server" Enabled="false"  EditModes="Design" 
            Height="269px" Skin="Web20" ToolbarMode="ShowOnFocus"><Modules><telerik:EditorModule Enabled="false" Name="RadEditorHtmlInspector" 
                    Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorNodeInspector" 
                    Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorDomInspector" 
                    Visible="false" /><telerik:EditorModule Enabled="false" Name="RadEditorStatistics" 
                    Visible="false" /></Modules><Tools><telerik:EditorToolGroup><telerik:EditorTool Name="InsertTable" /><telerik:EditorTool Name="InsertDate" /><telerik:EditorTool Name="InsertTime" /><telerik:EditorTool Name="InsertHorizontalRule" /><telerik:EditorTool Name="InsertUnorderedList" /><telerik:EditorTool Name="InsertSymbol" /><telerik:EditorTool Name="Undo" /><telerik:EditorTool Name="Redo" /><telerik:EditorTool Name="Cut" /><telerik:EditorTool Name="FindAndReplace" /><telerik:EditorTool Name="ToggleScreenMode" /><telerik:EditorTool Name="Zoom" /><telerik:EditorTool Name="FontName" /><telerik:EditorTool Name="FontSize" /><telerik:EditorTool Name="Italic" /><telerik:EditorTool Name="Bold" /><telerik:EditorTool Name="StrikeThrough" /><telerik:EditorTool Name="Underline" /><telerik:EditorTool Name="ForeColor" /><telerik:EditorTool Name="BackColor" /><telerik:EditorTool Name="InsertParagraph" /><telerik:EditorTool Name="Outdent" /><telerik:EditorTool Name="JustifyCenter" /><telerik:EditorTool Name="JustifyFull" /><telerik:EditorTool Name="JustifyRight" /><telerik:EditorTool Name="PasteFromWord" /><telerik:EditorTool Name="PasteFromWordNoFontsNoSizes" /><telerik:EditorTool Name="PastePlainText" /></telerik:EditorToolGroup></Tools></telerik:RadEditor></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td>Desempeño del producto</td><td><asp:RadioButton ID="rdDesempenoAdecuado" runat="server"  Enabled="false" GroupName="desempeno" 
            Text="Adecuado" /></td><td><asp:RadioButton ID="rdDesempenoNoAdecuado" runat="server"  Enabled="false" 
            GroupName="desempeno" Text="No Adecuado" /></td><td></td></tr><tr><td class="style4">Causa Identificada del desempeño</td><td class="style4"><asp:RadioButton ID="rdMotivoIdentificadoSi" runat="server"  Enabled="false" 
            GroupName="identificado" Text="Si" /></td><td class="style4"><asp:RadioButton ID="rdIdentificadoNo" runat="server"  Enabled="false" GroupName="identificado" 
            Text="No" /></td><td class="style4"></td></tr><tr><td colspan="4">Observaciones de la Causa del desempeño</td></tr><tr><td colspan="4"><asp:TextBox ID="txtTextoIdentificado" runat="server"  Enabled="false" Height="60px" 
    ...
    <telerik:RadPageView ID="RadPageViewInfoaprobacion"  runat="server" ><table><tr><td>Encargado aprobacion</td><td><asp:DropDownList ID="cmbResponsableAprobacion" runat="server" 
            ...
            DataValueField="cod_usuario" Enabled="False"></asp:DropDownList></td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td></td><td><asp:RadioButton ID="rdAplicaReclamo" runat="server" Enabled="false" 
                    GroupName="aplicaReclamo" Text="Aplica reclamo proveedor" /></td><td></td><td><asp:RadioButton ID="rdNoAplicaReclamo" runat="server" Enabled="false" 
                    GroupName="aplicaReclamo" Text="No Aplica reclamo proveedor" /></td></tr><tr><td>Fecha Envio Reclamo Proveedor: </td><td>
        ...
        TodayButtonCaption="Hoy"></FastNavigationSettings></Calendar></telerik:RadDatePicker></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td><td></td></tr></table></telerik:RadPageView>
