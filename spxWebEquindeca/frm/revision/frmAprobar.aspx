<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.master" AutoEventWireup="true" CodeFile="frmAprobar.aspx.cs" Inherits="frm_revision_frmAprobar" %>
...
<br />
<br />
<div class="tab">Aprobacion de revision<asp:SqlDataSource ID="SqlDataSource1" 
...
<tr>
<td>
    <asp:Label ID="Label1" runat="server" Text="Observaciones " 
...
<td class="style1" colspan="3">
    ...
    <asp:Button ID="btnReabrir" runat="server" Text="Reabrir" 
        onclick="btnReabrir_Click" />

    <asp:Button ID="btnAceptar" runat="server" Text="Aprobar" 
