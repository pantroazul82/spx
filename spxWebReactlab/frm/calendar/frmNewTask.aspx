<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.master" AutoEventWireup="true" CodeFile="frmNewTask.aspx.cs" Inherits="frm_calendar_frmNewTask" %>
...
<td colspan="4">
    ...
    <asp:DropDownList ID="cmbReactivo" runat="server" DataSourceID="odsReactivo" 
        DataTextField="codigo_manual" style= "visibility:hidden;"
