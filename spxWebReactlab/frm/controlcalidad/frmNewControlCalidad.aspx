...
<td class="style3">
    <telerik:RadDateTimePicker ID="calVencimiento" Runat="server">
    </telerik:RadDateTimePicker>
    </td>
<td>
    Lote</td>
...
<tr>
<td>&nbsp;</td>
<td>Entregado a servicio Técnico por</td>
...
<tr>
<td>&nbsp;</td>
<td valign="top">Numero de Factura</td>
<td colspan="3">
...
<td colspan="2">
    <asp:Button ID="btnCrearYCrearOtra" runat="server"  
        Text="Crear Control y Crear Otro" onclick="btnCrearYCrearOtra_Click" />
