...
public partial class frm_logica_frmLogin : System.Web.UI.Page
{
    ...
    private string construirMenu()
    {
        ...
        if (SPXSeguridad.verificadorPermisos.ejecutarAccionWeb(2004, codUsuario, Session))
        {
            string a = "Solicitudes Ingenieria|~/frm/logica/enDesarrollo.aspx";
            resCursos = a + "-" + resCursos;
        }
        if (SPXSeguridad.verificadorPermisos.ejecutarAccionWeb(2005, codUsuario, Session))
        {
            string a = "Solicitudes Cientifica|~/frm/logica/enDesarrollo.aspx";
            resCursos = a + "-" + resCursos;
        }
        ...
        moduloCientifica = "Cientifica#" + resActividades + resCapacitaciones+"#Calendario|~/frm/calendar/calendar.aspx#;";
