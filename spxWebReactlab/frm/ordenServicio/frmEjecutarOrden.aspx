<%@ Page Title="" Language="C#" MasterPageFile="~/frm/master/MasterPage.master" AutoEventWireup="true" CodeFile="frmEjecutarOrden.aspx.cs" Inherits="frm_ordenServicio_frmEjecutarOrden" %>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnCambiarFoto" runat="server" Text="Cambiar Firma" 
                    onclick="btnCambiarFoto_Click" Visible="False" />
                <asp:FileUpload ID="FileUploadFirma" runat="server" Visible="False" />
                <asp:Button ID="btnSubirFirma" runat="server" Text="Subir Firma" 
                    onclick="btnSubirFirma_Click" Visible="False" />
                <asp:Button ID="btnCancelarFirma" runat="server" 
                    onclick="btnCancelarFirma_Click" Text="Cancelar Firma" Visible="False" />
            </td>
        </tr>
        <tr>
            <td>
